...
public class AxolotlSwimNavigation extends EntityNavigation {
	public AxolotlSwimNavigation(MobEntity mobEntity, World world) { super(mobEntity, world); }
	@Override
	...
	@Override
	protected Vec3d getPos() { return new Vec3d(this.entity.getX(), this.entity.getBodyY(0.5), this.entity.getZ()); }
	@Override
	protected double adjustTargetY(Vec3d pos) { return pos.y; }
	@Override
