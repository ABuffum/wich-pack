...
public class RaccoonEntityModel extends EntityModel<RaccoonEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData frontrightleg = modelPartData.addChild(EntityModelPartNames.RIGHT_FRONT_LEG, ModelPartBuilder.create().uv(36, 1).cuboid(-0.5F, 0.0F, -1.5F, 2.0F, 6.0F, 2.0F), ModelTransform.pivot(-2.5F, 18.0F, -4.5F));
		ModelPartData frontleftleg = modelPartData.addChild(EntityModelPartNames.LEFT_FRONT_LEG, ModelPartBuilder.create().uv(2, 15).cuboid(3.5F, 0.0F, -1.5F, 2.0F, 6.0F, 2.0F), ModelTransform.pivot(-2.5F, 18.0F, -4.5F));
		ModelPartData backrightleg = modelPartData.addChild(EntityModelPartNames.RIGHT_HIND_LEG, ModelPartBuilder.create().uv(33, 12).cuboid(-0.5F, 0.0F, -1.5F, 2.0F, 6.0F, 2.0F), ModelTransform.pivot(-2.5F, 18.0F, 3.5F));
		ModelPartData backleftleg = modelPartData.addChild(EntityModelPartNames.LEFT_HIND_LEG, ModelPartBuilder.create().uv(50, 1).cuboid(-1.5F, 0.0F, -1.5F, 2.0F, 6.0F, 2.0F), ModelTransform.pivot(2.5F, 18.0F, 3.5F));
