...
public class ChestBoatItem extends Item {
	...
	public ChestBoatItem(BoatEntity.Type type, Item.Settings settings) {
		super(settings);
		this.type = type;
		this.modType = null;
	}
	public ChestBoatItem(ModBoatType type, Item.Settings settings) {
		super(settings);
		this.type = null;
		this.modType = type;
	}
