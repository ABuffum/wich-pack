...
public class AncientCityOutskirtsGenerator {
	public static void Initialize() {
		...
		StructurePools.register(new StructurePool(new Identifier("ancient_city/structures"),new Identifier("empty"),
				ImmutableList.of(
		...
		StructurePools.register(
				new StructurePool(new Identifier("ancient_city/sculk"), new Identifier("empty"),
						ImmutableList.of(
								Pair.of(StructurePoolElement.ofFeature(ModBase.SCULK_PATCH_ANCIENT_CITY_PLACED.getRegistryEntry()), 6),
								Pair.of(StructurePoolElement.ofEmpty(), 1)),
						StructurePool.Projection.RIGID));
		StructurePools.register(
				new StructurePool(new Identifier("ancient_city/walls"), new Identifier("empty"),
						ImmutableList.of(
						...
						StructurePool.Projection.RIGID));
		StructurePools.register(
				new StructurePool(new Identifier("ancient_city/walls/no_corners"), new Identifier("empty"),
						ImmutableList.of(
								Pair.of(StructurePoolElement.ofProcessedSingle("ancient_city/walls/intact_horizontal_wall_1", ANCIENT_CITY_WALLS_DEGRADATION), 1),
								Pair.of(StructurePoolElement.ofProcessedSingle("ancient_city/walls/intact_horizontal_wall_2", ANCIENT_CITY_WALLS_DEGRADATION), 1),
								Pair.of(StructurePoolElement.ofProcessedSingle("ancient_city/walls/intact_horizontal_wall_stairs_1", ANCIENT_CITY_WALLS_DEGRADATION), 1),
						...
						StructurePool.Projection.RIGID));
		StructurePools.register(
				new StructurePool(new Identifier("ancient_city/city_center/walls"), new Identifier("empty"),
						ImmutableList.of(
						...
						StructurePool.Projection.RIGID));
		StructurePools.register(
				new StructurePool(new Identifier("ancient_city/city/entrance"), new Identifier("empty"),
						ImmutableList.of(
