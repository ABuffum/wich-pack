...
//	public static final BedContainer RAINBOW_BED = MakeBed("rainbow");
	...
	public static final BloodType BEAR_BLOOD_TYPE = BloodType.Register("bear", List.of(EN_US.Blood(Words.Bear)));
	public static final BloodType BEE_BLOOD_TYPE = BloodType.Register("bee", List.of(EN_US.Blood(Words.Bee)));
	public static final BloodType CAT_BLOOD_TYPE = BloodType.Register("cat", List.of(EN_US.Blood(Words.Cat)));
	public static final BloodType CAMEL_BLOOD_TYPE = BloodType.Register("camel", List.of(EN_US.Blood(Words.Camel)));
	public static final BloodType CAVE_SPIDER_BLOOD_TYPE = BloodType.Register("cave_spider", List.of(EN_US.Blood(EN_US.Spider(Words.Cave))));
	...
	public static final BloodType CREEPER_BLOOD_TYPE = BloodType.Register("creeper", List.of(EN_US.Blood(Words.Creeper)));
	public static final BloodType DOLPHIN_BLOOD_TYPE = BloodType.Register("dolphin", List.of(EN_US.Blood(Words.Dolphin)));
	public static final BloodType DONKEY_BLOOD_TYPE = BloodType.Register("donkey", List.of(EN_US.Blood(Words.Donkey)));
	public static final BloodType ENDER_DRAGON_BLOOD_TYPE = BloodType.Register("ender_dragon", List.of(EN_US.Blood(EN_US.Dragon(Words.Ender))));
	public static final BloodType ENDERMAN_BLOOD_TYPE = BloodType.Register("enderman", List.of(EN_US.Blood(Words.Enderman)));
	public static final BloodType ENDERMITE_BLOOD_TYPE = BloodType.Register("endermite", List.of(EN_US.Blood(Words.Endermite)));
	public static final BloodType FISH_BLOOD_TYPE = BloodType.Register("fish", List.of(EN_US.Blood(Words.Fish)));
	public static final BloodType FOX_BLOOD_TYPE = BloodType.Register("fox", List.of(EN_US.Blood(Words.Fox)));
	public static final BloodType FROG_BLOOD_TYPE = BloodType.Register("frog", List.of(EN_US.Blood(Words.Frog)));
	public static final BloodType GLOW_SQUID_BLOOD_TYPE = BloodType.Register("glow_squid", List.of(EN_US.Blood(EN_US.Squid(Words.Glow))));
	public static final BloodType GOAT_BLOOD_TYPE = BloodType.Register("goat", List.of(EN_US.Blood(Words.Goat)));
	public static final BloodType GUARDIAN_BLOOD_TYPE = BloodType.Register("guardian", List.of(EN_US.Blood(Words.Guardian)));
	public static final BloodType HOGLIN_BLOOD_TYPE = BloodType.Register("hoglin", List.of(EN_US.Blood(Words.Hoglin)));
	public static final BloodType HORSE_BLOOD_TYPE = BloodType.Register("horse", List.of(EN_US.Blood(Words.Horse)));
	public static final BloodType LLAMA_BLOOD_TYPE = BloodType.Register("llama", List.of(EN_US.Blood(Words.Llama)));
	public static final BloodType MAGMA_CREAM_BLOOD_TYPE = BloodType.Register("magma_cream", List.of(EN_US.Cream(Words.Magma)));
	public static final BloodType MOOSHROOM_BLOOD_TYPE = BloodType.Register("mooshroom", List.of(EN_US.Blood(Words.Mooshroom)));
	public static final BloodType MULE_BLOOD_TYPE = BloodType.Register("mule", List.of(EN_US.Blood(Words.Mule)));
	public static final BloodType OCELOT_BLOOD_TYPE = BloodType.Register("ocelot", List.of(EN_US.Blood(Words.Ocelot)));
	public static final BloodType PANDA_BLOOD_TYPE = BloodType.Register("panda", List.of(EN_US.Blood(Words.Panda)));
	public static final BloodType PARROT_BLOOD_TYPE = BloodType.Register("parrot", List.of(EN_US.Blood(Words.Parrot)));
	public static final BloodType PHANTOM_BLOOD_TYPE = BloodType.Register("phantom", List.of(EN_US.Blood(Words.Phantom)));
	public static final BloodType PIG_BLOOD_TYPE = BloodType.Register("pig", List.of(EN_US.Blood(Words.Pig)));
	public static final BloodType PIGLIN_BLOOD_TYPE = BloodType.Register("piglin", List.of(EN_US.Blood(Words.Piglin)));
	public static final BloodType PUFFERFISH_BLOOD_TYPE = BloodType.Register("pufferfish", List.of(EN_US.Blood(Words.Pufferfish)));
	public static final BloodType RABBIT_BLOOD_TYPE = BloodType.Register("rabbit", List.of(EN_US.Blood(Words.Rabbit)));
	public static final BloodType RAVAGER_BLOOD_TYPE = BloodType.Register("ravager", List.of(EN_US.Blood(Words.Ravager)));
	public static final BloodType SHEEP_BLOOD_TYPE = BloodType.Register("sheep", List.of(EN_US.Blood(Words.Sheep)));
	public static final BloodType SHULKER_BLOOD_TYPE = BloodType.Register("shulker", List.of(EN_US.Blood(Words.Shulker)));
	public static final BloodType SILVERFISH_BLOOD_TYPE = BloodType.Register("silverfish", List.of(EN_US.Blood(Words.Silverfish)));
	public static final BloodType SLIME_BLOOD_TYPE = BloodType.Register("slime", List.of(Words.Slime));
	public static final BloodType SNIFFER_BLOOD_TYPE = BloodType.Register("sniffer", List.of(EN_US.Blood(Words.Sniffer)));
	public static final BloodType SPIDER_BLOOD_TYPE = BloodType.Register("spider", List.of(EN_US.Blood(Words.Spider)));
	public static final BloodType SQUID_BLOOD_TYPE = BloodType.Register("squid", List.of(EN_US.Blood(Words.Squid)));
	public static final BloodType STRIDER_BLOOD_TYPE = BloodType.Register("strider", List.of(EN_US.Blood(Words.Strider)));
	public static final BloodType TURTLE_BLOOD_TYPE = BloodType.Register("turtle", List.of(EN_US.Blood(Words.Turtle)));
	public static final BloodType VILLAGER_BLOOD_TYPE = BloodType.Register("villager", List.of(EN_US.Blood(Words.Villager)));
	public static final BloodType WARDEN_BLOOD_TYPE = BloodType.Register("warden", List.of(EN_US.Blood(Words.Warden)));
	public static final BloodType WOLF_BLOOD_TYPE = BloodType.Register("wolf", List.of(EN_US.Blood(Words.Wolf)));
	public static final BloodType ZOGLIN_BLOOD_TYPE = BloodType.Register("zoglin", List.of(EN_US.Blood(Words.Zoglin)));
	...
	public static final BloodType ZOMBIFIED_PIGLIN_BLOOD_TYPE = BloodType.Register("zombified_piglin", List.of(EN_US.Blood(EN_US.Piglin(Words.Zombified))));
	//</editor-fold>
	...
	private static void RegisterAll() {
		...
		Register("dispenser_minecart", DISPENSER_MINECART_ITEM, List.of(EN_US.Dispenser(EN_US.with(Words.Minecart))));
		...
		Register("acacia_iron_hanging_sign", "acacia_iron_wall_hanging_sign", ACACIA_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("acacia_gold_hanging_sign", "acacia_gold_wall_hanging_sign", ACACIA_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("acacia_copper_hanging_sign", "acacia_copper_wall_hanging_sign", ACACIA_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("acacia_exposed_copper_hanging_sign", "acacia_exposed_copper_wall_hanging_sign", ACACIA_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("acacia_weathered_copper_hanging_sign", "acacia_weathered_copper_wall_hanging_sign", ACACIA_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("acacia_oxidized_copper_hanging_sign", "acacia_oxidized_copper_wall_hanging_sign", ACACIA_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("acacia_netherite_hanging_sign", "acacia_netherite_wall_hanging_sign", ACACIA_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Acacia, EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_acacia_torch", "underwater_acacia_wall_torch", UNDERWATER_ACACIA_TORCH, List.of(EN_US._Torch(EN_US.Acacia(Words.Underwater))));
		...
		//</editor-fold>
		//<editor-fold desc="Birch">
		Register("minecraft:birch_hanging_sign", "minecraft:birch_wall_hanging_sign", BIRCH_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch)));
		Register("birch_iron_hanging_sign", "birch_iron_wall_hanging_sign", BIRCH_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("birch_gold_hanging_sign", "birch_gold_wall_hanging_sign", BIRCH_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("birch_copper_hanging_sign", "birch_copper_wall_hanging_sign", BIRCH_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("birch_exposed_copper_hanging_sign", "birch_exposed_copper_wall_hanging_sign", BIRCH_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("birch_weathered_copper_hanging_sign", "birch_weathered_copper_wall_hanging_sign", BIRCH_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("birch_oxidized_copper_hanging_sign", "birch_oxidized_copper_wall_hanging_sign", BIRCH_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("birch_netherite_hanging_sign", "birch_netherite_wall_hanging_sign", BIRCH_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Birch, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("birch_beehive", BIRCH_BEEHIVE, List.of(EN_US.Beehive(Words.Birch)));
		Register("birch_bookshelf", BIRCH_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Birch)));
		Register("birch_chiseled_bookshelf", BIRCH_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Birch))));
		Register("birch_crafting_table", BIRCH_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Birch))));
		Register("birch_ladder", BIRCH_LADDER, List.of(EN_US.Ladder(Words.Birch)));
		Register("birch_woodcutter", BIRCH_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Birch)));
		Register("birch_barrel", BIRCH_BARREL, List.of(EN_US.Barrel(Words.Birch)));
		Register("birch_lectern", BIRCH_LECTERN, List.of(EN_US.Lectern(Words.Birch)));
		Register("birch_powder_keg", BIRCH_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Birch))));
		Register("birch_log_slab", BIRCH_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Birch))));
		...
		Register("birch_wood_slab", BIRCH_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Birch))));
		...
		Register("minecraft:birch_chest_boat", BIRCH_CHEST_BOAT, List.of(EN_US.Boat(EN_US.Chest(Words.Birch))));
		Register("birch_hammer", BIRCH_HAMMER, List.of(EN_US.Hammer(Words.Birch)));
		Register("birch_torch", "birch_wall_torch", BIRCH_TORCH, List.of(EN_US._Torch(Words.Birch)));
		Register("birch_soul_torch", "birch_soul_wall_torch", BIRCH_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Birch))));
		Register("birch_ender_torch", "birch_ender_wall_torch", BIRCH_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Birch))));
		Register("underwater_birch_torch", "underwater_birch_wall_torch", UNDERWATER_BIRCH_TORCH, List.of(EN_US._Torch(EN_US.Birch(Words.Underwater))));
		Register("birch_campfire", BIRCH_CAMPFIRE, List.of(EN_US.Campfire(Words.Birch)));
		Register("birch_soul_campfire", BIRCH_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Birch))));
		Register("birch_ender_campfire", BIRCH_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Birch))));
		//</editor-fold>
		//<editor-fold desc="Dark Oak">
		Register("minecraft:dark_oak_hanging_sign", "minecraft:dark_oak_wall_hanging_sign", DARK_OAK_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark))));
		Register("dark_oak_iron_hanging_sign", "dark_oak_iron_wall_hanging_sign", DARK_OAK_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("dark_oak_gold_hanging_sign", "dark_oak_gold_wall_hanging_sign", DARK_OAK_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("dark_oak_copper_hanging_sign", "dark_oak_copper_wall_hanging_sign", DARK_OAK_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("dark_oak_exposed_copper_hanging_sign", "dark_oak_exposed_copper_wall_hanging_sign", DARK_OAK_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("dark_oak_weathered_copper_hanging_sign", "dark_oak_weathered_copper_wall_hanging_sign", DARK_OAK_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("dark_oak_oxidized_copper_hanging_sign", "dark_oak_oxidized_copper_wall_hanging_sign", DARK_OAK_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("dark_oak_netherite_hanging_sign", "dark_oak_netherite_wall_hanging_sign", DARK_OAK_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Oak(Words.Dark), EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("dark_oak_beehive", DARK_OAK_BEEHIVE, List.of(EN_US.Beehive(EN_US.Oak(Words.Dark))));
		Register("dark_oak_bookshelf", DARK_OAK_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Oak(Words.Dark))));
		Register("dark_oak_chiseled_bookshelf", DARK_OAK_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_crafting_table", DARK_OAK_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_ladder", DARK_OAK_LADDER, List.of(EN_US.Ladder(EN_US.Oak(Words.Dark))));
		Register("dark_oak_woodcutter", DARK_OAK_WOODCUTTER, List.of(EN_US.Woodcutter(EN_US.Oak(Words.Dark))));
		Register("dark_oak_barrel", DARK_OAK_BARREL, List.of(EN_US.Barrel(EN_US.Oak(Words.Dark))));
		Register("dark_oak_lectern", DARK_OAK_LECTERN, List.of(EN_US.Lectern(EN_US.Oak(Words.Dark))));
		Register("dark_oak_powder_keg", DARK_OAK_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_log_slab", DARK_OAK_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(EN_US.Oak(Words.Dark)))));
		...
		Register("dark_oak_wood_slab", DARK_OAK_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(EN_US.Oak(Words.Dark)))));
		...
		Register("minecraft:dark_oak_chest_boat", DARK_OAK_CHEST_BOAT, List.of(EN_US.Boat(EN_US.Chest(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_hammer", DARK_OAK_HAMMER, List.of(EN_US.Hammer(EN_US.Oak(Words.Dark))));
		Register("dark_oak_torch", "dark_oak_wall_torch", DARK_OAK_TORCH, List.of(EN_US._Torch(EN_US.Oak(Words.Dark))));
		Register("dark_oak_soul_torch", "dark_oak_soul_wall_torch", DARK_OAK_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_ender_torch", "dark_oak_ender_wall_torch", DARK_OAK_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(EN_US.Oak(Words.Dark)))));
		Register("underwater_dark_oak_torch", "underwater_dark_oak_wall_torch", UNDERWATER_DARK_OAK_TORCH, List.of(EN_US._Torch(EN_US.Oak(EN_US.Dark(Words.Underwater)))));
		Register("dark_oak_campfire", DARK_OAK_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Oak(Words.Dark))));
		Register("dark_oak_soul_campfire", DARK_OAK_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(EN_US.Oak(Words.Dark)))));
		Register("dark_oak_ender_campfire", DARK_OAK_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(EN_US.Oak(Words.Dark)))));
		//</editor-fold>
		//<editor-fold desc="Jungle">
		...
		Register("jungle_iron_hanging_sign", "jungle_iron_wall_hanging_sign", JUNGLE_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("jungle_gold_hanging_sign", "jungle_gold_wall_hanging_sign", JUNGLE_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("jungle_copper_hanging_sign", "jungle_copper_wall_hanging_sign", JUNGLE_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("jungle_exposed_copper_hanging_sign", "jungle_exposed_copper_wall_hanging_sign", JUNGLE_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("jungle_weathered_copper_hanging_sign", "jungle_weathered_copper_wall_hanging_sign", JUNGLE_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("jungle_oxidized_copper_hanging_sign", "jungle_oxidized_copper_wall_hanging_sign", JUNGLE_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("jungle_netherite_hanging_sign", "jungle_netherite_wall_hanging_sign", JUNGLE_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Jungle, EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_jungle_torch", "underwater_jungle_wall_torch", UNDERWATER_JUNGLE_TORCH, List.of(EN_US._Torch(EN_US.Jungle(Words.Underwater))));
		...
		Register("oak_iron_hanging_sign", "oak_iron_wall_hanging_sign", OAK_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("oak_gold_hanging_sign", "oak_gold_wall_hanging_sign", OAK_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("oak_copper_hanging_sign", "oak_copper_wall_hanging_sign", OAK_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("oak_exposed_copper_hanging_sign", "oak_exposed_copper_wall_hanging_sign", OAK_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("oak_weathered_copper_hanging_sign", "oak_weathered_copper_wall_hanging_sign", OAK_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("oak_oxidized_copper_hanging_sign", "oak_oxidized_copper_wall_hanging_sign", OAK_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("oak_netherite_hanging_sign", "oak_netherite_wall_hanging_sign", OAK_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Oak, EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		//</editor-fold>
		//<editor-fold desc="Spruce">
		Register("minecraft:spruce_hanging_sign", "minecraft:spruce_wall_hanging_sign", SPRUCE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce)));
		Register("spruce_iron_hanging_sign", "spruce_iron_wall_hanging_sign", SPRUCE_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("spruce_gold_hanging_sign", "spruce_gold_wall_hanging_sign", SPRUCE_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("spruce_copper_hanging_sign", "spruce_copper_wall_hanging_sign", SPRUCE_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("spruce_exposed_copper_hanging_sign", "spruce_exposed_copper_wall_hanging_sign", SPRUCE_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("spruce_weathered_copper_hanging_sign", "spruce_weathered_copper_wall_hanging_sign", SPRUCE_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("spruce_oxidized_copper_hanging_sign", "spruce_oxidized_copper_wall_hanging_sign", SPRUCE_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("spruce_netherite_hanging_sign", "spruce_netherite_wall_hanging_sign", SPRUCE_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Spruce, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("spruce_beehive", SPRUCE_BEEHIVE, List.of(EN_US.Beehive(Words.Spruce)));
		Register("spruce_bookshelf", SPRUCE_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Spruce)));
		Register("spruce_chiseled_bookshelf", SPRUCE_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Spruce))));
		Register("spruce_crafting_table", SPRUCE_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Spruce))));
		Register("spruce_ladder", SPRUCE_LADDER, List.of(EN_US.Ladder(Words.Spruce)));
		Register("spruce_woodcutter", SPRUCE_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Spruce)));
		Register("spruce_lectern", SPRUCE_LECTERN, List.of(EN_US.Lectern(Words.Spruce)));
		Register("spruce_powder_keg", SPRUCE_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Spruce))));
		Register("spruce_log_slab", SPRUCE_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Spruce))));
		...
		Register("spruce_wood_slab", SPRUCE_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Spruce))));
		...
		Register("minecraft:spruce_chest_boat", SPRUCE_CHEST_BOAT, List.of(EN_US.Boat(EN_US.Chest(Words.Spruce))));
		Register("spruce_hammer", SPRUCE_HAMMER, List.of(EN_US.Hammer(Words.Spruce)));
		Register("spruce_torch", "spruce_wall_torch", SPRUCE_TORCH, List.of(EN_US._Torch(Words.Spruce)));
		Register("spruce_soul_torch", "spruce_soul_wall_torch", SPRUCE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Spruce))));
		Register("spruce_ender_torch", "spruce_ender_wall_torch", SPRUCE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Spruce))));
		Register("underwater_spruce_torch", "underwater_spruce_wall_torch", UNDERWATER_SPRUCE_TORCH, List.of(EN_US._Torch(EN_US.Spruce(Words.Underwater))));
		Register("spruce_campfire", SPRUCE_CAMPFIRE, List.of(EN_US.Campfire(Words.Spruce)));
		Register("spruce_soul_campfire", SPRUCE_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Spruce))));
		Register("spruce_ender_campfire", SPRUCE_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Spruce))));
		//</editor-fold>
		//<editor-fold desc="Crimson">
		Register("minecraft:crimson_hanging_sign", "minecraft:crimson_wall_hanging_sign", CRIMSON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson)));
		Register("crimson_iron_hanging_sign", "crimson_iron_wall_hanging_sign", CRIMSON_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("crimson_gold_hanging_sign", "crimson_gold_wall_hanging_sign", CRIMSON_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("crimson_copper_hanging_sign", "crimson_copper_wall_hanging_sign", CRIMSON_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("crimson_exposed_copper_hanging_sign", "crimson_exposed_copper_wall_hanging_sign", CRIMSON_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("crimson_weathered_copper_hanging_sign", "crimson_weathered_copper_wall_hanging_sign", CRIMSON_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("crimson_oxidized_copper_hanging_sign", "crimson_oxidized_copper_wall_hanging_sign", CRIMSON_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("crimson_netherite_hanging_sign", "crimson_netherite_wall_hanging_sign", CRIMSON_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Crimson, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("crimson_beehive", CRIMSON_BEEHIVE, List.of(EN_US.Beehive(Words.Crimson)));
		Register("crimson_bookshelf", CRIMSON_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Crimson)));
		Register("crimson_chiseled_bookshelf", CRIMSON_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Crimson))));
		Register("crimson_crafting_table", CRIMSON_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Crimson))));
		Register("crimson_ladder", CRIMSON_LADDER, List.of(EN_US.Ladder(Words.Crimson)));
		Register("crimson_woodcutter", CRIMSON_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Crimson)));
		Register("crimson_barrel", CRIMSON_BARREL, List.of(EN_US.Barrel(Words.Crimson)));
		Register("crimson_lectern", CRIMSON_LECTERN, List.of(EN_US.Lectern(Words.Crimson)));
		Register("crimson_powder_keg", CRIMSON_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Crimson))));
		Register("crimson_stem_slab", CRIMSON_STEM_SLAB, List.of(EN_US.Slab(EN_US.Stem(Words.Crimson))));
		...
		Register("crimson_hyphae_slab", CRIMSON_HYPHAE_SLAB, List.of(EN_US.Slab(EN_US.Hyphae(Words.Crimson))));
		...
		Register("crimson_hammer", CRIMSON_HAMMER, List.of(EN_US.Hammer(Words.Crimson)));
		Register("nether_wart_slab", NETHER_WART_SLAB, List.of(EN_US.Slab(EN_US.Wart(Words.Nether))));
		Register("crimson_torch", "crimson_wall_torch", CRIMSON_TORCH, List.of(EN_US._Torch(Words.Crimson)));
		Register("crimson_soul_torch", "crimson_soul_wall_torch", CRIMSON_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Crimson))));
		Register("crimson_ender_torch", "crimson_ender_wall_torch", CRIMSON_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Crimson))));
		Register("underwater_crimson_torch", "underwater_crimson_wall_torch", UNDERWATER_CRIMSON_TORCH, List.of(EN_US._Torch(EN_US.Crimson(Words.Underwater))));
		Register("crimson_campfire", CRIMSON_CAMPFIRE, List.of(EN_US.Campfire(Words.Crimson)));
		Register("crimson_soul_campfire", CRIMSON_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Crimson))));
		Register("crimson_ender_campfire", CRIMSON_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Crimson))));
		//</editor-fold>
		//<editor-fold desc="Warped">
		Register("minecraft:warped_hanging_sign", "minecraft:warped_wall_hanging_sign", WARPED_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped)));
		Register("warped_iron_hanging_sign", "warped_iron_wall_hanging_sign", WARPED_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("warped_gold_hanging_sign", "warped_gold_wall_hanging_sign", WARPED_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("warped_copper_hanging_sign", "warped_copper_wall_hanging_sign", WARPED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("warped_exposed_copper_hanging_sign", "warped_exposed_copper_wall_hanging_sign", WARPED_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("warped_weathered_copper_hanging_sign", "warped_weathered_copper_wall_hanging_sign", WARPED_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("warped_oxidized_copper_hanging_sign", "warped_oxidized_copper_wall_hanging_sign", WARPED_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("warped_netherite_hanging_sign", "warped_netherite_wall_hanging_sign", WARPED_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Warped, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("warped_beehive", WARPED_BEEHIVE, List.of(EN_US.Beehive(Words.Warped)));
		Register("warped_bookshelf", WARPED_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Warped)));
		Register("warped_chiseled_bookshelf", WARPED_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Warped))));
		Register("warped_crafting_table", WARPED_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Warped))));
		Register("warped_ladder", WARPED_LADDER, List.of(EN_US.Ladder(Words.Warped)));
		Register("warped_woodcutter", WARPED_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Warped)));
		Register("warped_barrel", WARPED_BARREL, List.of(EN_US.Barrel(Words.Warped)));
		Register("warped_lectern", WARPED_LECTERN, List.of(EN_US.Lectern(Words.Warped)));
		Register("warped_powder_keg", WARPED_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Warped))));
		Register("warped_stem_slab", WARPED_STEM_SLAB, List.of(EN_US.Slab(EN_US.Stem(Words.Warped))));
		...
		Register("warped_hyphae_slab", WARPED_HYPHAE_SLAB, List.of(EN_US.Slab(EN_US.Hyphae(Words.Warped))));
		...
		Register("warped_hammer", WARPED_HAMMER, List.of(EN_US.Hammer(Words.Warped)));
		Register("warped_wart", WARPED_WART, List.of(EN_US.Wart(Words.Warped)));
		Register("warped_wart_slab", WARPED_WART_SLAB, List.of(EN_US.Slab(EN_US.Wart(Words.Warped))));
		Register("warped_torch", "warped_wall_torch", WARPED_TORCH, List.of(EN_US._Torch(Words.Warped)));
		Register("warped_soul_torch", "warped_soul_wall_torch", WARPED_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Warped))));
		Register("warped_ender_torch", "warped_ender_wall_torch", WARPED_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Warped))));
		Register("underwater_warped_torch", "underwater_warped_wall_torch", UNDERWATER_WARPED_TORCH, List.of(EN_US._Torch(EN_US.Warped(Words.Underwater))));
		Register("warped_campfire", WARPED_CAMPFIRE, List.of(EN_US.Campfire(Words.Warped)));
		Register("warped_soul_campfire", WARPED_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Warped))));
		Register("warped_ender_campfire", WARPED_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Warped))));
		//</editor-fold>
		//<editor-fold desc="Light Sources">
		Register("underwater_torch", "underwater_wall_torch", UNDERWATER_TORCH, List.of(EN_US._Torch(Words.Underwater)));
		Register("unlit_torch", "unlit_wall_torch", UNLIT_TORCH, List.of(EN_US._Torch(Words.Unlit)));
		Register("unlit_soul_torch", "unlit_soul_wall_torch", UNLIT_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Unlit))));
		Register("unlit_lantern", UNLIT_LANTERN, List.of(EN_US.Lantern(Words.Unlit)));
		Register("unlit_soul_lantern", UNLIT_SOUL_LANTERN, List.of(EN_US.Lantern(EN_US.Soul(Words.Unlit))));
		Register("empty_lantern", EMPTY_LANTERN, List.of(EN_US.Lantern(Words.Empty)));
		//</editor-fold>
		//<editor-fold desc="Soul & Ender Fire">
		Register("soul_candle", SOUL_CANDLE, List.of(EN_US.Candle(Words.Soul)));
		Register("ender_candle", ENDER_CANDLE, List.of(EN_US.Candle(Words.Ender)));
		Register("netherrack_candle", NETHERRACK_CANDLE, List.of(EN_US.Candle(Words.Netherrack)));
		Register("soul_candle_cake", SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(Words.Cake)))));
		Register("ender_candle_cake", ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(Words.Cake)))));
		Register("netherrack_candle_cake", NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(Words.Cake)))));
		Register("ender_torch", "ender_wall_torch", ENDER_TORCH, List.of(EN_US._Torch(Words.Ender)));
		Register("ender_lantern", ENDER_LANTERN, List.of(EN_US.Lantern(Words.Ender)));
		Register("ender_campfire", ENDER_CAMPFIRE, List.of(EN_US.Campfire(Words.Ender)));
		//</editor-fold>
		//<editor-fold desc="Stone">
		...
		Register("stone_tiles", STONE_TILES, List.of(EN_US.Tiles(Words.Stone)));
		Register("stone_tile_stairs", STONE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Stone))));
		Register("stone_tile_slab", STONE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Stone))));
		Register("stone_tile_wall", STONE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Stone))));
		Register("smooth_stone_stairs", SMOOTH_STONE_STAIRS, List.of(EN_US.Stairs(EN_US.Stone(Words.Smooth))));
		Register("stone_hammer", STONE_HAMMER, List.of(EN_US.Hammer(Words.Stone)));
		//</editor-fold>
		//<editor-fold desc="Andesite">
		Register("polished_andesite_wall", POLISHED_ANDESITE_WALL, List.of(EN_US.Wall(EN_US.Andesite(Words.Polished))));
		Register("cut_polished_andesite", CUT_POLISHED_ANDESITE, List.of(EN_US.Andesite(EN_US.Polished(Words.Cut))));
		Register("cut_polished_andesite_stairs", CUT_POLISHED_ANDESITE_STAIRS, List.of(EN_US.Stairs(EN_US.Andesite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_andesite_slab", CUT_POLISHED_ANDESITE_SLAB, List.of(EN_US.Slab(EN_US.Andesite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_andesite_wall", CUT_POLISHED_ANDESITE_WALL, List.of(EN_US.Wall(EN_US.Andesite(EN_US.Polished(Words.Cut)))));
		...
		//</editor-fold>
		//<editor-fold desc="Deepslate">
		Register("minecraft:reinforced_deepslate", REINFORCED_DEEPSLATE, List.of(EN_US.Deepslate(Words.Reinforced)));
		...
		//</editor-fold>
		//<editor-fold desc="Diorite">
		Register("polished_diorite_wall", POLISHED_DIORITE_WALL, List.of(EN_US.Wall(EN_US.Diorite(Words.Polished))));
		Register("cut_polished_diorite", CUT_POLISHED_DIORITE, List.of(EN_US.Diorite(EN_US.Polished(Words.Cut))));
		Register("cut_polished_diorite_stairs", CUT_POLISHED_DIORITE_STAIRS, List.of(EN_US.Stairs(EN_US.Diorite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_diorite_slab", CUT_POLISHED_DIORITE_SLAB, List.of(EN_US.Slab(EN_US.Diorite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_diorite_wall", CUT_POLISHED_DIORITE_WALL, List.of(EN_US.Wall(EN_US.Diorite(EN_US.Polished(Words.Cut)))));
		...
		//</editor-fold>
		//<editor-fold desc="Granite">
		Register("polished_granite_wall", POLISHED_GRANITE_WALL, List.of(EN_US.Wall(EN_US.Granite(Words.Polished))));
		...
		Register("cut_polished_granite", CUT_POLISHED_GRANITE, List.of(EN_US.Granite(EN_US.Polished(Words.Cut))));
		Register("cut_polished_granite_stairs", CUT_POLISHED_GRANITE_STAIRS, List.of(EN_US.Stairs(EN_US.Granite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_granite_slab", CUT_POLISHED_GRANITE_SLAB, List.of(EN_US.Slab(EN_US.Granite(EN_US.Polished(Words.Cut)))));
		Register("cut_polished_granite_wall", CUT_POLISHED_GRANITE_WALL, List.of(EN_US.Wall(EN_US.Granite(EN_US.Polished(Words.Cut)))));
		...
		//</editor-fold>
		//<editor-fold desc="Sandstone">
		Register("smooth_sandstone_wall", SMOOTH_SANDSTONE_WALL, List.of(EN_US.Wall(EN_US.Sandstone(Words.Smooth))));
		Register("smooth_red_sandstone_wall", SMOOTH_RED_SANDSTONE_WALL, List.of(EN_US.Wall(EN_US.Sandstone(EN_US.Red(Words.Smooth)))));
		//</editor-fold>
		//<editor-fold desc="Prismarine">
		Register("prismarine_rod", PRISMARINE_ROD, List.of(EN_US.Rod(Words.Prismarine)));
		Register("prismarine_torch", "prismarine_wall_torch", PRISMARINE_TORCH, List.of(EN_US._Torch(Words.Prismarine)));
		Register("prismarine_soul_torch", "prismarine_soul_wall_torch", PRISMARINE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Prismarine))));
		Register("prismarine_ender_torch", "prismarine_ender_wall_torch", PRISMARINE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Prismarine))));
		Register("underwater_prismarine_torch", "underwater_prismarine_wall_torch", UNDERWATER_PRISMARINE_TORCH, List.of(EN_US._Torch(EN_US.Prismarine(Words.Underwater))));
		Register("chiseled_prismarine_bricks", CHISELED_PRISMARINE_BRICKS, List.of(EN_US.Bricks(EN_US.Prismarine(Words.Chiseled))));
		Register("smooth_chiseled_prismarine_bricks", SMOOTH_CHISELED_PRISMARINE_BRICKS, List.of(EN_US.Bricks(EN_US.Prismarine(EN_US.Chiseled(Words.Smooth)))));
		Register("cut_prismarine_bricks", CUT_PRISMARINE_BRICKS, List.of(EN_US.Bricks(EN_US.Prismarine(Words.Cut))));
		Register("cut_prismarine_brick_stairs", CUT_PRISMARINE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Prismarine(Words.Cut)))));
		Register("cut_prismarine_brick_slab", CUT_PRISMARINE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Prismarine(Words.Cut)))));
		...
		Register("prismarine_tiles", PRISMARINE_TILES, List.of(EN_US.Tiles(Words.Prismarine)));
		Register("prismarine_tile_stairs", PRISMARINE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Prismarine))));
		Register("prismarine_tile_slab", PRISMARINE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Prismarine))));
		Register("prismarine_tile_wall", PRISMARINE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Prismarine))));
		Register("dark_prismarine_wall", DARK_PRISMARINE_WALL, List.of(EN_US.Wall(EN_US.Prismarine(Words.Dark))));
		//</editor-fold>
		//<editor-fold desc="Basalt">
		Register("polished_basalt_slab", POLISHED_BASALT_SLAB, List.of(EN_US.Slab(EN_US.Basalt(Words.Polished))));
		Register("smooth_basalt_stairs", SMOOTH_BASALT_STAIRS, List.of(EN_US.Stairs(EN_US.Basalt(Words.Smooth))));
		Register("smooth_basalt_slab", SMOOTH_BASALT_SLAB, List.of(EN_US.Slab(EN_US.Basalt(Words.Smooth))));
		Register("smooth_basalt_wall", SMOOTH_BASALT_WALL, List.of(EN_US.Wall(EN_US.Basalt(Words.Smooth))));
		Register("smooth_basalt_bricks", SMOOTH_BASALT_BRICKS, List.of(EN_US.Bricks(EN_US.Basalt(Words.Smooth))));
		Register("smooth_basalt_brick_stairs", SMOOTH_BASALT_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Basalt(Words.Smooth)))));
		Register("smooth_basalt_brick_slab", SMOOTH_BASALT_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Basalt(Words.Smooth)))));
		Register("smooth_basalt_brick_wall", SMOOTH_BASALT_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Basalt(Words.Smooth)))));
		//</editor-fold>
		//<editor-fold desc="Calcite">
		...
		Register("smooth_calcite", SMOOTH_CALCITE, List.of(EN_US.Calcite(Words.Smooth)));
		Register("smooth_calcite_stairs", SMOOTH_CALCITE_STAIRS, List.of(EN_US.Stairs(EN_US.Calcite(Words.Smooth))));
		Register("smooth_calcite_slab", SMOOTH_CALCITE_SLAB, List.of(EN_US.Slab(EN_US.Calcite(Words.Smooth))));
		Register("smooth_calcite_wall", SMOOTH_CALCITE_WALL, List.of(EN_US.Wall(EN_US.Calcite(Words.Smooth))));
		...
		//</editor-fold>
		//<editor-fold desc="Dripstone">
		Register("dripstone_stairs", DRIPSTONE_STAIRS, List.of(EN_US.Stairs(Words.Dripstone)));
		Register("dripstone_slab", DRIPSTONE_SLAB, List.of(EN_US.Slab(Words.Dripstone)));
		Register("dripstone_wall", DRIPSTONE_WALL, List.of(EN_US.Wall(Words.Dripstone)));
		Register("smooth_dripstone", SMOOTH_DRIPSTONE, List.of(EN_US.Dripstone(Words.Smooth)));
		Register("smooth_dripstone_stairs", SMOOTH_DRIPSTONE_STAIRS, List.of(EN_US.Stairs(EN_US.Dripstone(Words.Smooth))));
		Register("smooth_dripstone_slab", SMOOTH_DRIPSTONE_SLAB, List.of(EN_US.Slab(EN_US.Dripstone(Words.Smooth))));
		Register("smooth_dripstone_wall", SMOOTH_DRIPSTONE_WALL, List.of(EN_US.Wall(EN_US.Dripstone(Words.Smooth))));
		Register("dripstone_bricks", DRIPSTONE_BRICKS, List.of(EN_US.Bricks(Words.Dripstone)));
		Register("dripstone_brick_stairs", DRIPSTONE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Dripstone))));
		Register("dripstone_brick_slab", DRIPSTONE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Dripstone))));
		Register("dripstone_brick_wall", DRIPSTONE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Dripstone))));
		Register("chiseled_dripstone_bricks", CHISELED_DRIPSTONE_BRICKS, List.of(EN_US.Bricks(EN_US.Dripstone(Words.Chiseled))));
		Register("dripstone_tiles", DRIPSTONE_TILES, List.of(EN_US.Tiles(Words.Dripstone)));
		Register("dripstone_tile_stairs", DRIPSTONE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Dripstone))));
		Register("dripstone_tile_slab", DRIPSTONE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Dripstone))));
		Register("dripstone_tile_wall", DRIPSTONE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Dripstone))));
		//</editor-fold>
		//<editor-fold desc="Tuff">
		Register("minecraft:tuff_stairs", TUFF_STAIRS, List.of(EN_US.Stairs(Words.Tuff)));
		Register("minecraft:tuff_slab", TUFF_SLAB, List.of(EN_US.Slab(Words.Tuff)));
		Register("minecraft:tuff_wall", TUFF_WALL, List.of(EN_US.Wall(Words.Tuff)));
		Register("minecraft:polished_tuff", POLISHED_TUFF, List.of(EN_US.Tuff(Words.Polished)));
		Register("minecraft:polished_tuff_stairs", POLISHED_TUFF_STAIRS, List.of(EN_US.Stairs(EN_US.Tuff(Words.Polished))));
		Register("minecraft:polished_tuff_slab", POLISHED_TUFF_SLAB, List.of(EN_US.Slab(EN_US.Tuff(Words.Polished))));
		Register("minecraft:polished_tuff_wall", POLISHED_TUFF_WALL, List.of(EN_US.Wall(EN_US.Tuff(Words.Polished))));
		Register("minecraft:tuff_bricks", TUFF_BRICKS, List.of(EN_US.Bricks(Words.Tuff)));
		Register("minecraft:tuff_brick_stairs", TUFF_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Tuff))));
		Register("minecraft:tuff_brick_slab", TUFF_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Tuff))));
		Register("minecraft:tuff_brick_wall", TUFF_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Tuff))));
		...
		Register("tuff_tiles", TUFF_TILES, List.of(EN_US.Tiles(Words.Tuff)));
		Register("tuff_tile_stairs", TUFF_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Tuff))));
		Register("tuff_tile_slab", TUFF_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Tuff))));
		Register("tuff_tile_wall", TUFF_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Tuff))));
		//</editor-fold>
		//<editor-fold desc="Shale">
		Register("shale", SHALE, List.of(Words.Shale));
		Register("cobbled_shale", COBBLED_SHALE, List.of(EN_US.Shale(Words.Cobbled)));
		Register("cobbled_shale_stairs", COBBLED_SHALE_STAIRS, List.of(EN_US.Stairs(EN_US.Shale(Words.Cobbled))));
		Register("cobbled_shale_slab", COBBLED_SHALE_SLAB, List.of(EN_US.Slab(EN_US.Shale(Words.Cobbled))));
		Register("cobbled_shale_wall", COBBLED_SHALE_WALL, List.of(EN_US.Wall(EN_US.Shale(Words.Cobbled))));
		Register("polished_shale", POLISHED_SHALE, List.of(EN_US.Shale(Words.Polished)));
		Register("polished_shale_stairs", POLISHED_SHALE_STAIRS, List.of(EN_US.Stairs(EN_US.Shale(Words.Polished))));
		Register("polished_shale_slab", POLISHED_SHALE_SLAB, List.of(EN_US.Slab(EN_US.Shale(Words.Polished))));
		Register("polished_shale_wall", POLISHED_SHALE_WALL, List.of(EN_US.Wall(EN_US.Shale(Words.Polished))));
		Register("shale_bricks", SHALE_BRICKS, List.of(EN_US.Bricks(Words.Shale)));
		Register("shale_brick_stairs", SHALE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Shale))));
		Register("shale_brick_slab", SHALE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Shale))));
		Register("shale_brick_wall", SHALE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Shale))));
		Register("shale_tiles", SHALE_TILES, List.of(EN_US.Tiles(Words.Shale)));
		Register("shale_tile_stairs", SHALE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Shale))));
		Register("shale_tile_slab", SHALE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Shale))));
		Register("shale_tile_wall", SHALE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Shale))));
		//</editor-fold>
		//<editor-fold desc="End Stone">
		...
		Register("cobbled_end_shale", COBBLED_END_SHALE, List.of(EN_US.Shale(EN_US.End(Words.Cobbled))));
		Register("cobbled_end_shale_stairs", COBBLED_END_SHALE_STAIRS, List.of(EN_US.Stairs(EN_US.Shale(EN_US.End(Words.Cobbled)))));
		Register("cobbled_end_shale_slab", COBBLED_END_SHALE_SLAB, List.of(EN_US.Slab(EN_US.Shale(EN_US.End(Words.Cobbled)))));
		Register("cobbled_end_shale_wall", COBBLED_END_SHALE_WALL, List.of(EN_US.Wall(EN_US.Shale(EN_US.End(Words.Cobbled)))));
		...
		//</editor-fold>
		//<editor-fold desc="Purpur">
		Register("purpur_wall", PURPUR_WALL, List.of(EN_US.Wall(Words.Purpur)));
		Register("cracked_purpur_block", CRACKED_PURPUR_BLOCK, List.of(EN_US.Block(EN_US.Purpur(Words.Cracked))));
		...
		Register("purpur_mosaic", PURPUR_MOSAIC, List.of(EN_US.Mosaic(Words.Purpur)));
		Register("purpur_mosaic_stairs", PURPUR_MOSAIC_STAIRS, List.of(EN_US.Stairs(EN_US.Mosaic(Words.Purpur))));
		Register("purpur_mosaic_slab", PURPUR_MOSAIC_SLAB, List.of(EN_US.Slab(EN_US.Mosaic(Words.Purpur))));
		Register("purpur_mosaic_wall", PURPUR_MOSAIC_WALL, List.of(EN_US.Wall(EN_US.Mosaic(Words.Purpur))));
		Register("smooth_purpur", SMOOTH_PURPUR, List.of(EN_US.Purpur(Words.Smooth)));
		Register("smooth_purpur_stairs", SMOOTH_PURPUR_STAIRS, List.of(EN_US.Stairs(EN_US.Purpur(Words.Smooth))));
		Register("smooth_purpur_slab", SMOOTH_PURPUR_SLAB, List.of(EN_US.Slab(EN_US.Purpur(Words.Smooth))));
		Register("smooth_purpur_wall", SMOOTH_PURPUR_WALL, List.of(EN_US.Wall(EN_US.Purpur(Words.Smooth))));
		Register("purpur_bricks", PURPUR_BRICKS, List.of(EN_US.Bricks(Words.Purpur)));
		Register("purpur_brick_stairs", PURPUR_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Purpur))));
		Register("purpur_brick_slab", PURPUR_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Purpur))));
		Register("purpur_brick_wall", PURPUR_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Purpur))));
		Register("chiseled_purpur_bricks", CHISELED_PURPUR_BRICKS, List.of(EN_US.Bricks(EN_US.Purpur(Words.Chiseled))));
		Register("smooth_chiseled_purpur_bricks", SMOOTH_CHISELED_PURPUR_BRICKS, List.of(EN_US.Bricks(EN_US.Purpur(EN_US.Chiseled(Words.Smooth)))));
		Register("purpur_tiles", PURPUR_TILES, List.of(EN_US.Tiles(Words.Purpur)));
		Register("purpur_tile_stairs", PURPUR_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(Words.Purpur))));
		Register("purpur_tile_slab", PURPUR_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(Words.Purpur))));
		Register("purpur_tile_wall", PURPUR_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(Words.Purpur))));
		//</editor-fold>
		//<editor-fold desc="Shulker">
		Register("shulker_helmet", SHULKER_HELMET, List.of(EN_US.Helmet(Words.Shulker)));
		Register("shulker_chestplate", SHULKER_CHESTPLATE, List.of(EN_US.Chestplate(Words.Shulker)));
		Register("shulker_leggings", SHULKER_LEGGINGS, List.of(EN_US.Leggings(Words.Shulker)));
		Register("shulker_boots", SHULKER_BOOTS, List.of(EN_US.Boots(Words.Shulker)));
		//</editor-fold>
		...
		//</editor-fold>
		//<editor-fold desc="Obsidian">
		Register("obsidian_stairs", OBSIDIAN_STAIRS, List.of(EN_US.Stairs(Words.Obsidian)));
		Register("obsidian_slab", OBSIDIAN_SLAB, List.of(EN_US.Slab(Words.Obsidian)));
		Register("obsidian_wall", OBSIDIAN_WALL, List.of(EN_US.Wall(Words.Obsidian)));
		Register("polished_obsidian", POLISHED_OBSIDIAN, List.of(EN_US.Obsidian(Words.Polished)));
		Register("polished_obsidian_stairs", POLISHED_OBSIDIAN_STAIRS, List.of(EN_US.Stairs(EN_US.Obsidian(Words.Polished))));
		Register("polished_obsidian_slab", POLISHED_OBSIDIAN_SLAB, List.of(EN_US.Slab(EN_US.Obsidian(Words.Polished))));
		Register("polished_obsidian_wall", POLISHED_OBSIDIAN_WALL, List.of(EN_US.Wall(EN_US.Obsidian(Words.Polished))));
		Register("polished_obsidian_bricks", POLISHED_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(Words.Polished))));
		Register("polished_obsidian_brick_stairs", POLISHED_OBSIDIAN_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Obsidian(Words.Polished)))));
		Register("polished_obsidian_brick_slab", POLISHED_OBSIDIAN_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Obsidian(Words.Polished)))));
		Register("polished_obsidian_brick_wall", POLISHED_OBSIDIAN_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Obsidian(Words.Polished)))));
		Register("cracked_polished_obsidian_bricks", CRACKED_POLISHED_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(EN_US.Polished(Words.Cracked)))));
		CrackedBlocks.Register(POLISHED_OBSIDIAN_BRICKS, CRACKED_POLISHED_OBSIDIAN_BRICKS);
		//Crying
		Register("crying_obsidian_stairs", CRYING_OBSIDIAN_STAIRS, List.of(EN_US.Stairs(EN_US.Obsidian(Words.Crying))));
		Register("crying_obsidian_slab", CRYING_OBSIDIAN_SLAB, List.of(EN_US.Slab(EN_US.Obsidian(Words.Crying))));
		Register("crying_obsidian_wall", CRYING_OBSIDIAN_WALL, List.of(EN_US.Wall(EN_US.Obsidian(Words.Crying))));
		Register("polished_crying_obsidian", POLISHED_CRYING_OBSIDIAN, List.of(EN_US.Obsidian(EN_US.Crying(Words.Polished))));
		Register("polished_crying_obsidian_stairs", POLISHED_CRYING_OBSIDIAN_STAIRS, List.of(EN_US.Stairs(EN_US.Obsidian(EN_US.Crying(Words.Polished)))));
		Register("polished_crying_obsidian_slab", POLISHED_CRYING_OBSIDIAN_SLAB, List.of(EN_US.Slab(EN_US.Obsidian(EN_US.Crying(Words.Polished)))));
		Register("polished_crying_obsidian_wall", POLISHED_CRYING_OBSIDIAN_WALL, List.of(EN_US.Wall(EN_US.Obsidian(EN_US.Crying(Words.Polished)))));
		Register("polished_crying_obsidian_bricks", POLISHED_CRYING_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(EN_US.Crying(Words.Polished)))));
		Register("polished_crying_obsidian_brick_stairs", POLISHED_CRYING_OBSIDIAN_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Obsidian(EN_US.Crying(Words.Polished))))));
		Register("polished_crying_obsidian_brick_slab", POLISHED_CRYING_OBSIDIAN_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Obsidian(EN_US.Crying(Words.Polished))))));
		Register("polished_crying_obsidian_brick_wall", POLISHED_CRYING_OBSIDIAN_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Obsidian(EN_US.Crying(Words.Polished))))));
		Register("cracked_polished_crying_obsidian_bricks", CRACKED_POLISHED_CRYING_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(EN_US.Crying(EN_US.Polished(Words.Cracked))))));
		CrackedBlocks.Register(POLISHED_CRYING_OBSIDIAN_BRICKS, CRACKED_POLISHED_CRYING_OBSIDIAN_BRICKS);
		//Bleeding
		Register("bleeding_obsidian", BLEEDING_OBSIDIAN, List.of(EN_US.Obsidian(Words.Bleeding)));
		Register("bleeding_obsidian_stairs", BLEEDING_OBSIDIAN_STAIRS, List.of(EN_US.Stairs(EN_US.Obsidian(Words.Bleeding))));
		Register("bleeding_obsidian_slab", BLEEDING_OBSIDIAN_SLAB, List.of(EN_US.Slab(EN_US.Obsidian(Words.Bleeding))));
		Register("bleeding_obsidian_wall", BLEEDING_OBSIDIAN_WALL, List.of(EN_US.Wall(EN_US.Obsidian(Words.Bleeding))));
		Register("polished_bleeding_obsidian", POLISHED_BLEEDING_OBSIDIAN, List.of(EN_US.Obsidian(EN_US.Bleeding(Words.Polished))));
		Register("polished_bleeding_obsidian_stairs", POLISHED_BLEEDING_OBSIDIAN_STAIRS, List.of(EN_US.Stairs(EN_US.Obsidian(EN_US.Bleeding(Words.Polished)))));
		Register("polished_bleeding_obsidian_slab", POLISHED_BLEEDING_OBSIDIAN_SLAB, List.of(EN_US.Slab(EN_US.Obsidian(EN_US.Bleeding(Words.Polished)))));
		Register("polished_bleeding_obsidian_wall", POLISHED_BLEEDING_OBSIDIAN_WALL, List.of(EN_US.Wall(EN_US.Obsidian(EN_US.Bleeding(Words.Polished)))));
		Register("polished_bleeding_obsidian_bricks", POLISHED_BLEEDING_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(EN_US.Bleeding(Words.Polished)))));
		Register("polished_bleeding_obsidian_brick_stairs", POLISHED_BLEEDING_OBSIDIAN_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Obsidian(EN_US.Bleeding(Words.Polished))))));
		Register("polished_bleeding_obsidian_brick_slab", POLISHED_BLEEDING_OBSIDIAN_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Obsidian(EN_US.Bleeding(Words.Polished))))));
		Register("polished_bleeding_obsidian_brick_wall", POLISHED_BLEEDING_OBSIDIAN_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Obsidian(EN_US.Bleeding(Words.Polished))))));
		Register("cracked_polished_bleeding_obsidian_bricks", CRACKED_POLISHED_BLEEDING_OBSIDIAN_BRICKS, List.of(EN_US.Bricks(EN_US.Obsidian(EN_US.Bleeding(EN_US.Polished(Words.Cracked))))));
		CrackedBlocks.Register(POLISHED_BLEEDING_OBSIDIAN_BRICKS, CRACKED_POLISHED_BLEEDING_OBSIDIAN_BRICKS);
		//Tools & Armor
		Register("obsidian_shovel", OBSIDIAN_SHOVEL, List.of(EN_US.Shovel(Words.Obsidian)));
		Register("obsidian_pickaxe", OBSIDIAN_PICKAXE, List.of(EN_US.Pickaxe(Words.Obsidian)));
		Register("obsidian_axe", OBSIDIAN_AXE, List.of(EN_US.Axe(Words.Obsidian)));
		Register("obsidian_hoe", OBSIDIAN_HOE, List.of(EN_US.Hoe(Words.Obsidian)));
		Register("obsidian_sword", OBSIDIAN_SWORD, List.of(EN_US.Sword(Words.Obsidian)));
		Register("obsidian_knife", OBSIDIAN_KNIFE, List.of(EN_US.Knife(Words.Obsidian)));
		Register("obsidian_hammer", OBSIDIAN_HAMMER, List.of(EN_US.Hammer(Words.Obsidian)));
		//</editor-fold>
		//<editor-fold desc="Amethyst">
		...
		Register("tinted_glass_pane", TINTED_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(Words.Tinted))));
		Register("tinted_glass_slab", TINTED_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(Words.Tinted))));
		Register("tinted_glass_trapdoor", TINTED_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(Words.Tinted))));
		//</editor-fold>
		//<editor-fold desc="Ruby Glass">
		Register("ruby_goggles", RUBY_GOGGLES, List.of(EN_US.Goggles(Words.Ruby)));
		Register("ruby_glass", RUBY_GLASS, List.of(EN_US.Glass(Words.Ruby)));
		Register("ruby_glass_pane", RUBY_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(Words.Ruby))));
		Register("ruby_glass_slab", RUBY_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(Words.Ruby))));
		Register("ruby_glass_trapdoor", RUBY_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(Words.Ruby))));
		//</editor-fold>
		//<editor-fold desc="Sapphire Glass">
		Register("sapphire_goggles", SAPPHIRE_GOGGLES, List.of(EN_US.Goggles(Words.Sapphire)));
		Register("sapphire_glass", SAPPHIRE_GLASS, List.of(EN_US.Glass(Words.Sapphire)));
		Register("sapphire_glass_pane", SAPPHIRE_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(Words.Sapphire))));
		Register("sapphire_glass_slab", SAPPHIRE_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(Words.Sapphire))));
		Register("sapphire_glass_trapdoor", SAPPHIRE_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(Words.Sapphire))));
		//</editor-fold>
		//<editor-fold desc="Glass">
		Register("glass_slab", GLASS_SLAB, List.of(EN_US.Slab(Words.Glass)));
		Register("glass_trapdoor", GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Glass)));
		...
		//</editor-fold>
		//<editor-fold desc="Blaze">
		Register("blaze_powder_block", BLAZE_POWDER_BLOCK, List.of(EN_US.Block(EN_US.Powder(Words.Blaze))));
		Register("blaze_torch", "blaze_wall_torch", BLAZE_TORCH, List.of(EN_US._Torch(Words.Blaze)));
		Register("blaze_soul_torch", "blaze_soul_wall_torch", BLAZE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Blaze))));
		Register("blaze_ender_torch", "blaze_ender_wall_torch", BLAZE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Blaze))));
		Register("underwater_blaze_torch", "underwater_blaze_wall_torch", UNDERWATER_BLAZE_TORCH, List.of(EN_US._Torch(EN_US.Blaze(Words.Underwater))));
		//</editor-fold>
		//<editor-fold desc="Emerald">
		Register("emerald_stairs", EMERALD_STAIRS, List.of(EN_US.Stairs(Words.Emerald)));
		Register("emerald_slab", EMERALD_SLAB, List.of(EN_US.Slab(Words.Emerald)));
		Register("emerald_wall", EMERALD_WALL, List.of(EN_US.Wall(Words.Emerald)));
		Register("emerald_bricks", EMERALD_BRICKS, List.of(EN_US.Bricks(Words.Emerald)));
		Register("emerald_brick_stairs", EMERALD_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Emerald))));
		Register("emerald_brick_slab", EMERALD_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Emerald))));
		Register("emerald_brick_wall", EMERALD_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Emerald))));
		Register("cut_emerald", CUT_EMERALD, List.of(EN_US.Emerald(Words.Cut)));
		Register("cut_emerald_stairs", CUT_EMERALD_STAIRS, List.of(EN_US.Stairs(EN_US.Emerald(Words.Cut))));
		Register("cut_emerald_slab", CUT_EMERALD_SLAB, List.of(EN_US.Slab(EN_US.Emerald(Words.Cut))));
		Register("cut_emerald_wall", CUT_EMERALD_WALL, List.of(EN_US.Wall(EN_US.Emerald(Words.Cut))));
		Register("emerald_shovel", EMERALD_SHOVEL, List.of(EN_US.Shovel(Words.Emerald)));
		Register("emerald_pickaxe", EMERALD_PICKAXE, List.of(EN_US.Pickaxe(Words.Emerald)));
		Register("emerald_axe", EMERALD_AXE, List.of(EN_US.Axe(Words.Emerald)));
		Register("emerald_hoe", EMERALD_HOE, List.of(EN_US.Hoe(Words.Emerald)));
		Register("emerald_sword", EMERALD_SWORD, List.of(EN_US.Sword(Words.Emerald)));
		Register("emerald_knife", EMERALD_KNIFE, List.of(EN_US.Knife(Words.Emerald)));
		Register("emerald_hammer", EMERALD_HAMMER, List.of(EN_US.Hammer(Words.Emerald)));
		Register("emerald_helmet", EMERALD_HELMET, List.of(EN_US.Helmet(Words.Emerald)));
		Register("emerald_chestplate", EMERALD_CHESTPLATE, List.of(EN_US.Chestplate(Words.Emerald)));
		Register("emerald_leggings", EMERALD_LEGGINGS, List.of(EN_US.Leggings(Words.Emerald)));
		Register("emerald_boots", EMERALD_BOOTS, List.of(EN_US.Boots(Words.Emerald)));
		Register("emerald_horse_armor", EMERALD_HORSE_ARMOR, List.of(EN_US.Armor(EN_US.Horse(Words.Emerald))));
		//</editor-fold>
		//<editor-fold desc="Ruby">
		Register("ruby_ore", RUBY_ORE, List.of(EN_US.Ore(Words.Ruby)));
		Register("deepslate_ruby_ore", DEEPSLATE_RUBY_ORE, List.of(EN_US.Ore(EN_US.Ruby(Words.Deepslate))));
		Register("ruby_block", RUBY_BLOCK, List.of(EN_US.Block(Words.Ruby)));
		Register("ruby_stairs", RUBY_STAIRS, List.of(EN_US.Stairs(Words.Ruby)));
		Register("ruby_slab", RUBY_SLAB, List.of(EN_US.Slab(Words.Ruby)));
		Register("ruby_wall", RUBY_WALL, List.of(EN_US.Wall(Words.Ruby)));
		Register("ruby_bricks", RUBY_BRICKS, List.of(EN_US.Bricks(Words.Ruby)));
		Register("ruby_brick_stairs", RUBY_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Ruby))));
		Register("ruby_brick_slab", RUBY_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Ruby))));
		Register("ruby_brick_wall", RUBY_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Ruby))));
		Register("ruby", RUBY, List.of(Words.Ruby));
		//</editor-fold>
		//<editor-fold desc="Sapphire">
		Register("sapphire_ore", SAPPHIRE_ORE, List.of(EN_US.Ore(Words.Sapphire)));
		Register("deepslate_sapphire_ore", DEEPSLATE_SAPPHIRE_ORE, List.of(EN_US.Ore(EN_US.Sapphire(Words.Deepslate))));
		Register("sapphire_block", SAPPHIRE_BLOCK, List.of(EN_US.Block(Words.Sapphire)));
		Register("sapphire_stairs", SAPPHIRE_STAIRS, List.of(EN_US.Stairs(Words.Sapphire)));
		Register("sapphire_slab", SAPPHIRE_SLAB, List.of(EN_US.Slab(Words.Sapphire)));
		Register("sapphire_wall", SAPPHIRE_WALL, List.of(EN_US.Wall(Words.Sapphire)));
		Register("sapphire_bricks", SAPPHIRE_BRICKS, List.of(EN_US.Bricks(Words.Sapphire)));
		Register("sapphire_brick_stairs", SAPPHIRE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Sapphire))));
		Register("sapphire_brick_slab", SAPPHIRE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Sapphire))));
		Register("sapphire_brick_wall", SAPPHIRE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Sapphire))));
		Register("sapphire", SAPPHIRE, List.of(Words.Sapphire));
		//</editor-fold>
		//<editor-fold desc="Diamond">
		...
		//</editor-fold>
		//<editor-fold desc="Quartz">
		Register("quartz_ore", QUARTZ_ORE, List.of(EN_US.Ore(Words.Quartz)));
		Register("deepslate_quartz_ore", DEEPSLATE_QUARTZ_ORE, List.of(EN_US.Ore(EN_US.Quartz(Words.Deepslate))));
		Register("quartz_crystal_block", QUARTZ_CRYSTAL_BLOCK, List.of(EN_US.Block(EN_US.Crystal(Words.Quartz))));
		Register("quartz_crystal_stairs", QUARTZ_CRYSTAL_STAIRS, List.of(EN_US.Stairs(EN_US.Crystal(Words.Quartz))));
		Register("quartz_crystal_slab", QUARTZ_CRYSTAL_SLAB, List.of(EN_US.Slab(EN_US.Crystal(Words.Quartz))));
		Register("quartz_crystal_wall", QUARTZ_CRYSTAL_WALL, List.of(EN_US.Wall(EN_US.Crystal(Words.Quartz))));
		Register("smooth_quartz_wall", SMOOTH_QUARTZ_WALL, List.of(EN_US.Wall(EN_US.Quartz(Words.Smooth))));
		Register("quartz_wall", QUARTZ_WALL, List.of(EN_US.Wall(Words.Quartz)));
		Register("quartz_brick_stairs", QUARTZ_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Quartz))));
		Register("quartz_brick_slab", QUARTZ_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Quartz))));
		Register("quartz_brick_wall", QUARTZ_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Quartz))));
		Register("chiseled_quartz_bricks", CHISELED_QUARTZ_BRICKS, List.of(EN_US.Bricks(EN_US.Quartz(Words.Chiseled))));
		Register("smooth_chiseled_quartz_bricks", SMOOTH_CHISELED_QUARTZ_BRICKS, List.of(EN_US.Bricks(EN_US.Quartz(EN_US.Chiseled(Words.Smooth)))));
		Register("quartz_shovel", QUARTZ_SHOVEL, List.of(EN_US.Shovel(Words.Quartz)));
		Register("quartz_pickaxe", QUARTZ_PICKAXE, List.of(EN_US.Pickaxe(Words.Quartz)));
		Register("quartz_axe", QUARTZ_AXE, List.of(EN_US.Axe(Words.Quartz)));
		Register("quartz_hoe", QUARTZ_HOE, List.of(EN_US.Hoe(Words.Quartz)));
		Register("quartz_sword", QUARTZ_SWORD, List.of(EN_US.Sword(Words.Quartz)));
		Register("quartz_knife", QUARTZ_KNIFE, List.of(EN_US.Knife(Words.Quartz)));
		Register("quartz_hammer", QUARTZ_HAMMER, List.of(EN_US.Hammer(Words.Quartz)));
		Register("quartz_helmet", QUARTZ_HELMET, List.of(EN_US.Helmet(Words.Quartz)));
		Register("quartz_chestplate", QUARTZ_CHESTPLATE, List.of(EN_US.Chestplate(Words.Quartz)));
		Register("quartz_leggings", QUARTZ_LEGGINGS, List.of(EN_US.Leggings(Words.Quartz)));
		Register("quartz_boots", QUARTZ_BOOTS, List.of(EN_US.Boots(Words.Quartz)));
		Register("quartz_horse_armor", QUARTZ_HORSE_ARMOR, List.of(EN_US.Armor(EN_US.Horse(Words.Quartz))));
		//</editor-fold>
		RegisterIron();
		RegisterGold();
		ModCopperRegistry.RegisterCopper();
		//<editor-fold desc="Raw Metal">
		Register("raw_copper_slab", RAW_COPPER_SLAB, List.of(EN_US.Slab(EN_US.Copper(Words.Raw))));
		Register("raw_gold_slab", RAW_GOLD_SLAB, List.of(EN_US.Slab(EN_US.Gold(Words.Raw))));
		Register("raw_iron_slab", RAW_IRON_SLAB, List.of(EN_US.Slab(EN_US.Iron(Words.Raw))));
		//</editor-fold>
		//<editor-fold desc="Netherite">
		Register("netherite_nugget", NETHERITE_NUGGET, List.of(EN_US.Nugget(Words.Netherite)));
		Register("netherite_rod", NETHERITE_ROD, List.of(EN_US.Rod(Words.Netherite)));
		Register("netherite_torch", "netherite_wall_torch", NETHERITE_TORCH, List.of(EN_US._Torch(Words.Netherite)));
		Register("netherite_soul_torch", "netherite_soul_wall_torch", NETHERITE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Netherite))));
		Register("netherite_ender_torch", "netherite_ender_wall_torch", NETHERITE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Netherite))));
		Register("underwater_netherite_torch", "underwater_netherite_wall_torch", UNDERWATER_NETHERITE_TORCH, List.of(EN_US._Torch(EN_US.Netherite(Words.Underwater))));
		Register("netherite_lantern", NETHERITE_LANTERN, List.of(EN_US.Lantern(Words.Netherite)));
		Register("netherite_soul_lantern", NETHERITE_SOUL_LANTERN, List.of(EN_US.Lantern(EN_US.Soul(Words.Netherite))));
		Register("netherite_ender_lantern", NETHERITE_ENDER_LANTERN, List.of(EN_US.Lantern(EN_US.Ender(Words.Netherite))));
		Register("netherite_button", NETHERITE_BUTTON, List.of(EN_US.Button(Words.Netherite)));
		Register("netherite_chain", NETHERITE_CHAIN, List.of(EN_US.Chain(Words.Netherite)));
		Register("heavy_netherite_chain", HEAVY_NETHERITE_CHAIN, List.of(EN_US.Chain(EN_US.Netherite(Words.Heavy))));
		Register("netherite_bars", NETHERITE_BARS, List.of(EN_US.Bars(Words.Netherite)));
		Register("netherite_stairs", NETHERITE_STAIRS, List.of(EN_US.Stairs(Words.Netherite)));
		Register("netherite_slab", NETHERITE_SLAB, List.of(EN_US.Slab(Words.Netherite)));
		Register("netherite_wall", NETHERITE_WALL, List.of(EN_US.Wall(Words.Netherite)));
		Register("netherite_bricks", NETHERITE_BRICKS, List.of(EN_US.Bricks(Words.Netherite)));
		Register("netherite_brick_stairs", NETHERITE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Netherite))));
		Register("netherite_brick_slab", NETHERITE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Netherite))));
		Register("netherite_brick_wall", NETHERITE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Netherite))));
		Register("cut_netherite", CUT_NETHERITE, List.of(EN_US.Netherite(Words.Cut)));
		Register("cut_netherite_pillar", CUT_NETHERITE_PILLAR, List.of(EN_US.Pillar(EN_US.Netherite(Words.Cut))));
		Register("cut_netherite_stairs", CUT_NETHERITE_STAIRS, List.of(EN_US.Stairs(Words.Netherite)));
		Register("cut_netherite_slab", CUT_NETHERITE_SLAB, List.of(EN_US.Slab(EN_US.Netherite(Words.Cut))));
		Register("cut_netherite_wall", CUT_NETHERITE_WALL, List.of(EN_US.Wall(EN_US.Netherite(Words.Cut))));
		Register("netherite_door", NETHERITE_DOOR, List.of(EN_US.Door(Words.Netherite)));
		Register("netherite_trapdoor", NETHERITE_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Netherite)));
		Register("crushing_weighted_pressure_plate", CRUSHING_WEIGHTED_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(EN_US.Weighted(Words.Crushing)))));
		Register("netherite_hammer", NETHERITE_HAMMER, List.of(EN_US.Hammer(Words.Netherite)));
		Register("netherite_shears", NETHERITE_SHEARS, List.of(EN_US.Shears(Words.Netherite)));
		Register("netherite_horse_armor", NETHERITE_HORSE_ARMOR, List.of(EN_US.Armor(EN_US.Horse(Words.Netherite))));
		//Bucket
		Register("netherite_bucket", NETHERITE_BUCKET, List.of(EN_US.Bucket(Words.Netherite)));
		DispenserBlock.registerBehavior(NETHERITE_BUCKET, new BucketDispenserBehavior(NETHERITE_BUCKET_PROVIDER));
		Register("netherite_water_bucket", NETHERITE_WATER_BUCKET, List.of(EN_US.Bucket(EN_US.Water(Words.Netherite))));
		...
		Register("netherite_lava_bucket", NETHERITE_LAVA_BUCKET, List.of(EN_US.Bucket(EN_US.Lava(Words.Netherite))));
		Register("netherite_powder_snow_bucket", NETHERITE_POWDER_SNOW_BUCKET, List.of(EN_US.Bucket(EN_US.Snow(EN_US.Powder(Words.Netherite)))));
		...
		Register("netherite_blood_bucket", NETHERITE_BLOOD_BUCKET, List.of(EN_US.Bucket(EN_US.Blood(Words.Netherite))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(NETHERITE_BLOOD_BUCKET, BloodCauldronBlock.FillFromBucket(NETHERITE_BUCKET));
		Register("netherite_mud_bucket", NETHERITE_MUD_BUCKET, List.of(EN_US.Bucket(EN_US.Mud(Words.Netherite))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(NETHERITE_MUD_BUCKET, MudCauldronBlock.FillFromBucket(NETHERITE_BUCKET));
		Register("netherite_milk_bucket", NETHERITE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Netherite))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(NETHERITE_MILK_BUCKET, MilkCauldronBlock.FillFromBucket(NETHERITE_BUCKET));
		Register("netherite_chocolate_milk_bucket", NETHERITE_CHOCOLATE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Chocolate(Words.Netherite)))));
		Register("netherite_coffee_milk_bucket", NETHERITE_COFFEE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Coffee(Words.Netherite)))));
		Register("netherite_strawberry_milk_bucket", NETHERITE_STRAWBERRY_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Strawberry(Words.Netherite)))));
		Register("netherite_vanilla_milk_bucket", NETHERITE_VANILLA_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Vanilla(Words.Netherite)))));
		//</editor-fold>
		//<editor-fold desc="Bone">
		Register("bone_torch", "bone_wall_torch", BONE_TORCH, List.of(EN_US._Torch(Words.Bone)));
		Register("bone_soul_torch", "bone_soul_wall_torch", BONE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Bone))));
		Register("bone_ender_torch", "bone_ender_wall_torch", BONE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Bone))));
		Register("underwater_bone_torch", "underwater_bone_wall_torch", UNDERWATER_BONE_TORCH, List.of(EN_US._Torch(EN_US.Bone(Words.Underwater))));
		Register("bone_ladder", BONE_LADDER, List.of(EN_US.Ladder(Words.Bone)));
		Register("bone_slab", BONE_SLAB, List.of(EN_US.Slab(Words.Bone)));
		Register("bone_row", BONE_ROW, List.of(EN_US.Row(Words.Bone)));
		Register("bone_knife", BONE_KNIFE, List.of(EN_US.Knife(Words.Bone)));
		Register("bone_hammer", BONE_HAMMER, List.of(EN_US.Hammer(Words.Bone)));
		//</editor-fold>
		Register("bone_shard", BONE_SHARD, List.of(EN_US.Shard(Words.Bone)));
		//<editor-fold desc="Blackstone">
		Register("smooth_chiseled_polished_blackstone", SMOOTH_CHISELED_POLISHED_BLACKSTONE, List.of(EN_US.Blackstone(EN_US.Polished(EN_US.Chiseled(Words.Smooth)))));
		Register("polished_blackstone_tiles", POLISHED_BLACKSTONE_TILES, List.of(EN_US.Tiles(EN_US.Blackstone(Words.Polished))));
		Register("polished_blackstone_tile_stairs", POLISHED_BLACKSTONE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(EN_US.Blackstone(Words.Polished)))));
		Register("polished_blackstone_tile_slab", POLISHED_BLACKSTONE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(EN_US.Blackstone(Words.Polished)))));
		Register("polished_blackstone_tile_wall", POLISHED_BLACKSTONE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(EN_US.Blackstone(Words.Polished)))));
		//</editor-fold>
		//<editor-fold desc="Gilded Blackstone">
		Register("gilded_blackstone_stairs", GILDED_BLACKSTONE_STAIRS, List.of(EN_US.Stairs(EN_US.Blackstone(Words.Gilded))));
		Register("gilded_blackstone_slab", GILDED_BLACKSTONE_SLAB, List.of(EN_US.Slab(EN_US.Blackstone(Words.Gilded))));
		Register("gilded_blackstone_wall", GILDED_BLACKSTONE_WALL, List.of(EN_US.Wall(EN_US.Blackstone(Words.Gilded))));
		Register("polished_gilded_blackstone", POLISHED_GILDED_BLACKSTONE, List.of(EN_US.Blackstone(EN_US.Gilded(Words.Polished))));
		Register("polished_gilded_blackstone_stairs", POLISHED_GILDED_BLACKSTONE_STAIRS, List.of(EN_US.Stairs(EN_US.Blackstone(EN_US.Gilded(Words.Polished)))));
		Register("polished_gilded_blackstone_slab", POLISHED_GILDED_BLACKSTONE_SLAB, List.of(EN_US.Slab(EN_US.Blackstone(EN_US.Gilded(Words.Polished)))));
		Register("polished_gilded_blackstone_wall", POLISHED_GILDED_BLACKSTONE_WALL, List.of(EN_US.Wall(EN_US.Blackstone(EN_US.Gilded(Words.Polished)))));
		Register("polished_gilded_blackstone_bricks", POLISHED_GILDED_BLACKSTONE_BRICKS, List.of(EN_US.Bricks(EN_US.Blackstone(EN_US.Gilded(Words.Polished)))));
		Register("polished_gilded_blackstone_brick_stairs", POLISHED_GILDED_BLACKSTONE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		Register("polished_gilded_blackstone_brick_slab", POLISHED_GILDED_BLACKSTONE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		Register("polished_gilded_blackstone_brick_wall", POLISHED_GILDED_BLACKSTONE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		Register("cracked_polished_gilded_blackstone_bricks", CRACKED_POLISHED_GILDED_BLACKSTONE_BRICKS, List.of(EN_US.Bricks(EN_US.Blackstone(EN_US.Gilded(EN_US.Polished(Words.Cracked))))));
		...
		Register("smooth_chiseled_polished_gilded_blackstone", SMOOTH_CHISELED_POLISHED_GILDED_BLACKSTONE, List.of(EN_US.Blackstone(EN_US.Gilded(EN_US.Polished(EN_US.Chiseled(Words.Smooth))))));
		Register("polished_gilded_blackstone_tiles", POLISHED_GILDED_BLACKSTONE_TILES, List.of(EN_US.Tiles(EN_US.Blackstone(EN_US.Gilded(Words.Polished)))));
		Register("polished_gilded_blackstone_tile_stairs", POLISHED_GILDED_BLACKSTONE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		Register("polished_gilded_blackstone_tile_slab", POLISHED_GILDED_BLACKSTONE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		Register("polished_gilded_blackstone_tile_wall", POLISHED_GILDED_BLACKSTONE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(EN_US.Blackstone(EN_US.Gilded(Words.Polished))))));
		//</editor-fold>
		//<editor-fold desc="Arrows">
		Register("amethyst_arrow", AMETHYST_ARROW, List.of(EN_US.Arrow(Words.Amethyst)));
		Register("blinding_arrow", BLINDING_ARROW, List.of(EN_US.Arrow(Words.Blinding)));
		Register("bone_arrow", BONE_ARROW, List.of(EN_US.Arrow(Words.Bone)));
		Register("chorus_arrow", CHORUS_ARROW, List.of(EN_US.Arrow(Words.Chorus)));
		//</editor-fold>
		//<editor-fold desc="Golems and Gourds">
		Register("soul_jack_o_lantern", SOUL_JACK_O_LANTERN, List.of(EN_US.JackOLantern(Words.Soul)));
		Register("ender_jack_o_lantern", ENDER_JACK_O_LANTERN, List.of(EN_US.JackOLantern(Words.Ender)));
		Register("carved_melon", CARVED_MELON, List.of(EN_US.Melon(Words.Carved)));
		...
		Register("melon_lantern", MELON_LANTERN, List.of(EN_US.Lantern(Words.Melon)));
		Register("soul_melon_lantern", SOUL_MELON_LANTERN, List.of(EN_US.Lantern(EN_US.Soul(Words.Melon))));
		Register("ender_melon_lantern", ENDER_MELON_LANTERN, List.of(EN_US.Lantern(EN_US.Ender(Words.Melon))));
		//Burnt Pumpkin
		Register("burnt_pumpkin", BURNT_PUMPKIN, List.of(EN_US.Pumpkin(Words.Burnt)));
		//White Pumpkin
		...
		Register("attached_white_pumpkin_stem", ATTACHED_WHITE_PUMPKIN_STEM, List.of(EN_US.Stem(EN_US.Pumpkin(EN_US.White(Words.Attached)))));
		...
		//Rotten Pumpkin
		Register("rotten_pumpkin", ROTTEN_PUMPKIN, List.of(EN_US.Pumpkin(Words.Rotten)));
		Register("carved_rotten_pumpkin", CARVED_ROTTEN_PUMPKIN, List.of(EN_US.Pumpkin(EN_US.Rotten(Words.Carved))));
		...
		Register("rotten_jack_o_lantern", ROTTEN_JACK_O_LANTERN, List.of(EN_US.JackOLantern(Words.Rotten)));
		Register("rotten_soul_jack_o_lantern", ROTTEN_SOUL_JACK_O_LANTERN, List.of(EN_US.JackOLantern(EN_US.Soul(Words.Rotten))));
		Register("rotten_ender_jack_o_lantern", ROTTEN_ENDER_JACK_O_LANTERN, List.of(EN_US.JackOLantern(EN_US.Ender(Words.Rotten))));
		Register("rotten_pumpkin_seeds", ROTTEN_PUMPKIN_SEEDS, List.of(EN_US.Seeds(EN_US.Pumpkin(Words.Rotten))));
		CompostingChanceRegistry.INSTANCE.add(ROTTEN_PUMPKIN_SEEDS, 0.65F);
		//</editor-fold>
		//<editor-fold desc="Mushrooms">
		Register("death_cap_mushroom", DEATH_CAP_MUSHROOM, List.of(EN_US._Potted(EN_US.Mushroom(EN_US.Cap(Words.Death)))));
		...
		Register("creeper_anatomy_statue", CREEPER_ANATOMY_STATUE, List.of(EN_US.Statue(EN_US.Anatomy(Words.Creeper))));
		RegisterPlushies();
		RegisterDarkIron();
		//<editor-fold desc="Gilded Fungus">
		Register("gilded_stem", GILDED_STEM, List.of(EN_US.Stem(Words.Gilded)));
		Register("stripped_gilded_stem", STRIPPED_GILDED_STEM, List.of(EN_US.Stem(EN_US.Gilded(Words.Stripped))));
		Register("gilded_hyphae", GILDED_HYPHAE, List.of(EN_US.Hyphae(Words.Gilded)));
		Register("stripped_gilded_hyphae", STRIPPED_GILDED_HYPHAE, List.of(EN_US.Hyphae(EN_US.Gilded(Words.Stripped))));
		Register("gilded_planks", GILDED_PLANKS, List.of(EN_US.Planks(Words.Gilded)));
		Register("gilded_stairs", GILDED_STAIRS, List.of(EN_US.Stairs(Words.Gilded)));
		Register("gilded_slab", GILDED_SLAB, List.of(EN_US.Slab(Words.Gilded)));
		Register("gilded_fence", GILDED_FENCE, List.of(EN_US.Fence(Words.Gilded)));
		Register("gilded_fence_gate", GILDED_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Gilded))));
		Register("gilded_door", GILDED_DOOR, List.of(EN_US.Door(Words.Gilded)));
		Register("gilded_trapdoor", GILDED_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Gilded)));
		Register("gilded_pressure_plate", GILDED_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Gilded))));
		Register("gilded_button", GILDED_BUTTON, List.of(EN_US.Button(Words.Gilded)));
		Register("gilded", GILDED_SIGN, List.of(EN_US._Sign(Words.Gilded)));
		Register("gilded_iron_hanging_sign", "gilded_iron_wall_hanging_sign", GILDED_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("gilded_gold_hanging_sign", "gilded_gold_wall_hanging_sign", GILDED_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("gilded_copper_hanging_sign", "gilded_copper_wall_hanging_sign", GILDED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("gilded_exposed_copper_hanging_sign", "gilded_exposed_copper_wall_hanging_sign", GILDED_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("gilded_weathered_copper_hanging_sign", "gilded_weathered_copper_wall_hanging_sign", GILDED_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("gilded_oxidized_copper_hanging_sign", "gilded_oxidized_copper_wall_hanging_sign", GILDED_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("gilded_netherite_hanging_sign", "gilded_netherite_wall_hanging_sign", GILDED_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Gilded, EN_US.Chain(EN_US.Netherite(Words.with)))));
		//Extended
		Register("gilded_beehive", GILDED_BEEHIVE, List.of(EN_US.Beehive(Words.Gilded)));
		Register("gilded_bookshelf", GILDED_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Gilded)));
		Register("gilded_chiseled_bookshelf", GILDED_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Gilded))));
		Register("gilded_crafting_table", GILDED_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Gilded))));
		Register("gilded_ladder", GILDED_LADDER, List.of(EN_US.Ladder(Words.Gilded)));
		Register("gilded_woodcutter", GILDED_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Gilded)));
		Register("gilded_barrel", GILDED_BARREL, List.of(EN_US.Barrel(Words.Gilded)));
		Register("gilded_lectern", GILDED_LECTERN, List.of(EN_US.Lectern(Words.Gilded)));
		Register("gilded_powder_keg", GILDED_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Gilded))));
		Register("gilded_stem_slab", GILDED_STEM_SLAB, List.of(EN_US.Stem(Words.Gilded)));
		Register("stripped_gilded_stem_slab", STRIPPED_GILDED_STEM_SLAB, List.of(EN_US.Slab(EN_US.Stem(EN_US.Gilded(Words.Stripped)))));
		Register("gilded_hyphae_slab", GILDED_HYPHAE_SLAB, List.of(EN_US.Slab(EN_US.Hyphae(Words.Gilded))));
		...
		Register("gilded_hammer", GILDED_HAMMER, List.of(EN_US.Hammer(Words.Gilded)));
		//Torches
		Register("gilded_torch", "gilded_wall_torch", GILDED_TORCH, List.of(EN_US._Torch(Words.Gilded)));
		Register("gilded_soul_torch", "gilded_soul_wall_torch", GILDED_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Gilded))));
		Register("gilded_ender_torch", "gilded_ender_wall_torch", GILDED_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Gilded))));
		Register("underwater_gilded_torch", "underwater_gilded_wall_torch", UNDERWATER_GILDED_TORCH, List.of(EN_US._Torch(EN_US.Gilded(Words.Underwater))));
		//Campfires
		Register("gilded_campfire", GILDED_CAMPFIRE, List.of(EN_US.Campfire(Words.Gilded)));
		Register("gilded_soul_campfire", GILDED_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Gilded))));
		Register("gilded_ender_campfire", GILDED_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Gilded))));
		//Fungus
		Register("gilded_fungus", GILDED_FUNGUS, List.of(EN_US._Potted(EN_US.Fungus(Words.Gilded))));
		Register("gilded_roots", GILDED_ROOTS, List.of(EN_US._Potted(EN_US.Roots(Words.Gilded))));
		Register("gilded_wart", GILDED_WART, List.of(EN_US.Wart(Words.Gilded)));
		Register("gilded_wart_block", GILDED_WART_BLOCK, List.of(EN_US.Block(EN_US.Wart(Words.Gilded))));
		Register("gilded_wart_slab", GILDED_WART_SLAB, List.of(EN_US.Slab(EN_US.Wart(Words.Gilded))));
		Register("gilded_nylium", GILDED_NYLIUM, List.of(EN_US.Nylium(Words.Gilded)));
		//</editor-fold>
		//<editor-fold desc="Nether Bricks">
		Register("smooth_chiseled_nether_bricks", SMOOTH_CHISELED_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Chiseled(Words.Smooth)))));
		...
		Register("smooth_chiseled_red_nether_bricks", SMOOTH_CHISELED_RED_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Red(EN_US.Chiseled(Words.Smooth))))));
		Register("cracked_red_nether_bricks", CRACKED_RED_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Red(Words.Cracked)))));
		...
		Register("smooth_chiseled_blue_nether_bricks", SMOOTH_CHISELED_BLUE_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Blue(EN_US.Chiseled(Words.Smooth))))));
		Register("cracked_blue_nether_bricks", CRACKED_BLUE_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Blue(Words.Cracked)))));
		...
		Register("smooth_chiseled_yellow_nether_bricks", SMOOTH_CHISELED_YELLOW_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Yellow(EN_US.Chiseled(Words.Smooth))))));
		Register("cracked_yellow_nether_bricks", CRACKED_YELLOW_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Yellow(Words.Cracked)))));
		...
		Register("smooth_chiseled_black_nether_bricks", SMOOTH_CHISELED_BLACK_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Black(EN_US.Chiseled(Words.Smooth))))));
		Register("cracked_black_nether_bricks", CRACKED_BLACK_NETHER_BRICKS, List.of(EN_US.Bricks(EN_US.Nether(EN_US.Black(Words.Cracked)))));
		CrackedBlocks.Register(BLACK_NETHER_BRICKS, CRACKED_BLACK_NETHER_BRICKS);
		//</editor-fold>
		//<editor-fold desc="Misc Stuff">
		Register("coal_stairs", COAL_STAIRS, List.of(EN_US.Stairs(Words.Coal)));
		Register("coal_slab", COAL_SLAB, List.of(EN_US.Slab(Words.Coal)));
		Register("charcoal_block", CHARCOAL_BLOCK, List.of(EN_US.Block(Words.Charcoal)));
		Register("charcoal_stairs", CHARCOAL_STAIRS, List.of(EN_US.Stairs(Words.Charcoal)));
		Register("charcoal_slab", CHARCOAL_SLAB, List.of(EN_US.Slab(Words.Charcoal)));
		Register("coarse_dirt_slab", COARSE_DIRT_SLAB, List.of(EN_US.Slab(EN_US.Dirt(Words.Coarse))));
		Register("cocoa_block", COCOA_BLOCK, List.of(EN_US.Block(Words.Cocoa)));
		Register("blue_shroomlight", BLUE_SHROOMLIGHT, List.of(EN_US.Shroomlight(Words.Blue)));
		Register("flint_block", FLINT_BLOCK, List.of(EN_US.Block(Words.Flint)));
		Register("flint_slab", FLINT_SLAB, List.of(EN_US.Slab(Words.Flint)));
		Register("flint_bricks", FLINT_BRICKS, List.of(EN_US.Bricks(Words.Flint)));
		Register("flint_brick_stairs", FLINT_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Flint))));
		Register("flint_brick_slab", FLINT_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Flint))));
		Register("flint_brick_wall", FLINT_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Flint))));
		Register("gunpowder_block", GUNPOWDER_BLOCK, List.of(EN_US.Block(Words.Gunpowder)));
		Register("gunpowder_fuse", GUNPOWDER_FUSE, List.of(EN_US.Fuse(Words.Gunpowder)));
		Register("hedge_block", HEDGE_BLOCK, List.of(EN_US.Block(Words.Hedge)));
		Register("light_blue_target", LIGHT_BLUE_TARGET, List.of(EN_US.Target(EN_US.Blue(Words.Light))));
		Register("mycelium_roots", MYCELIUM_ROOTS, List.of(EN_US._Potted(EN_US.Roots(Words.Mycelium))));
		Register("seed_block", SEED_BLOCK, List.of(EN_US.Block(Words.Seed)));
		Register("sugar_block", SUGAR_BLOCK, List.of(EN_US.Block(Words.Sugar)));
		Register("caramel_block", CARAMEL_BLOCK, List.of(EN_US.Block(Words.Caramel)));
		Register("sweet_berry_leaves", SWEET_BERRY_LEAVES, List.of(EN_US.Leaves(EN_US.Berry(Words.Sweet))));
		Register("wax_block", WAX_BLOCK, List.of(EN_US.Block(Words.Wax)));
		Register("wind_horn", WIND_HORN, List.of(EN_US.Horn(Words.Wind)));
		Register("grappling_rod", GRAPPLING_ROD, List.of(EN_US.Rod(Words.Grappling)));
		//</editor-fold>
		//<editor-fold desc="Wildfire">
		Register("wildfire_crown", WILDFIRE_CROWN, List.of(EN_US.Crown(Words.Wildfire)));
		//</editor-fold>
		//<editor-fold desc="Sugar Cane">
		Register("sugar_cane_block", SUGAR_CANE_BLOCK, List.of(EN_US.Block(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_block_slab", SUGAR_CANE_BLOCK_SLAB, List.of(EN_US.Slab(EN_US.Block(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_row", SUGAR_CANE_ROW, List.of(EN_US.Row(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_bale", SUGAR_CANE_BALE, List.of(EN_US.Bale(EN_US.Cane(Words.Sugar))));
		//Wood
		Register("sugar_cane_planks", SUGAR_CANE_PLANKS, List.of(EN_US.Planks(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_stairs", SUGAR_CANE_STAIRS, List.of(EN_US.Stairs(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_slab", SUGAR_CANE_SLAB, List.of(EN_US.Slab(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_fence", SUGAR_CANE_FENCE, List.of(EN_US.Fence(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_fence_gate", SUGAR_CANE_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_door", SUGAR_CANE_DOOR, List.of(EN_US.Door(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_trapdoor", SUGAR_CANE_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_pressure_plate", SUGAR_CANE_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_button", SUGAR_CANE_BUTTON, List.of(EN_US.Button(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane", SUGAR_CANE_SIGN, List.of(EN_US._Sign(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_iron_hanging_sign", "sugar_cane_iron_wall_hanging_sign", SUGAR_CANE_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("sugar_cane_gold_hanging_sign", "sugar_cane_gold_wall_hanging_sign", SUGAR_CANE_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("sugar_cane_copper_hanging_sign", "sugar_cane_copper_wall_hanging_sign", SUGAR_CANE_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("sugar_cane_exposed_copper_hanging_sign", "sugar_cane_exposed_copper_wall_hanging_sign", SUGAR_CANE_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("sugar_cane_weathered_copper_hanging_sign", "sugar_cane_weathered_copper_wall_hanging_sign", SUGAR_CANE_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("sugar_cane_oxidized_copper_hanging_sign", "sugar_cane_oxidized_copper_wall_hanging_sign", SUGAR_CANE_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("sugar_cane_netherite_hanging_sign", "sugar_cane_netherite_wall_hanging_sign", SUGAR_CANE_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Cane(Words.Sugar), EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("sugar_cane", SUGAR_CANE_BOAT, List.of(EN_US._Boat(EN_US.Cane(Words.Sugar))));
		//Extended
		Register("sugar_cane_beehive", SUGAR_CANE_BEEHIVE, List.of(EN_US.Beehive(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_bookshelf", SUGAR_CANE_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_chiseled_bookshelf", SUGAR_CANE_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_crafting_table", SUGAR_CANE_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_ladder", SUGAR_CANE_LADDER, List.of(EN_US.Ladder(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_woodcutter", SUGAR_CANE_WOODCUTTER, List.of(EN_US.Woodcutter(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_barrel", SUGAR_CANE_BARREL, List.of(EN_US.Barrel(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_lectern", SUGAR_CANE_LECTERN, List.of(EN_US.Lectern(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_powder_keg", SUGAR_CANE_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(EN_US.Cane(Words.Sugar)))));
		//Mosaic
		Register("sugar_cane_mosaic", SUGAR_CANE_MOSAIC, List.of(EN_US.Mosaic(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_mosaic_stairs", SUGAR_CANE_MOSAIC_STAIRS, List.of(EN_US.Stairs(EN_US.Mosaic(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_mosaic_slab", SUGAR_CANE_MOSAIC_SLAB, List.of(EN_US.Slab(EN_US.Mosaic(EN_US.Cane(Words.Sugar)))));
		//Misc
		Register("sugar_cane_hammer", SUGAR_CANE_HAMMER, List.of(EN_US.Hammer(EN_US.Cane(Words.Sugar))));
		//Torches
		Register("sugar_cane_torch", "sugar_cane_wall_torch", SUGAR_CANE_TORCH, List.of(EN_US._Torch(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_soul_torch", "sugar_cane_soul_wall_torch", SUGAR_CANE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_ender_torch", "sugar_cane_ender_wall_torch", SUGAR_CANE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(EN_US.Cane(Words.Sugar)))));
		Register("underwater_sugar_cane_torch", "underwater_sugar_cane_wall_torch", UNDERWATER_SUGAR_CANE_TORCH, List.of(EN_US._Torch(EN_US.Cane(EN_US.Sugar(Words.Underwater)))));
		//Campfires
		Register("sugar_cane_campfire", SUGAR_CANE_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Cane(Words.Sugar))));
		Register("sugar_cane_soul_campfire", SUGAR_CANE_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(EN_US.Cane(Words.Sugar)))));
		Register("sugar_cane_ender_campfire", SUGAR_CANE_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(EN_US.Cane(Words.Sugar)))));
		//</editor-fold>
		//<editor-fold desc="Hay">
		Register("hay_planks", HAY_PLANKS, List.of(EN_US.Planks(Words.Hay)));
		Register("hay_stairs", HAY_STAIRS, List.of(EN_US.Stairs(Words.Hay)));
		Register("hay_slab", HAY_SLAB, List.of(EN_US.Slab(Words.Hay)));
		Register("hay_fence", HAY_FENCE, List.of(EN_US.Fence(Words.Hay)));
		Register("hay_fence_gate", HAY_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Hay))));
		Register("hay_door", HAY_DOOR, List.of(EN_US.Door(Words.Hay)));
		Register("hay_trapdoor", HAY_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Hay)));
		Register("hay_pressure_plate", HAY_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Hay))));
		Register("hay_button", HAY_BUTTON, List.of(EN_US.Button(Words.Hay)));
		Register("hay", HAY_SIGN, List.of(EN_US._Sign(Words.Hay)));
		Register("hay_iron_hanging_sign", "hay_iron_wall_hanging_sign", HAY_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("hay_gold_hanging_sign", "hay_gold_wall_hanging_sign", HAY_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("hay_copper_hanging_sign", "hay_copper_wall_hanging_sign", HAY_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("hay_exposed_copper_hanging_sign", "hay_exposed_copper_wall_hanging_sign", HAY_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("hay_weathered_copper_hanging_sign", "hay_weathered_copper_wall_hanging_sign", HAY_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("hay_oxidized_copper_hanging_sign", "hay_oxidized_copper_wall_hanging_sign", HAY_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("hay_netherite_hanging_sign", "hay_netherite_wall_hanging_sign", HAY_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Hay, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("hay", HAY_BOAT, List.of(EN_US._Boat(Words.Hay)));
		//Extended
		Register("hay_beehive", HAY_BEEHIVE, List.of(EN_US.Beehive(Words.Hay)));
		Register("hay_bookshelf", HAY_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Hay)));
		Register("hay_chiseled_bookshelf", HAY_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Hay))));
		Register("hay_crafting_table", HAY_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Hay))));
		Register("hay_ladder", HAY_LADDER, List.of(EN_US.Ladder(Words.Hay)));
		Register("hay_woodcutter", HAY_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Hay)));
		Register("hay_barrel", HAY_BARREL, List.of(EN_US.Barrel(Words.Hay)));
		Register("hay_lectern", HAY_LECTERN, List.of(EN_US.Lectern(Words.Hay)));
		Register("hay_powder_keg", HAY_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Hay))));
		//Torches
		Register("hay_torch", "hay_wall_torch", HAY_TORCH, List.of(EN_US._Torch(Words.Hay)));
		Register("hay_soul_torch", "hay_soul_wall_torch", HAY_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Hay))));
		Register("hay_ender_torch", "hay_ender_wall_torch", HAY_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Hay))));
		Register("underwater_hay_torch", "underwater_hay_wall_torch", UNDERWATER_HAY_TORCH, List.of(EN_US._Torch(EN_US.Hay(Words.Underwater))));
		//</editor-fold>
		RegisterFood();
		Register("bottled_confetti", BOTTLED_CONFETTI_ITEM, List.of(EN_US.Confetti(Words.Bottled)));
		Register("bottled_lightning", BOTTLED_LIGHTNING_ITEM, List.of(EN_US.Lightning(Words.Bottled)));
		Register("throwable_tomato", THROWABLE_TOMATO_ITEM, List.of(EN_US.Tomato(Words.Throwable)));
		//<editor-fold desc="Poison">
		Register("poison_vial", POISON_VIAL, List.of(EN_US.Vial(Words.Poison)));
		...
		Register("spider_poison_vial", SPIDER_POISON_VIAL, List.of(EN_US.Vial(EN_US.Venom(Words.Spider))));
		JuicerBlock.JUICE_MAP.put(() -> Items.SPIDER_EYE, SPIDER_POISON_VIAL);
		Register("pufferfish_poison_vial", PUFFERFISH_POISON_VIAL, List.of(EN_US.Vial(EN_US.Poison(Words.Pufferfish))));
		JuicerBlock.JUICE_MAP.put(() -> Items.PUFFERFISH, PUFFERFISH_POISON_VIAL);
		//</editor-fold>
		//<editor-fold desc="Hammers">
		Register("gravity_hammer", GRAVITY_HAMMER, List.of(EN_US.Gravity(EN_US.of(Words.Hammer))));
		Register("repulsion_hammer", REPULSION_HAMMER, List.of(EN_US.Repulsion(EN_US.of(Words.Hammer))));
		Register("thundering_hammer", THUNDERING_HAMMER, List.of(EN_US.Hammer(Words.Thundering)));
		//</editor-fold>
		RegisterDyes();
		...
		Register("terracotta_stairs", TERRACOTTA_STAIRS, List.of(EN_US.Stairs(Words.Terracotta)));
		Register("terracotta_slab", TERRACOTTA_SLAB, List.of(EN_US.Slab(Words.Terracotta)));
		Register("terracotta_wall", TERRACOTTA_WALL, List.of(EN_US.Wall(Words.Terracotta)));
		for(DyeColor color : DyeColor.values()) {
			String name = color.getName();
		...
		Register("glazed_terracotta", GLAZED_TERRACOTTA, List.of(EN_US.Terracotta(Words.Glazed)));
		Register("glazed_terracotta_slab", GLAZED_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(Words.Glazed))));
		...
		Register("lapis_slab", LAPIS_SLAB, List.of(EN_US.Slab(Words.Lapis)));
		Register("kill_potion", KILL_POTION, List.of(EN_US.Instantly(EN_US.Die(EN_US.of(Words.Potion)))));
		Register("dense_brew", DENSE_BREW, List.of(EN_US.Brew(Words.Dense)));
		Register("oakwood_brew", OAKWOOD_BREW, List.of(EN_US.Brew(Words.Oakwood)));
		Register("sweet_brew", SWEET_BREW, List.of(EN_US.Brew(Words.Sweet)));
		Register("distilled_water_bottle", DISTILLED_WATER_BOTTLE, List.of(EN_US.Bottle(EN_US.Water(Words.Distilled))));
		...
		Register("sugar_water_bottle", SUGAR_WATER_BOTTLE, List.of(EN_US.Bottle(EN_US.Water(Words.Sugar))));
		Register("sap_bottle", SAP_BOTTLE, List.of(EN_US.Bottle(Words.Sap)));
		Register("syrup_bottle", SYRUP_BOTTLE, List.of(EN_US.Bottle(Words.Syrup)));
		Register("lava_bottle", LAVA_BOTTLE, List.of(EN_US.Bottle(Words.Lava)));
		...
		Register("magma_cream_bottle", MAGMA_CREAM_BOTTLE, List.of(EN_US.Bottle(EN_US.Cream(Words.Magma))));
		JuicerBlock.JUICE_MAP.put(() -> Items.MAGMA_BLOCK, MAGMA_CREAM_BOTTLE);
		Register("cooled_magma_block", COOLED_MAGMA_BLOCK, List.of(EN_US.Block(EN_US.Magma(Words.Cooled))));
		Register("pumice", PUMICE, List.of(Words.Pumice));
		//</editor-fold>
		//<editor-fold desc="Slime">
		...
		//Lanterns
		Register("magma_cube_lantern", MAGMA_CUBE_LANTERN, List.of(EN_US.Lantern(EN_US.Cube(Words.Magma))));
		Register("slime_lantern", SLIME_LANTERN, List.of(EN_US.Lantern(Words.Slime)));
		Register("tropical_slime_lantern", TROPICAL_SLIME_LANTERN, List.of(EN_US.Lantern(EN_US.Slime(Words.Tropical))));
		Register("pink_slime_lantern", PINK_SLIME_LANTERN, List.of(EN_US.Lantern(EN_US.Slime(Words.Pink))));
		//</editor-fold>
		Register("turtle_chestplate", TURTLE_CHESTPLATE, List.of(EN_US.Chestplate(Words.Turtle)));
		Register("turtle_boots", TURTLE_BOOTS, List.of(EN_US.Boots(Words.Turtle)));
		Register("horn", HORN, List.of(Words.Horn));
		//<editor-fold desc="Feathers">
		Register("fancy_feather", FANCY_FEATHER, List.of(EN_US.Feather(Words.Fancy)));
		...
		//</editor-fold>
		//<editor-fold desc="Books">
		Register("unreadable_book", UNREADABLE_BOOK, List.of(EN_US.Book(Words.Unreadable)));
		...
		Register("gray_book", GRAY_BOOK, List.of(EN_US.Book(Words.Gray)));
		//</editor-fold>
		//<editor-fold desc="Wood">
		Register("wood_bucket", WOOD_BUCKET, List.of(EN_US.Bucket(Words.Wood)));
		DispenserBlock.registerBehavior(WOOD_BUCKET, new BucketDispenserBehavior(WOOD_BUCKET_PROVIDER));
		Register("wood_water_bucket", WOOD_WATER_BUCKET, List.of(EN_US.Bucket(EN_US.Water(Words.Wood))));
		...
		CauldronBehavior.WATER_CAULDRON_BEHAVIOR.put(WOOD_BUCKET, (state, world, pos, player, hand, stack) -> CauldronBehavior.emptyCauldron(state, world, pos, player, hand, stack, new ItemStack(WOOD_WATER_BUCKET),
				(statex) -> statex.get(LeveledCauldronBlock.LEVEL) == 3, SoundEvents.ITEM_BUCKET_FILL));
		Register("wood_powder_snow_bucket", WOOD_POWDER_SNOW_BUCKET, List.of(EN_US.Bucket(EN_US.Snow(EN_US.Powder(Words.Wood)))));
		...
		CauldronBehavior.POWDER_SNOW_CAULDRON_BEHAVIOR.put(WOOD_BUCKET, (state, world, pos, player, hand, stack) -> CauldronBehavior.emptyCauldron(state, world, pos, player, hand, stack, new ItemStack(WOOD_POWDER_SNOW_BUCKET),
				(statex) -> statex.get(LeveledCauldronBlock.LEVEL) == 3, SoundEvents.ITEM_BUCKET_FILL_POWDER_SNOW));
		Register("wood_blood_bucket", WOOD_BLOOD_BUCKET, List.of(EN_US.Bucket(EN_US.Blood(Words.Wood))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(WOOD_BLOOD_BUCKET, BloodCauldronBlock.FillFromBucket(WOOD_BUCKET));
		Register("wood_mud_bucket", WOOD_MUD_BUCKET, List.of(EN_US.Bucket(EN_US.Mud(Words.Wood))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(WOOD_MUD_BUCKET, MudCauldronBlock.FillFromBucket(WOOD_BUCKET));
		Register("wood_milk_bucket", WOOD_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Wood))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(WOOD_MILK_BUCKET, MilkCauldronBlock.FillFromBucket(WOOD_BUCKET));
		Register("wood_chocolate_milk_bucket", WOOD_CHOCOLATE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Chocolate(Words.Wood)))));
		Register("wood_coffee_milk_bucket", WOOD_COFFEE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Coffee(Words.Wood)))));
		Register("wood_strawberry_milk_bucket", WOOD_STRAWBERRY_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Strawberry(Words.Wood)))));
		Register("wood_vanilla_milk_bucket", WOOD_VANILLA_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Vanilla(Words.Wood)))));
		//</editor-fold>
		//<editor-fold desc="Wool">
...
//		Register("rainbow_bed", RAINBOW_BED, List.of(EN_US.Bed(Words.Rainbow)));
		...
		Register("mooblossom_magenta_tulip", MOOBLOSSOM_MAGENTA_TULIP, List.of(EN_US.Tulip(EN_US.Magenta(Words.Mooblossom))));
		Register("mooblossom_red_tulip", MOOBLOSSOM_RED_TULIP, List.of(EN_US.Tulip(EN_US.Red(Words.Mooblossom))));
		Register("mooblossom_orange_tulip", MOOBLOSSOM_ORANGE_TULIP, List.of(EN_US.Tulip(EN_US.Orange(Words.Mooblossom))));
		Register("mooblossom_white_tulip", MOOBLOSSOM_WHITE_TULIP, List.of(EN_US.Tulip(EN_US.White(Words.Mooblossom))));
		Register("mooblossom_pink_tulip", MOOBLOSSOM_PINK_TULIP, List.of(EN_US.Tulip(EN_US.Pink(Words.Mooblossom))));
		//</editor-fold>
		//<editor-fold desc="Moss">
		Register("moss_slab", MOSS_SLAB, List.of(EN_US.Slab(Words.Moss)));
//		Register("moss_bed", MOSS_BED, List.of(EN_US.Bed(Words.Moss)));
		//</editor-fold>
		//<editor-fold desc="Glow Lichen">
		Register("glow_lichen_block", GLOW_LICHEN_BLOCK, List.of(EN_US.Block(EN_US.Lichen(Words.Glow))));
		Register("glow_lichen_slab", GLOW_LICHEN_SLAB, List.of(EN_US.Slab(EN_US.Lichen(Words.Glow))));
		Register("glow_lichen_carpet", GLOW_LICHEN_CARPET, List.of(EN_US.Carpet(EN_US.Lichen(Words.Glow))));
//		Register("glow_lichen_bed", GLOW_LICHEN_BED, List.of(EN_US.Bed(EN_US.Lichen(Words.Glow))));
		//</editor-fold>
		//<editor-fold desc="Goat">
		Register("minecraft:set_instrument", SET_INSTRUMENT_LOOT_FUNCTION);
		Register("minecraft:goat_horn", GOAT_HORN, List.of(EN_US.Horn(Words.Goat)));
		//Extended
		Register("chevon", CHEVON, List.of(Words.Chevon));
		Register("cooked_chevon", COOKED_CHEVON, List.of(EN_US.Chevon(Words.Cooked)));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("fleece_helmet", FLEECE_HELMET, List.of(EN_US.Helmet(Words.Fleece)));
		Register("fleece_chestplate", FLEECE_CHESTPLATE, List.of(EN_US.Chestplate(Words.Fleece)));
		Register("fleece_leggings", FLEECE_LEGGINGS, List.of(EN_US.Leggings(Words.Fleece)));
		Register("fleece_boots", FLEECE_BOOTS, List.of(EN_US.Boots(Words.Fleece)));
		Register("fleece_horse_armor", FLEECE_HORSE_ARMOR, List.of(EN_US.Armor(EN_US.Horse(Words.Fleece))));
		Register("goat_horn_salve", GOAT_HORN_SALVE, List.of(EN_US.Salve(EN_US.Horn(Words.Goat))));
		//</editor-fold>
		//<editor-fold desc="Studded Leather">
		Register("studded_leather_helmet", STUDDED_LEATHER_HELMET, List.of(EN_US.Helmet(EN_US.Leather(Words.Studded))));
		Register("studded_leather_chestplate", STUDDED_LEATHER_CHESTPLATE, List.of(EN_US.Chestplate(EN_US.Leather(Words.Studded))));
		Register("studded_leather_leggings", STUDDED_LEATHER_LEGGINGS, List.of(EN_US.Leggings(EN_US.Leather(Words.Studded))));
		Register("studded_leather_boots", STUDDED_LEATHER_BOOTS, List.of(EN_US.Boots(EN_US.Leather(Words.Studded))));
		Register("studded_leather_horse_armor", STUDDED_LEATHER_HORSE_ARMOR, List.of(EN_US.Armor(EN_US.Horse(EN_US.Leather(Words.Studded)))));
		//</editor-fold>
		//<editor-fold desc="Charred Wood">
		Register("charred_log", CHARRED_LOG, List.of(EN_US.Log(Words.Charred)));
		...
		Register("charred_wood", CHARRED_WOOD, List.of(EN_US.Wood(Words.Charred)));
		...
		Register("charred_planks", CHARRED_PLANKS, List.of(EN_US.Planks(Words.Charred)));
		Register("charred_stairs", CHARRED_STAIRS, List.of(EN_US.Stairs(Words.Charred)));
		Register("charred_slab", CHARRED_SLAB, List.of(EN_US.Slab(Words.Charred)));
		Register("charred_fence", CHARRED_FENCE, List.of(EN_US.Fence(Words.Charred)));
		Register("charred_fence_gate", CHARRED_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Charred))));
		Register("charred_door", CHARRED_DOOR, List.of(EN_US.Door(Words.Charred)));
		Register("charred_trapdoor", CHARRED_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Charred)));
		Register("charred_pressure_plate", CHARRED_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Charred))));
		Register("charred_button", CHARRED_BUTTON, List.of(EN_US.Button(Words.Charred)));
		Register("charred", CHARRED_SIGN, List.of(EN_US._Sign(Words.Charred)));
		Register("charred_iron_hanging_sign", "charred_iron_wall_hanging_sign", CHARRED_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("charred_gold_hanging_sign", "charred_gold_wall_hanging_sign", CHARRED_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("charred_copper_hanging_sign", "charred_copper_wall_hanging_sign", CHARRED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("charred_exposed_copper_hanging_sign", "charred_exposed_copper_wall_hanging_sign", CHARRED_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("charred_weathered_copper_hanging_sign", "charred_weathered_copper_wall_hanging_sign", CHARRED_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("charred_oxidized_copper_hanging_sign", "charred_oxidized_copper_wall_hanging_sign", CHARRED_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("charred_netherite_hanging_sign", "charred_netherite_wall_hanging_sign", CHARRED_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Charred, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("charred", CHARRED_BOAT, List.of(EN_US._Boat(Words.Charred)));
		Register("charred_beehive", CHARRED_BEEHIVE, List.of(EN_US.Beehive(Words.Charred)));
		Register("charred_bookshelf", CHARRED_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Charred)));
		Register("charred_chiseled_bookshelf", CHARRED_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Charred))));
		Register("charred_crafting_table", CHARRED_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Charred))));
		Register("charred_ladder", CHARRED_LADDER, List.of(EN_US.Ladder(Words.Charred)));
		Register("charred_woodcutter", CHARRED_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Charred)));
		Register("charred_barrel", CHARRED_BARREL, List.of(EN_US.Barrel(Words.Charred)));
		Register("charred_lectern", CHARRED_LECTERN, List.of(EN_US.Lectern(Words.Charred)));
		Register("charred_powder_keg", CHARRED_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Charred))));
		Register("charred_log_slab", CHARRED_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Charred))));
		Register("stripped_charred_log_slab", STRIPPED_CHARRED_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(EN_US.Stripped(Words.Charred)))));
		StrippedBlockUtil.Register(CHARRED_LOG_SLAB, STRIPPED_CHARRED_LOG_SLAB);
		Register("charred_wood_slab", CHARRED_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Charred))));
		Register("stripped_charred_wood_slab", STRIPPED_CHARRED_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(EN_US.Stripped(Words.Charred)))));
		StrippedBlockUtil.Register(CHARRED_WOOD_SLAB, STRIPPED_CHARRED_WOOD_SLAB);
		Register("charred_hammer", CHARRED_HAMMER, List.of(EN_US.Hammer(Words.Charred)));
		Register("charred_torch", "charred_wall_torch", CHARRED_TORCH, List.of(EN_US._Torch(Words.Charred)));
		Register("charred_soul_torch", "charred_soul_wall_torch", CHARRED_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Charred))));
		Register("charred_ender_torch", "charred_ender_wall_torch", CHARRED_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Charred))));
		Register("underwater_charred_torch", "underwater_charred_wall_torch", UNDERWATER_CHARRED_TORCH, List.of(EN_US._Torch(EN_US.Charred(Words.Underwater))));
		Register("charred_campfire", CHARRED_CAMPFIRE, List.of(EN_US.Campfire(Words.Charred)));
		Register("charred_soul_campfire", CHARRED_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Charred))));
		Register("charred_ender_campfire", CHARRED_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Charred))));
		//</editor-fold>
		Register("minecraft:music_disc_5", MUSIC_DISC_5, List.of(EN_US.Disc(Words.Music)));
		Register("minecraft:disc_fragment_5", DISC_FRAGMENT_5, List.of(EN_US.Fragment(Words.Disc)));
		Register("minecraft:music_disc_relic", MUSIC_DISC_RELIC, List.of(EN_US.Disc(Words.Music)));
		//<editor-fold desc="Mud">
		Register("minecraft:mud", MUD, List.of(Words.Mud));
		Register("minecraft:packed_mud", PACKED_MUD, List.of(EN_US.Mud(Words.Packed)));
		Register("packed_mud_stairs", PACKED_MUD_STAIRS, List.of(EN_US.Stairs(EN_US.Mud(Words.Packed))));
		Register("packed_mud_slab", PACKED_MUD_SLAB, List.of(EN_US.Slab(EN_US.Mud(Words.Packed))));
		Register("packed_mud_wall", PACKED_MUD_WALL, List.of(EN_US.Wall(EN_US.Mud(Words.Packed))));
		Register("minecraft:mud_bricks", MUD_BRICKS, List.of(EN_US.Bricks(Words.Mud)));
		Register("minecraft:mud_brick_stairs", MUD_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Mud))));
		Register("minecraft:mud_brick_slab", MUD_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Mud))));
		Register("minecraft:mud_brick_wall", MUD_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Mud))));
		Register("chiseled_mud_bricks", CHISELED_MUD_BRICKS, List.of(EN_US.Bricks(EN_US.Mud(Words.Chiseled))));
		Register("smooth_chiseled_mud_bricks", SMOOTH_CHISELED_MUD_BRICKS, List.of(EN_US.Bricks(EN_US.Mud(EN_US.Chiseled(Words.Smooth)))));
		...
		//</editor-fold>
		//<editor-fold desc="Mud (Liquid)">
		Register("mud_bottle", MUD_BOTTLE, List.of(EN_US.Bottle(Words.Mud)));
		JuicerBlock.JUICE_MAP.put(MUD::asItem, MUD_BOTTLE);
		Register("mud_bucket", MUD_BUCKET, List.of(EN_US.Bucket(Words.Mud)));
		...
		Register("mud_cauldron", MUD_CAULDRON, List.of(EN_US.Cauldron(Words.Mud)));
		...
		Register("mud_fluid_block", MUD_FLUID_BLOCK, List.of(EN_US.Block(EN_US.Fluid(Words.Mud))));
		//</editor-fold>
		RegisterBlood();
		//<editor-fold desc="Mangrove">
		Register("minecraft:mangrove_log", MANGROVE_LOG, List.of(EN_US.Log(Words.Mangrove)));
		...
		Register("minecraft:mangrove_wood", MANGROVE_WOOD, List.of(EN_US.Wood(Words.Mangrove)));
		...
		Register("minecraft:mangrove_leaves", MANGROVE_LEAVES, List.of(EN_US.Leaves(Words.Mangrove)));
		Register("minecraft:mangrove_planks", MANGROVE_PLANKS, List.of(EN_US.Planks(Words.Mangrove)));
		Register("minecraft:mangrove_stairs", MANGROVE_STAIRS, List.of(EN_US.Stairs(Words.Mangrove)));
		Register("minecraft:mangrove_slab", MANGROVE_SLAB, List.of(EN_US.Slab(Words.Mangrove)));
		Register("minecraft:mangrove_fence", MANGROVE_FENCE, List.of(EN_US.Fence(Words.Mangrove)));
		Register("minecraft:mangrove_fence_gate", MANGROVE_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Mangrove))));
		Register("minecraft:mangrove_door", MANGROVE_DOOR, List.of(EN_US.Door(Words.Mangrove)));
		Register("minecraft:mangrove_trapdoor", MANGROVE_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Mangrove)));
		Register("minecraft:mangrove_pressure_plate", MANGROVE_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Mangrove))));
		Register("minecraft:mangrove_button", MANGROVE_BUTTON, List.of(EN_US.Button(Words.Mangrove)));
		Register("minecraft:mangrove_roots", MANGROVE_ROOTS, List.of(EN_US.Roots(Words.Mangrove)));
		Register("minecraft:muddy_mangrove_roots", MUDDY_MANGROVE_ROOTS, List.of(EN_US.Muddy(EN_US.Roots(Words.Mangrove))));
		Register("minecraft:mangrove", MANGROVE_SIGN, List.of(EN_US._Sign(Words.Mangrove)));
		Register("mangrove_iron_hanging_sign", "mangrove_iron_wall_hanging_sign", MANGROVE_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("mangrove_gold_hanging_sign", "mangrove_gold_wall_hanging_sign", MANGROVE_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("mangrove_copper_hanging_sign", "mangrove_copper_wall_hanging_sign", MANGROVE_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("mangrove_exposed_copper_hanging_sign", "mangrove_exposed_copper_wall_hanging_sign", MANGROVE_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("mangrove_weathered_copper_hanging_sign", "mangrove_weathered_copper_wall_hanging_sign", MANGROVE_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("mangrove_oxidized_copper_hanging_sign", "mangrove_oxidized_copper_wall_hanging_sign", MANGROVE_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("mangrove_netherite_hanging_sign", "mangrove_netherite_wall_hanging_sign", MANGROVE_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Mangrove, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("minecraft:mangrove", MANGROVE_BOAT, List.of(EN_US._Boat(Words.Mangrove)));
		Register("minecraft:mangrove_propagule", MANGROVE_PROPAGULE, List.of(EN_US._Potted(EN_US.Propagule(Words.Mangrove))));
		//Extended
		Register("mangrove_beehive", MANGROVE_BEEHIVE, List.of(EN_US.Beehive(Words.Mangrove)));
		Register("mangrove_bookshelf", MANGROVE_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Mangrove)));
		Register("mangrove_chiseled_bookshelf", MANGROVE_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Mangrove))));
		Register("mangrove_crafting_table", MANGROVE_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Mangrove))));
		Register("mangrove_ladder", MANGROVE_LADDER, List.of(EN_US.Ladder(Words.Mangrove)));
		Register("mangrove_woodcutter", MANGROVE_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Mangrove)));
		Register("mangrove_barrel", MANGROVE_BARREL, List.of(EN_US.Barrel(Words.Mangrove)));
		Register("mangrove_lectern", MANGROVE_LECTERN, List.of(EN_US.Lectern(Words.Mangrove)));
		Register("mangrove_powder_keg", MANGROVE_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Mangrove))));
		Register("mangrove_log_slab", MANGROVE_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Mangrove))));
		Register("stripped_mangrove_log_slab", STRIPPED_MANGROVE_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(EN_US.Stripped(Words.Mangrove)))));
		StrippedBlockUtil.Register(MANGROVE_LOG_SLAB, STRIPPED_MANGROVE_LOG_SLAB);
		Register("mangrove_wood_slab", MANGROVE_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Mangrove))));
		Register("stripped_mangrove_wood_slab", STRIPPED_MANGROVE_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(EN_US.Stripped(Words.Mangrove)))));
		StrippedBlockUtil.Register(MANGROVE_WOOD_SLAB, STRIPPED_MANGROVE_WOOD_SLAB);
		Register("mangrove_hammer", MANGROVE_HAMMER, List.of(EN_US.Hammer(Words.Mangrove)));
		Register("mangrove_torch", "mangrove_wall_torch", MANGROVE_TORCH, List.of(EN_US._Torch(Words.Mangrove)));
		Register("mangrove_soul_torch", "mangrove_soul_wall_torch", MANGROVE_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Mangrove))));
		Register("mangrove_ender_torch", "mangrove_ender_wall_torch", MANGROVE_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Mangrove))));
		Register("underwater_mangrove_torch", "underwater_mangrove_wall_torch", UNDERWATER_MANGROVE_TORCH, List.of(EN_US._Torch(EN_US.Mangrove(Words.Underwater))));
		Register("mangrove_campfire", MANGROVE_CAMPFIRE, List.of(EN_US.Campfire(Words.Mangrove)));
		Register("mangrove_soul_campfire", MANGROVE_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Mangrove))));
		Register("mangrove_ender_campfire", MANGROVE_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Mangrove))));
		//</editor-fold>
		//<editor-fold desc="Cherry">
		Register("minecraft:cherry_log", CHERRY_LOG, List.of(EN_US.Log(Words.Cherry)));
		...
		Register("minecraft:cherry_wood", CHERRY_WOOD, List.of(EN_US.Wood(Words.Cherry)));
		...
		Register("minecraft:cherry_leaves", CHERRY_LEAVES, List.of(EN_US.Leaves(Words.Cherry)));
		Register("minecraft:cherry_planks", CHERRY_PLANKS, List.of(EN_US.Planks(Words.Cherry)));
		Register("minecraft:cherry_stairs", CHERRY_STAIRS, List.of(EN_US.Stairs(Words.Cherry)));
		Register("minecraft:cherry_slab", CHERRY_SLAB, List.of(EN_US.Slab(Words.Cherry)));
		Register("minecraft:cherry_fence", CHERRY_FENCE, List.of(EN_US.Fence(Words.Cherry)));
		Register("minecraft:cherry_fence_gate", CHERRY_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Cherry))));
		Register("minecraft:cherry_door", CHERRY_DOOR, List.of(EN_US.Door(Words.Cherry)));
		Register("minecraft:cherry_trapdoor", CHERRY_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Cherry)));
		Register("minecraft:cherry_pressure_plate", CHERRY_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Cherry))));
		Register("minecraft:cherry_button", CHERRY_BUTTON, List.of(EN_US.Button(Words.Cherry)));
		Register("minecraft:cherry", CHERRY_SIGN, List.of(EN_US._Sign(Words.Cherry)));
		Register("cherry_iron_hanging_sign", "cherry_iron_wall_hanging_sign", CHERRY_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("cherry_gold_hanging_sign", "cherry_gold_wall_hanging_sign", CHERRY_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("cherry_copper_hanging_sign", "cherry_copper_wall_hanging_sign", CHERRY_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("cherry_exposed_copper_hanging_sign", "cherry_exposed_copper_wall_hanging_sign", CHERRY_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("cherry_weathered_copper_hanging_sign", "cherry_weathered_copper_wall_hanging_sign", CHERRY_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("cherry_oxidized_copper_hanging_sign", "cherry_oxidized_copper_wall_hanging_sign", CHERRY_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("cherry_netherite_hanging_sign", "cherry_netherite_wall_hanging_sign", CHERRY_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cherry, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("minecraft:cherry", CHERRY_BOAT, List.of(EN_US._Boat(Words.Cherry)));
		Register("minecraft:cherry_sapling", CHERRY_SAPLING, List.of(EN_US._Potted(EN_US.Sapling(Words.Cherry))));
		//Extended
		Register("cherry_beehive", CHERRY_BEEHIVE, List.of(EN_US.Beehive(Words.Cherry)));
		Register("cherry_bookshelf", CHERRY_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Cherry)));
		Register("cherry_chiseled_bookshelf", CHERRY_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Cherry))));
		Register("cherry_crafting_table", CHERRY_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Cherry))));
		Register("cherry_ladder", CHERRY_LADDER, List.of(EN_US.Ladder(Words.Cherry)));
		Register("cherry_woodcutter", CHERRY_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Cherry)));
		Register("cherry_barrel", CHERRY_BARREL, List.of(EN_US.Barrel(Words.Cherry)));
		Register("cherry_lectern", CHERRY_LECTERN, List.of(EN_US.Lectern(Words.Cherry)));
		Register("cherry_powder_keg", CHERRY_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Cherry))));
		Register("cherry_log_slab", CHERRY_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Cherry))));
		Register("stripped_cherry_log_slab", STRIPPED_CHERRY_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(EN_US.Stripped(Words.Cherry)))));
		StrippedBlockUtil.Register(CHERRY_LOG_SLAB, STRIPPED_CHERRY_LOG_SLAB);
		Register("cherry_wood_slab", CHERRY_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Cherry))));
		Register("stripped_cherry_wood_slab", STRIPPED_CHERRY_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(EN_US.Stripped(Words.Cherry)))));
		StrippedBlockUtil.Register(CHERRY_WOOD_SLAB, STRIPPED_CHERRY_WOOD_SLAB);
		Register("cherry_hammer", CHERRY_HAMMER, List.of(EN_US.Hammer(Words.Cherry)));
		Register("cherry_torch", "cherry_wall_torch", CHERRY_TORCH, List.of(EN_US._Torch(Words.Cherry)));
		Register("cherry_soul_torch", "cherry_soul_wall_torch", CHERRY_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Cherry))));
		Register("cherry_ender_torch", "cherry_ender_wall_torch", CHERRY_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Cherry))));
		Register("underwater_cherry_torch", "underwater_cherry_wall_torch", UNDERWATER_CHERRY_TORCH, List.of(EN_US._Torch(EN_US.Cherry(Words.Underwater))));
		Register("cherry_campfire", CHERRY_CAMPFIRE, List.of(EN_US.Campfire(Words.Cherry)));
		Register("cherry_soul_campfire", CHERRY_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Cherry))));
		Register("cherry_ender_campfire", CHERRY_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Cherry))));
		//</editor-fold>
		//<editor-fold desc="Cassia">
		...
		Register("flowering_cassia_leaves", FLOWERING_CASSIA_LEAVES, List.of(EN_US.Leaves(EN_US.Cassia(Words.Flowering))));
		...
		Register("cassia_iron_hanging_sign", "cassia_iron_wall_hanging_sign", CASSIA_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("cassia_gold_hanging_sign", "cassia_gold_wall_hanging_sign", CASSIA_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("cassia_copper_hanging_sign", "cassia_copper_wall_hanging_sign", CASSIA_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("cassia_exposed_copper_hanging_sign", "cassia_exposed_copper_wall_hanging_sign", CASSIA_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("cassia_weathered_copper_hanging_sign", "cassia_weathered_copper_wall_hanging_sign", CASSIA_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("cassia_oxidized_copper_hanging_sign", "cassia_oxidized_copper_wall_hanging_sign", CASSIA_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("cassia_netherite_hanging_sign", "cassia_netherite_wall_hanging_sign", CASSIA_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Cassia, EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_cassia_torch", "underwater_cassia_wall_torch", UNDERWATER_CASSIA_TORCH, List.of(EN_US._Torch(EN_US.Cassia(Words.Underwater))));
		...
		//</editor-fold>
		//<editor-fold desc="Dogwood">
		Register("dogwood_log", DOGWOOD_LOG, List.of(EN_US.Log(Words.Dogwood)));
		...
		Register("dogwood_wood", DOGWOOD_WOOD, List.of(EN_US.Wood(Words.Dogwood)));
		...
		Register("dogwood_planks", DOGWOOD_PLANKS, List.of(EN_US.Planks(Words.Dogwood)));
		Register("dogwood_stairs", DOGWOOD_STAIRS, List.of(EN_US.Stairs(Words.Dogwood)));
		Register("dogwood_slab", DOGWOOD_SLAB, List.of(EN_US.Slab(Words.Dogwood)));
		Register("dogwood_fence", DOGWOOD_FENCE, List.of(EN_US.Fence(Words.Dogwood)));
		Register("dogwood_fence_gate", DOGWOOD_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(Words.Dogwood))));
		Register("dogwood_door", DOGWOOD_DOOR, List.of(EN_US.Door(Words.Dogwood)));
		Register("dogwood_trapdoor", DOGWOOD_TRAPDOOR, List.of(EN_US.Trapdoor(Words.Dogwood)));
		Register("dogwood_pressure_plate", DOGWOOD_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(Words.Dogwood))));
		Register("dogwood_button", DOGWOOD_BUTTON, List.of(EN_US.Button(Words.Dogwood)));
		Register("dogwood", DOGWOOD_SIGN, List.of(EN_US._Sign(Words.Dogwood)));
		Register("dogwood_iron_hanging_sign", "dogwood_iron_wall_hanging_sign", DOGWOOD_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("dogwood_gold_hanging_sign", "dogwood_gold_wall_hanging_sign", DOGWOOD_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("dogwood_copper_hanging_sign", "dogwood_copper_wall_hanging_sign", DOGWOOD_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("dogwood_exposed_copper_hanging_sign", "dogwood_exposed_copper_wall_hanging_sign", DOGWOOD_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("dogwood_weathered_copper_hanging_sign", "dogwood_weathered_copper_wall_hanging_sign", DOGWOOD_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("dogwood_oxidized_copper_hanging_sign", "dogwood_oxidized_copper_wall_hanging_sign", DOGWOOD_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("dogwood_netherite_hanging_sign", "dogwood_netherite_wall_hanging_sign", DOGWOOD_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(Words.Dogwood, EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("dogwood", DOGWOOD_BOAT, List.of(EN_US._Boat(Words.Dogwood)));
		Register("dogwood_sapling", DOGWOOD_SAPLING, List.of(EN_US._Potted(EN_US.Sapling(Words.Dogwood))));
		Register("dogwood_beehive", DOGWOOD_BEEHIVE, List.of(EN_US.Beehive(Words.Dogwood)));
		Register("dogwood_bookshelf", DOGWOOD_BOOKSHELF, List.of(EN_US.Bookshelf(Words.Dogwood)));
		Register("dogwood_chiseled_bookshelf", DOGWOOD_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(Words.Dogwood))));
		Register("dogwood_crafting_table", DOGWOOD_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(Words.Dogwood))));
		Register("dogwood_ladder", DOGWOOD_LADDER, List.of(EN_US.Ladder(Words.Dogwood)));
		Register("dogwood_woodcutter", DOGWOOD_WOODCUTTER, List.of(EN_US.Woodcutter(Words.Dogwood)));
		Register("dogwood_barrel", DOGWOOD_BARREL, List.of(EN_US.Barrel(Words.Dogwood)));
		Register("dogwood_lectern", DOGWOOD_LECTERN, List.of(EN_US.Lectern(Words.Dogwood)));
		Register("dogwood_powder_keg", DOGWOOD_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(Words.Dogwood))));
		Register("dogwood_log_slab", DOGWOOD_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(Words.Dogwood))));
		Register("stripped_dogwood_log_slab", STRIPPED_DOGWOOD_LOG_SLAB, List.of(EN_US.Slab(EN_US.Log(EN_US.Stripped(Words.Dogwood)))));
		StrippedBlockUtil.Register(DOGWOOD_LOG_SLAB, STRIPPED_DOGWOOD_LOG_SLAB);
		Register("dogwood_wood_slab", DOGWOOD_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(Words.Dogwood))));
		Register("stripped_dogwood_wood_slab", STRIPPED_DOGWOOD_WOOD_SLAB, List.of(EN_US.Slab(EN_US.Wood(EN_US.Stripped(Words.Dogwood)))));
		StrippedBlockUtil.Register(DOGWOOD_WOOD_SLAB, STRIPPED_DOGWOOD_WOOD_SLAB);
		Register("dogwood_hammer", DOGWOOD_HAMMER, List.of(EN_US.Hammer(Words.Dogwood)));
		Register("dogwood_torch", "dogwood_wall_torch", DOGWOOD_TORCH, List.of(EN_US._Torch(Words.Dogwood)));
		Register("dogwood_soul_torch", "dogwood_soul_wall_torch", DOGWOOD_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Dogwood))));
		Register("dogwood_ender_torch", "dogwood_ender_wall_torch", DOGWOOD_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Dogwood))));
		Register("underwater_dogwood_torch", "underwater_dogwood_wall_torch", UNDERWATER_DOGWOOD_TORCH, List.of(EN_US._Torch(EN_US.Dogwood(Words.Underwater))));
		Register("dogwood_campfire", DOGWOOD_CAMPFIRE, List.of(EN_US.Campfire(Words.Dogwood)));
		Register("dogwood_soul_campfire", DOGWOOD_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(Words.Dogwood))));
		Register("dogwood_ender_campfire", DOGWOOD_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(Words.Dogwood))));
		//</editor-fold>
		Register("tiki_torch", TIKI_TORCH, List.of(EN_US.Torch(Words.Tiki)));
		Register("tiki_soul_torch", TIKI_SOUL_TORCH, List.of(EN_US.Torch(EN_US.Soul(Words.Tiki))));
		Register("tiki_ender_torch", TIKI_ENDER_TORCH, List.of(EN_US.Torch(EN_US.Ender(Words.Tiki))));
		Register("tiki_torch_post", TIKI_TORCH_POST, List.of(EN_US.Post(EN_US.Torch(Words.Tiki))));
		ModBambooRegistry.RegisterBamboo();
		Register("javelin", JAVELIN, List.of(Words.Javelin));
		...
		//<editor-fold desc="Frogs">
		Register("minecraft:ochre_froglight", OCHRE_FROGLIGHT, List.of(EN_US.Froglight(Words.Ochre)));
		Register("minecraft:verdant_froglight", VERDANT_FROGLIGHT, List.of(EN_US.Froglight(Words.Verdant)));
		Register("minecraft:pearlescent_froglight", PEARLESCENT_FROGLIGHT, List.of(EN_US.Froglight(Words.Pearlescent)));
		Register("minecraft:frogspawn", FROGSPAWN, List.of(Words.Frogspawn));
		//</editor-fold>
		//<editor-fold desc="Sculk">
		Register("minecraft:sculk", SCULK, List.of(Words.Sculk));
		Register("minecraft:sculk_vein", SCULK_VEIN, List.of(EN_US.Vein(Words.Sculk)));
		Register("minecraft:calibrated_sculk_sensor", CALIBRATED_SCULK_SENSOR, CALIBRATED_SCULK_SENSOR_ENTITY, List.of(EN_US.Sensor(EN_US.Sculk(Words.Calibrated))));
		Register("minecraft:sculk_catalyst", SCULK_CATALYST, SCULK_CATALYST_ENTITY, List.of(EN_US.Catalyst(Words.Sculk)));
		Register("minecraft:sculk_shrieker", SCULK_SHRIEKER, SCULK_SHRIEKER_ENTITY, List.of(EN_US.Shrieker(Words.Sculk)));
		//</editor-fold>
		Register("minecraft:recovery_compass", RECOVERY_COMPASS, List.of(EN_US.Compass(Words.Recovery)));
		//<editor-fold desc="Echo">
		Register("minecraft:echo_shard", ECHO_SHARD, List.of(EN_US.Shard(Words.Echo)));
		//Extended
		Register("echo_block", ECHO_BLOCK, List.of(EN_US.Block(Words.Echo)));
		Register("echo_stairs", ECHO_STAIRS, List.of(EN_US.Stairs(Words.Echo)));
		Register("echo_slab", ECHO_SLAB, List.of(EN_US.Slab(Words.Echo)));
		Register("echo_wall", ECHO_WALL, List.of(EN_US.Wall(Words.Echo)));
		Register("echo_bricks", ECHO_BRICKS, List.of(EN_US.Bricks(Words.Echo)));
		Register("echo_brick_stairs", ECHO_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Echo))));
		Register("echo_brick_slab", ECHO_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Echo))));
		Register("echo_brick_wall", ECHO_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Echo))));
		Register("echo_crystal_block", ECHO_CRYSTAL_BLOCK, List.of(EN_US.Block(EN_US.Crystal(Words.Echo))));
		Register("echo_crystal_stairs", ECHO_CRYSTAL_STAIRS, List.of(EN_US.Stairs(EN_US.Crystal(Words.Echo))));
		Register("echo_crystal_slab", ECHO_CRYSTAL_SLAB, List.of(EN_US.Slab(EN_US.Crystal(Words.Echo))));
		Register("echo_crystal_wall", ECHO_CRYSTAL_WALL, List.of(EN_US.Wall(EN_US.Crystal(Words.Echo))));
		Register("budding_echo", BUDDING_ECHO, List.of(EN_US.Echo(Words.Budding)));
		Register("echo_cluster", ECHO_CLUSTER, List.of(EN_US.Cluster(Words.Echo)));
		Register("large_echo_bud", LARGE_ECHO_BUD, List.of(EN_US.Bud(EN_US.Echo(Words.Large))));
		Register("medium_echo_bud", MEDIUM_ECHO_BUD, List.of(EN_US.Bud(EN_US.Echo(Words.Medium))));
		Register("small_echo_bud", SMALL_ECHO_BUD, List.of(EN_US.Bud(EN_US.Echo(Words.Small))));
		Register("echo_axe", ECHO_AXE, List.of(EN_US.Axe(Words.Echo)));
		Register("echo_hoe", ECHO_HOE, List.of(EN_US.Hoe(Words.Echo)));
		Register("echo_pickaxe", ECHO_PICKAXE, List.of(EN_US.Pickaxe(Words.Echo)));
		Register("echo_shovel", ECHO_SHOVEL, List.of(EN_US.Shovel(Words.Echo)));
		Register("echo_sword", ECHO_SWORD, List.of(EN_US.Sword(Words.Echo)));
		Register("echo_knife", ECHO_KNIFE, List.of(EN_US.Knife(Words.Echo)));
		Register("echo_hammer", ECHO_HAMMER, List.of(EN_US.Hammer(Words.Echo)));
		//</editor-fold>
		//<editor-fold desc="Sculk (Extended)">
		Register("sculk_stone", SCULK_STONE, List.of(EN_US.Stone(Words.Sculk)));
		Register("sculk_stone_stairs", SCULK_STONE_STAIRS, List.of(EN_US.Stairs(EN_US.Stone(Words.Sculk))));
		Register("sculk_stone_slab", SCULK_STONE_SLAB, List.of(EN_US.Slab(EN_US.Stone(Words.Sculk))));
		Register("sculk_stone_wall", SCULK_STONE_WALL, List.of(EN_US.Wall(EN_US.Stone(Words.Sculk))));
		Register("cobbled_sculk_stone", COBBLED_SCULK_STONE, List.of(EN_US.Stone(EN_US.Sculk(Words.Cobbled))));
		Register("cobbled_sculk_stone_stairs", COBBLED_SCULK_STONE_STAIRS, List.of(EN_US.Stairs(EN_US.Stone(EN_US.Sculk(Words.Cobbled)))));
		Register("cobbled_sculk_stone_slab", COBBLED_SCULK_STONE_SLAB, List.of(EN_US.Slab(EN_US.Stone(EN_US.Sculk(Words.Cobbled)))));
		Register("cobbled_sculk_stone_wall", COBBLED_SCULK_STONE_WALL, List.of(EN_US.Wall(EN_US.Stone(EN_US.Sculk(Words.Cobbled)))));
		Register("sculk_stone_bricks", SCULK_STONE_BRICKS, List.of(EN_US.Bricks(EN_US.Stone(Words.Sculk))));
		Register("sculk_stone_brick_stairs", SCULK_STONE_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Stone(Words.Sculk)))));
		Register("sculk_stone_brick_slab", SCULK_STONE_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Stone(Words.Sculk)))));
		Register("sculk_stone_brick_wall", SCULK_STONE_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Stone(Words.Sculk)))));
		...
		Register("smooth_chiseled_sculk_stone_bricks", SMOOTH_CHISELED_SCULK_STONE_BRICKS, List.of(EN_US.Bricks(EN_US.Stone(EN_US.Sculk(EN_US.Chiseled(Words.Smooth))))));
		Register("sculk_stone_tiles", SCULK_STONE_TILES, List.of(EN_US.Tiles(EN_US.Stone(Words.Sculk))));
		Register("sculk_stone_tile_stairs", SCULK_STONE_TILE_STAIRS, List.of(EN_US.Stairs(EN_US.Tile(EN_US.Stone(Words.Sculk)))));
		Register("sculk_stone_tile_slab", SCULK_STONE_TILE_SLAB, List.of(EN_US.Slab(EN_US.Tile(EN_US.Stone(Words.Sculk)))));
		Register("sculk_stone_tile_wall", SCULK_STONE_TILE_WALL, List.of(EN_US.Wall(EN_US.Tile(EN_US.Stone(Words.Sculk)))));
		//Turf
		Register("chum", CHUM, List.of(Words.Chum));
		...
		Register("basalt_sculk_turf", BASALT_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Basalt))));
		...
		Register("deepslate_sculk_turf", DEEPSLATE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Deepslate))));
		Register("diorite_sculk_turf", DIORITE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Diorite))));
		Register("dripstone_sculk_turf", DRIPSTONE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Dripstone))));
		...
		Register("netherrack_sculk_turf", NETHERRACK_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Netherrack))));
		Register("red_sandstone_sculk_turf", RED_SANDSTONE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(EN_US.Sandstone(Words.Red)))));
		Register("sandstone_sculk_turf", SANDSTONE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Sandstone))));
		Register("shale_sculk_turf", SHALE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Shale))));
		Register("smooth_basalt_sculk_turf", SMOOTH_BASALT_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(EN_US.Basalt(Words.Smooth)))));
		Register("stone_sculk_turf", STONE_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Stone))));
		Register("tuff_sculk_turf", TUFF_SCULK_TURF, List.of(EN_US.Turf(EN_US.Sculk(Words.Tuff))));
		//</editor-fold>
		Register("broom", BROOM, List.of(Words.Broom));
		//<editor-fold desc="Sniffer">
		Register("minecraft:sniffer_egg", SNIFFER_EGG, List.of(EN_US.Egg(Words.Sniffer)));
		//</editor-fold>
		RegisterBrushableBlocks();
		Register("minecraft:chiseled_bookshelf", CHISELED_BOOKSHELF_ENTITY);
		//<editor-fold desc="Pottery Shards">
		Register("minecraft:angler_pottery_sherd", ANGLER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Angler))));
		Register("minecraft:archer_pottery_sherd", ARCHER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Archer))));
		Register("minecraft:arms_up_pottery_sherd", ARMS_UP_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(EN_US.Up(Words.Arms)))));
		Register("minecraft:blade_pottery_sherd", BLADE_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Blade))));
		Register("minecraft:brewer_pottery_sherd", BREWER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Brewer))));
		Register("minecraft:burn_pottery_sherd", BURN_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Burn))));
		Register("minecraft:danger_pottery_sherd", DANGER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Danger))));
		Register("minecraft:explorer_pottery_sherd", EXPLORER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Explorer))));
		Register("minecraft:friend_pottery_sherd", FRIEND_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Friend))));
		Register("minecraft:heart_pottery_sherd", HEART_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Heart))));
		Register("minecraft:heartbreak_pottery_sherd", HEARTBREAK_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Heartbreak))));
		Register("minecraft:howl_pottery_sherd", HOWL_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Howl))));
		Register("minecraft:miner_pottery_sherd", MINER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Miner))));
		Register("minecraft:mourner_pottery_sherd", MOURNER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Mourner))));
		Register("minecraft:plenty_pottery_sherd", PLENTY_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Plenty))));
		Register("minecraft:prize_pottery_sherd", PRIZE_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Prize))));
		Register("minecraft:sheaf_pottery_sherd", SHEAF_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Sheaf))));
		Register("minecraft:shelter_pottery_sherd", SHELTER_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Shelter))));
		Register("minecraft:skull_pottery_sherd", SKULL_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Skull))));
		Register("minecraft:snort_pottery_sherd", SNORT_POTTERY_SHERD, List.of(EN_US.Sherd(EN_US.Pottery(Words.Snort))));
		//</editor-fold>
		RegisterFlowers();
		Register("firing_charge", FIRING_CHARGE, List.of(EN_US.Charge(Words.Firing)));
		Register("minecraft:trial_key", TRIAL_KEY, List.of(EN_US.Key(Words.Trial)));
		Register("minecraft:netherite_upgrade_smithing_template", NETHERITE_UPGRADE_SMITHING_TEMPLATE, List.of(EN_US.Template(EN_US.Smithing(EN_US.Upgrade(Words.Netherite)))));
		Register("trimming", TRIMMING_RECIPE_SERIALIZER);
		Register("trimming_table", TRIMMING_TABLE, List.of(EN_US.Table(Words.Trimming)));
		...
		Register("cooked_piranha", COOKED_PIRANHA, List.of(EN_US.Piranha(Words.Cooked)));
		//</editor-fold>
	...
	private static void RegisterDyes() {
		...
		//<editor-fold desc="Beige">
		Register("beige_dye", BEIGE_DYE, List.of(EN_US.Dye(Words.Beige)));
		Register("beige_dye_block", BEIGE_DYE_BLOCK, List.of(EN_US.Block(EN_US.Dye(Words.Beige))));
		Register("beige_candle", BEIGE_CANDLE, List.of(EN_US.Candle(Words.Beige)));
		Register("beige_candle_cake", BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(Words.Cake)))));
		Register("beige_carrot_candle_cake", CARROT_CAKE.BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("beige_chocolate_candle_cake", CHOCOLATE_CAKE.BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("beige_chorus_candle_cake", CHORUS_CAKE.BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(EN_US.Cake(Words.Chorus))))));
		...
		Register("beige_confetti_candle_cake", CONFETTI_CAKE.BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("beige_strawberry_candle_cake", STRAWBERRY_CAKE.BEIGE_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Beige(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		...
		Register("beige_concrete", BEIGE_CONCRETE, List.of(EN_US.Concrete(Words.Beige)));
		Register("beige_concrete_stairs", BEIGE_CONCRETE_STAIRS, List.of(EN_US.Stairs(EN_US.Concrete(Words.Beige))));
		Register("beige_concrete_slab", BEIGE_CONCRETE_SLAB, List.of(EN_US.Slab(EN_US.Concrete(Words.Beige))));
		Register("beige_concrete_wall", BEIGE_CONCRETE_WALL, List.of(EN_US.Wall(EN_US.Concrete(Words.Beige))));
		Register("beige_concrete_powder", BEIGE_CONCRETE_POWDER, List.of(EN_US.Powder(EN_US.Concrete(Words.Beige))));
		Register("beige_terracotta", BEIGE_TERRACOTTA, List.of(EN_US.Terracotta(Words.Beige)));
		Register("beige_terracotta_stairs", BEIGE_TERRACOTTA_STAIRS, List.of(EN_US.Stairs(EN_US.Terracotta(Words.Beige))));
		Register("beige_terracotta_slab", BEIGE_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(Words.Beige))));
		Register("beige_terracotta_wall", BEIGE_TERRACOTTA_WALL, List.of(EN_US.Wall(EN_US.Terracotta(Words.Beige))));
		Register("beige_glazed_terracotta", BEIGE_GLAZED_TERRACOTTA, List.of(EN_US.Terracotta(EN_US.Glazed(Words.Beige))));
		Register("beige_glazed_terracotta_slab", BEIGE_GLAZED_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(EN_US.Glazed(Words.Beige)))));
		Register("beige_wool", BEIGE_WOOL, List.of(EN_US.Wool(Words.Beige)));
		Register("beige_wool_slab", BEIGE_WOOL_SLAB, List.of(EN_US.Slab(EN_US.Wool(Words.Beige))));
		Register("beige_carpet", BEIGE_CARPET, List.of(EN_US.Carpet(Words.Beige)));
		Register("beige_fleece", BEIGE_FLEECE, List.of(EN_US.Fleece(Words.Beige)));
		Register("beige_fleece_slab", BEIGE_FLEECE_SLAB, List.of(EN_US.Slab(EN_US.Fleece(Words.Beige))));
		Register("beige_fleece_carpet", BEIGE_FLEECE_CARPET, List.of(EN_US.Carpet(EN_US.Fleece(Words.Beige))));
		Register("beige_stained_glass", BEIGE_STAINED_GLASS, List.of(EN_US.Glass(EN_US.Stained(Words.Beige))));
		Register("beige_stained_glass_pane", BEIGE_STAINED_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(EN_US.Stained(Words.Beige)))));
		Register("beige_stained_glass_slab", BEIGE_STAINED_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(EN_US.Stained(Words.Beige)))));
		Register("beige_stained_glass_trapdoor", BEIGE_STAINED_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(EN_US.Stained(Words.Beige)))));
		//</editor-fold>
		//<editor-fold desc="Burgundy">
		Register("burgundy_dye", BURGUNDY_DYE, List.of(EN_US.Dye(Words.Burgundy)));
		Register("burgundy_dye_block", BURGUNDY_DYE_BLOCK, List.of(EN_US.Block(EN_US.Dye(Words.Burgundy))));
		Register("burgundy_candle", BURGUNDY_CANDLE, List.of(EN_US.Candle(Words.Burgundy)));
		Register("burgundy_candle_cake", BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(Words.Cake)))));
		Register("burgundy_carrot_candle_cake", CARROT_CAKE.BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("burgundy_chocolate_candle_cake", CHOCOLATE_CAKE.BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("burgundy_chorus_candle_cake", CHORUS_CAKE.BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(EN_US.Cake(Words.Chorus))))));
		...
		Register("burgundy_confetti_candle_cake", CONFETTI_CAKE.BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("burgundy_strawberry_candle_cake", STRAWBERRY_CAKE.BURGUNDY_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Burgundy(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		...
		Register("burgundy_concrete", BURGUNDY_CONCRETE, List.of(EN_US.Concrete(Words.Burgundy)));
		Register("burgundy_concrete_stairs", BURGUNDY_CONCRETE_STAIRS, List.of(EN_US.Stairs(EN_US.Concrete(Words.Burgundy))));
		Register("burgundy_concrete_slab", BURGUNDY_CONCRETE_SLAB, List.of(EN_US.Slab(EN_US.Concrete(Words.Burgundy))));
		Register("burgundy_concrete_wall", BURGUNDY_CONCRETE_WALL, List.of(EN_US.Wall(EN_US.Concrete(Words.Burgundy))));
		Register("burgundy_concrete_powder", BURGUNDY_CONCRETE_POWDER, List.of(EN_US.Powder(EN_US.Concrete(Words.Burgundy))));
		Register("burgundy_terracotta", BURGUNDY_TERRACOTTA, List.of(EN_US.Terracotta(Words.Burgundy)));
		Register("burgundy_terracotta_stairs", BURGUNDY_TERRACOTTA_STAIRS, List.of(EN_US.Stairs(EN_US.Terracotta(Words.Burgundy))));
		Register("burgundy_terracotta_slab", BURGUNDY_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(Words.Burgundy))));
		Register("burgundy_terracotta_wall", BURGUNDY_TERRACOTTA_WALL, List.of(EN_US.Wall(EN_US.Terracotta(Words.Burgundy))));
		Register("burgundy_glazed_terracotta", BURGUNDY_GLAZED_TERRACOTTA, List.of(EN_US.Terracotta(EN_US.Glazed(Words.Burgundy))));
		Register("burgundy_glazed_terracotta_slab", BURGUNDY_GLAZED_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(EN_US.Glazed(Words.Burgundy)))));
		Register("burgundy_wool", BURGUNDY_WOOL, List.of(EN_US.Wool(Words.Burgundy)));
		Register("burgundy_wool_slab", BURGUNDY_WOOL_SLAB, List.of(EN_US.Slab(EN_US.Wool(Words.Burgundy))));
		Register("burgundy_carpet", BURGUNDY_CARPET, List.of(EN_US.Carpet(Words.Burgundy)));
		Register("burgundy_fleece", BURGUNDY_FLEECE, List.of(EN_US.Fleece(Words.Burgundy)));
		Register("burgundy_fleece_slab", BURGUNDY_FLEECE_SLAB, List.of(EN_US.Slab(EN_US.Fleece(Words.Burgundy))));
		Register("burgundy_fleece_carpet", BURGUNDY_FLEECE_CARPET, List.of(EN_US.Carpet(EN_US.Fleece(Words.Burgundy))));
		Register("burgundy_stained_glass", BURGUNDY_STAINED_GLASS, List.of(EN_US.Glass(EN_US.Stained(Words.Burgundy))));
		Register("burgundy_stained_glass_pane", BURGUNDY_STAINED_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(EN_US.Stained(Words.Burgundy)))));
		Register("burgundy_stained_glass_slab", BURGUNDY_STAINED_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(EN_US.Stained(Words.Burgundy)))));
		Register("burgundy_stained_glass_trapdoor", BURGUNDY_STAINED_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(EN_US.Stained(Words.Burgundy)))));
		//</editor-fold>
		//<editor-fold desc="Lavender">
		Register("lavender_dye", LAVENDER_DYE, List.of(EN_US.Dye(Words.Lavender)));
		Register("lavender_dye_block", LAVENDER_DYE_BLOCK, List.of(EN_US.Block(EN_US.Dye(Words.Lavender))));
		Register("lavender_candle", LAVENDER_CANDLE, List.of(EN_US.Candle(Words.Lavender)));
		Register("lavender_candle_cake", LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(Words.Cake)))));
		Register("lavender_carrot_candle_cake", CARROT_CAKE.LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("lavender_chocolate_candle_cake", CHOCOLATE_CAKE.LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("lavender_chorus_candle_cake", CHORUS_CAKE.LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(EN_US.Cake(Words.Chorus))))));
		...
		Register("lavender_confetti_candle_cake", CONFETTI_CAKE.LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("lavender_strawberry_candle_cake", STRAWBERRY_CAKE.LAVENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Lavender(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		...
		Register("lavender_concrete", LAVENDER_CONCRETE, List.of(EN_US.Concrete(Words.Lavender)));
		Register("lavender_concrete_stairs", LAVENDER_CONCRETE_STAIRS, List.of(EN_US.Stairs(EN_US.Concrete(Words.Lavender))));
		Register("lavender_concrete_slab", LAVENDER_CONCRETE_SLAB, List.of(EN_US.Slab(EN_US.Concrete(Words.Lavender))));
		Register("lavender_concrete_wall", LAVENDER_CONCRETE_WALL, List.of(EN_US.Wall(EN_US.Concrete(Words.Lavender))));
		Register("lavender_concrete_powder", LAVENDER_CONCRETE_POWDER, List.of(EN_US.Powder(EN_US.Concrete(Words.Lavender))));
		Register("lavender_terracotta", LAVENDER_TERRACOTTA, List.of(EN_US.Terracotta(Words.Lavender)));
		Register("lavender_terracotta_stairs", LAVENDER_TERRACOTTA_STAIRS, List.of(EN_US.Stairs(EN_US.Terracotta(Words.Lavender))));
		Register("lavender_terracotta_slab", LAVENDER_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(Words.Lavender))));
		Register("lavender_terracotta_wall", LAVENDER_TERRACOTTA_WALL, List.of(EN_US.Wall(EN_US.Terracotta(Words.Lavender))));
		Register("lavender_glazed_terracotta", LAVENDER_GLAZED_TERRACOTTA, List.of(EN_US.Terracotta(EN_US.Glazed(Words.Lavender))));
		Register("lavender_glazed_terracotta_slab", LAVENDER_GLAZED_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(EN_US.Glazed(Words.Lavender)))));
		Register("lavender_wool", LAVENDER_WOOL, List.of(EN_US.Wool(Words.Lavender)));
		Register("lavender_wool_slab", LAVENDER_WOOL_SLAB, List.of(EN_US.Slab(EN_US.Wool(Words.Lavender))));
		Register("lavender_carpet", LAVENDER_CARPET, List.of(EN_US.Carpet(Words.Lavender)));
		Register("lavender_fleece", LAVENDER_FLEECE, List.of(EN_US.Fleece(Words.Lavender)));
		Register("lavender_fleece_slab", LAVENDER_FLEECE_SLAB, List.of(EN_US.Slab(EN_US.Fleece(Words.Lavender))));
		Register("lavender_fleece_carpet", LAVENDER_FLEECE_CARPET, List.of(EN_US.Carpet(EN_US.Fleece(Words.Lavender))));
		Register("lavender_stained_glass", LAVENDER_STAINED_GLASS, List.of(EN_US.Glass(EN_US.Stained(Words.Lavender))));
		Register("lavender_stained_glass_pane", LAVENDER_STAINED_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(EN_US.Stained(Words.Lavender)))));
		Register("lavender_stained_glass_slab", LAVENDER_STAINED_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(EN_US.Stained(Words.Lavender)))));
		Register("lavender_stained_glass_trapdoor", LAVENDER_STAINED_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(EN_US.Stained(Words.Lavender)))));
		//</editor-fold>
		//<editor-fold desc="Mint">
		Register("mint_dye", MINT_DYE, List.of(EN_US.Dye(Words.Mint)));
		Register("mint_dye_block", MINT_DYE_BLOCK, List.of(EN_US.Block(EN_US.Dye(Words.Mint))));
		Register("mint_candle", MINT_CANDLE, List.of(EN_US.Candle(Words.Mint)));
		Register("mint_candle_cake", MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(Words.Cake)))));
		Register("mint_carrot_candle_cake", CARROT_CAKE.MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("mint_chocolate_candle_cake", CHOCOLATE_CAKE.MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("mint_chorus_candle_cake", CHORUS_CAKE.MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(EN_US.Cake(Words.Chorus))))));
		...
		Register("mint_confetti_candle_cake", CONFETTI_CAKE.MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("mint_strawberry_candle_cake", STRAWBERRY_CAKE.MINT_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Mint(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		...
		Register("mint_concrete", MINT_CONCRETE, List.of(EN_US.Concrete(Words.Mint)));
		Register("mint_concrete_stairs", MINT_CONCRETE_STAIRS, List.of(EN_US.Stairs(EN_US.Concrete(Words.Mint))));
		Register("mint_concrete_slab", MINT_CONCRETE_SLAB, List.of(EN_US.Slab(EN_US.Concrete(Words.Mint))));
		Register("mint_concrete_wall", MINT_CONCRETE_WALL, List.of(EN_US.Wall(EN_US.Concrete(Words.Mint))));
		Register("mint_concrete_powder", MINT_CONCRETE_POWDER, List.of(EN_US.Powder(EN_US.Concrete(Words.Mint))));
		Register("mint_terracotta", MINT_TERRACOTTA, List.of(EN_US.Terracotta(Words.Mint)));
		Register("mint_terracotta_stairs", MINT_TERRACOTTA_STAIRS, List.of(EN_US.Stairs(EN_US.Terracotta(Words.Mint))));
		Register("mint_terracotta_slab", MINT_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(Words.Mint))));
		Register("mint_terracotta_wall", MINT_TERRACOTTA_WALL, List.of(EN_US.Wall(EN_US.Terracotta(Words.Mint))));
		Register("mint_glazed_terracotta", MINT_GLAZED_TERRACOTTA, List.of(EN_US.Terracotta(EN_US.Glazed(Words.Mint))));
		Register("mint_glazed_terracotta_slab", MINT_GLAZED_TERRACOTTA_SLAB, List.of(EN_US.Slab(EN_US.Terracotta(EN_US.Glazed(Words.Mint)))));
		Register("mint_wool", MINT_WOOL, List.of(EN_US.Wool(Words.Mint)));
		Register("mint_wool_slab", MINT_WOOL_SLAB, List.of(EN_US.Slab(EN_US.Wool(Words.Mint))));
		Register("mint_carpet", MINT_CARPET, List.of(EN_US.Carpet(Words.Mint)));
		Register("mint_fleece", MINT_FLEECE, List.of(EN_US.Fleece(Words.Mint)));
		Register("mint_fleece_slab", MINT_FLEECE_SLAB, List.of(EN_US.Slab(EN_US.Fleece(Words.Mint))));
		Register("mint_fleece_carpet", MINT_FLEECE_CARPET, List.of(EN_US.Carpet(EN_US.Fleece(Words.Mint))));
		Register("mint_stained_glass", MINT_STAINED_GLASS, List.of(EN_US.Glass(EN_US.Stained(Words.Mint))));
		Register("mint_stained_glass_pane", MINT_STAINED_GLASS_PANE, List.of(EN_US.Pane(EN_US.Glass(EN_US.Stained(Words.Mint)))));
		Register("mint_stained_glass_slab", MINT_STAINED_GLASS_SLAB, List.of(EN_US.Slab(EN_US.Glass(EN_US.Stained(Words.Mint)))));
		Register("mint_stained_glass_trapdoor", MINT_STAINED_GLASS_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Glass(EN_US.Stained(Words.Mint)))));
		//</editor-fold>
	}
	private static void RegisterIron() {
		Register("raw_iron_nugget", RAW_IRON_NUGGET, List.of(EN_US.Nugget(EN_US.Iron(Words.Raw))));
		Register("iron_rod", IRON_ROD, List.of(EN_US.Rod(Words.Iron)));
		...
		Register("iron_torch", "iron_wall_torch", IRON_TORCH, List.of(EN_US._Torch(Words.Iron)));
		Register("iron_soul_torch", "iron_soul_wall_torch", IRON_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(Words.Iron))));
		Register("iron_ender_torch", "iron_ender_wall_torch", IRON_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(Words.Iron))));
		Register("underwater_iron_torch", "underwater_iron_wall_torch", UNDERWATER_IRON_TORCH, List.of(EN_US._Torch(EN_US.Iron(Words.Underwater))));
		Register("iron_lantern", IRON_LANTERN, List.of(EN_US.Lantern(Words.Iron)));
		Register("iron_soul_lantern", IRON_SOUL_LANTERN, List.of(EN_US.Lantern(EN_US.Soul(Words.Iron))));
		Register("iron_ender_lantern", IRON_ENDER_LANTERN, List.of(EN_US.Lantern(EN_US.Ender(Words.Iron))));
		Register("iron_button", IRON_BUTTON, List.of(EN_US.Button(Words.Iron)));
		Register("iron_chain", IRON_CHAIN, List.of(EN_US.Chain(Words.Iron)));
		Register("heavy_iron_chain", HEAVY_IRON_CHAIN, List.of(EN_US.Chain(EN_US.Iron(Words.Heavy))));
		Register("iron_stairs", IRON_STAIRS, List.of(EN_US.Stairs(Words.Iron)));
		Register("iron_slab", IRON_SLAB, List.of(EN_US.Slab(Words.Iron)));
		Register("iron_wall", IRON_WALL, List.of(EN_US.Wall(Words.Iron)));
		Register("iron_bricks", IRON_BRICKS, List.of(EN_US.Bricks(Words.Iron)));
		Register("iron_brick_stairs", IRON_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(Words.Iron))));
		Register("iron_brick_slab", IRON_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(Words.Iron))));
		Register("iron_brick_wall", IRON_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(Words.Iron))));
		Register("cut_iron", CUT_IRON, List.of(EN_US.Iron(Words.Cut)));
		Register("cut_iron_pillar", CUT_IRON_PILLAR, List.of(EN_US.Pillar(EN_US.Iron(Words.Cut))));
		Register("cut_iron_stairs", CUT_IRON_STAIRS, List.of(EN_US.Stairs(EN_US.Iron(Words.Cut))));
		Register("cut_iron_slab", CUT_IRON_SLAB, List.of(EN_US.Slab(EN_US.Iron(Words.Cut))));
		Register("cut_iron_wall", CUT_IRON_WALL, List.of(EN_US.Wall(EN_US.Iron(Words.Cut))));
		Register("iron_hammer", IRON_HAMMER, List.of(EN_US.Hammer(Words.Iron)));
	}
	private static void RegisterGold() {
		...
		Register("underwater_gold_torch", "underwater_gold_wall_torch", UNDERWATER_GOLD_TORCH, List.of(EN_US._Torch(EN_US.Gold(Words.Underwater))));
		...
		Register("heavy_gold_chain", HEAVY_GOLD_CHAIN, List.of(EN_US.Chain(EN_US.Gold(Words.Heavy))));
		...
		Register("cut_gold", CUT_GOLD, List.of(EN_US.Gold(Words.Cut)));
		Register("cut_gold_pillar", CUT_GOLD_PILLAR, List.of(EN_US.Pillar(EN_US.Gold(Words.Cut))));
		Register("cut_gold_stairs", CUT_GOLD_STAIRS, List.of(EN_US.Stairs(EN_US.Gold(Words.Cut))));
		Register("cut_gold_slab", CUT_GOLD_SLAB, List.of(EN_US.Slab(EN_US.Gold(Words.Cut))));
		Register("cut_gold_wall", CUT_GOLD_WALL, List.of(EN_US.Wall(EN_US.Gold(Words.Cut))));
	...
	private static void RegisterBlood() {
		//<editor-fold desc="Blood">
		Register("blood_bottle", BLOOD_BOTTLE, List.of(EN_US.Bottle(Words.Blood)));
		Register("blood_bucket", BLOOD_BUCKET, List.of(EN_US.Bucket(Words.Blood)));
		Register("blood_cauldron", BLOOD_CAULDRON, List.of(EN_US.Cauldron(Words.Blood)));
		...
		Register("blood_fluid_block", BLOOD_FLUID_BLOCK, List.of(EN_US.Block(EN_US.Fluid(Words.Blood))));
		//Solid
		Register("blood_block", BLOOD_BLOCK, List.of(EN_US.Block(Words.Blood)));
		JuicerBlock.JUICE_MAP.put(BLOOD_BLOCK::asItem, BLOOD_BOTTLE);
		Register("blood_fence", BLOOD_FENCE, List.of(EN_US.Fence(Words.Blood)));
		Register("blood_pane", BLOOD_PANE, List.of(EN_US.Pane(Words.Blood)));
		Register("blood_stairs", BLOOD_STAIRS, List.of(EN_US.Stairs(Words.Blood)));
		Register("blood_slab", BLOOD_SLAB, List.of(EN_US.Slab(Words.Blood)));
		Register("blood_wall", BLOOD_WALL, List.of(EN_US.Wall(Words.Blood)));
		...
		Register("syringe", SYRINGE, List.of(Words.Syringe));
		Register("dirty_syringe", DIRTY_SYRINGE, List.of(EN_US.Syringe(Words.Dirty)));
		Register("blood_syringe", BLOOD_SYRINGE, List.of(EN_US.Syringe(Words.Blood)));
		Register("confetti_syringe", CONFETTI_SYRINGE, List.of(EN_US.Syringe(Words.Confetti)));
		Register("dragon_breath_syringe", DRAGON_BREATH_SYRINGE, List.of(EN_US.Syringe(EN_US.Breath(Words.Dragon))));
		Register("experience_syringe", EXPERIENCE_SYRINGE, List.of(EN_US.Syringe(Words.Experience)));
		Register("honey_syringe", HONEY_SYRINGE, List.of(EN_US.Syringe(Words.Honey)));
		BloodType.RegisterBloodType(BloodType.HONEY, HONEY_SYRINGE);
		Register("lava_syringe", LAVA_SYRINGE, List.of(EN_US.Syringe(Words.Lava)));
		BloodType.RegisterBloodType(BloodType.LAVA, LAVA_SYRINGE);
		Register("magma_cream_syringe", MAGMA_CREAM_SYRINGE, List.of(EN_US.Syringe(EN_US.Cream(Words.Magma))));
		BloodType.RegisterBloodType(MAGMA_CREAM_BLOOD_TYPE, MAGMA_CREAM_SYRINGE);
		Register("mud_syringe", MUD_SYRINGE, List.of(EN_US.Syringe(Words.Mud)));
		BloodType.RegisterBloodType(BloodType.MUD, MUD_SYRINGE);
		Register("sap_syringe", SAP_SYRINGE, List.of(EN_US.Syringe(Words.Sap)));
	...
	private static void RegisterFlowers() {
		...
		Register("minecraft:torchflower", TORCHFLOWER, List.of(EN_US._Potted(Words.Torchflower)));
		//</editor-fold>
		//<editor-fold desc="Pitcher Plant">
		...
		//<editor-fold desc="Flowers">
		//<editor-fold desc="Minecraft Earth">
		Register("buttercup", BUTTERCUP, List.of(EN_US._Potted(Words.Buttercup)));
		Register("pink_daisy", PINK_DAISY, List.of(EN_US._Potted(EN_US.Daisy(Words.Pink))));
		//</editor-fold>
		Register("rose", ROSE, List.of(EN_US._Potted(Words.Rose)));
		...
		Register("marigold", MARIGOLD, List.of(EN_US._Potted(Words.Marigold)));
		Register("pink_allium", PINK_ALLIUM, List.of(EN_US._Potted(EN_US.Allium(Words.Pink))));
		Register("lavender", LAVENDER, List.of(EN_US._Potted(Words.Lavender)));
		Register("hydrangea", HYDRANGEA, List.of(EN_US._Potted(Words.Hydrangea)));
		//<editor-fold desc="Orchids">
		...
		//</editor-fold>
		Register("paeonia", PAEONIA, List.of(EN_US._Potted(Words.Paeonia)));
	...
	private static void RegisterFood() {
		...
		Register("cinnamon", CINNAMON, List.of(Words.Cinnamon));
		CompostingChanceRegistry.INSTANCE.add(CINNAMON, 0.2f);
		Register("cherry", CHERRY, List.of(Words.Cherry));
		...
		Register("strawberry_bush", STRAWBERRY_BUSH, List.of(EN_US.Bush(Words.Strawberry)));
		FlammableBlockRegistry.getDefaultInstance().add(STRAWBERRY_BUSH, 60, 100);
		Register("strawberry", STRAWBERRY, List.of(Words.Strawberry));
		CompostingChanceRegistry.INSTANCE.add(STRAWBERRY, 0.3F);
		Register("snickerdoodle", SNICKERDOODLE, List.of(Words.Snickerdoodle));
		CompostingChanceRegistry.INSTANCE.add(SNICKERDOODLE, 0.85F);
		Register("chocolate_cookie", CHOCOLATE_COOKIE, List.of(EN_US.Cookie(Words.Chocolate)));
		CompostingChanceRegistry.INSTANCE.add(CHOCOLATE_COOKIE, 0.85F);
		Register("chorus_cookie", CHORUS_COOKIE, List.of(EN_US.Cookie(Words.Chorus)));
		CompostingChanceRegistry.INSTANCE.add(CHORUS_COOKIE, 0.85F);
		Register("confetti_cookie", CONFETTI_COOKIE, List.of(EN_US.Cookie(Words.Confetti)));
		CompostingChanceRegistry.INSTANCE.add(CONFETTI_COOKIE, 0.85F);
		Register("cinnamon_roll", CINNAMON_ROLL, List.of(EN_US.Roll(Words.Cinnamon)));
		CompostingChanceRegistry.INSTANCE.add(CINNAMON_ROLL, 0.85F);
		Register("tomato_soup", TOMATO_SOUP, List.of(EN_US.Soup(Words.Tomato)));
		Register("hotdog", HOTDOG, List.of(Words.Hotdog));
		Register("ramen", RAMEN, List.of(Words.Ramen));
		Register("stir_fry", STIR_FRY, List.of(EN_US.Fry(Words.Stir)));
		//Dairy
		Register("cheese", CHEESE, List.of(Words.Cheese));
		Register("grilled_cheese", GRILLED_CHEESE, List.of(EN_US.Cheese(Words.Grilled)));
		Register("cottage_cheese_bowl", COTTAGE_CHEESE_BOWL, List.of(EN_US.Bowl(EN_US.Cheese(Words.Cottage))));
		//Dairy Sweets
		Register("egg_nog", EGG_NOG, List.of(EN_US.Nog(Words.Egg)));
		Register("milkshake", MILKSHAKE, List.of(Words.Milkshake));
		Register("chocolate_milkshake", CHOCOLATE_MILKSHAKE, List.of(EN_US.Milkshake(Words.Chocolate)));
		Register("coffee_milkshake", COFFEE_MILKSHAKE, List.of(EN_US.Milkshake(Words.Coffee)));
		Register("strawberry_milkshake", STRAWBERRY_MILKSHAKE, List.of(EN_US.Milkshake(Words.Strawberry)));
		Register("vanilla_milkshake", VANILLA_MILKSHAKE, List.of(EN_US.Milkshake(Words.Vanilla)));
		Register("chocolate_chip_milkshake", CHOCOLATE_CHIP_MILKSHAKE, List.of(EN_US.Milkshake(EN_US.Chip(Words.Chocolate))));
		Register("ice_cream", ICE_CREAM, List.of(EN_US.Cream(Words.Ice)));
		Register("chocolate_ice_cream", CHOCOLATE_ICE_CREAM, List.of(EN_US.Cream(EN_US.Ice(Words.Chocolate))));
		Register("coffee_ice_cream", COFFEE_ICE_CREAM, List.of(EN_US.Cream(EN_US.Ice(Words.Coffee))));
		Register("strawberry_ice_cream", STRAWBERRY_ICE_CREAM, List.of(EN_US.Cream(EN_US.Ice(Words.Strawberry))));
		Register("vanilla_ice_cream", VANILLA_ICE_CREAM, List.of(EN_US.Cream(EN_US.Ice(Words.Vanilla))));
		Register("chocolate_chip_ice_cream", CHOCOLATE_CHIP_ICE_CREAM, List.of(EN_US.Cream(EN_US.Ice(EN_US.Chip(Words.Chocolate)))));
		//Candy
		Register("cinnamon_bean", CINNAMON_BEAN, List.of(EN_US.Bean(Words.Cinnamon)));
		...
		Register("candy_cane", CANDY_CANE, List.of(EN_US.Cane(Words.Candy)));
		Register("candy_corn", CANDY_CORN, List.of(EN_US.Corn(Words.Candy)));
		Register("caramel", CARAMEL, List.of(Words.Caramel));
		Register("caramel_apple", CARAMEL_APPLE, List.of(EN_US.Apple(Words.Caramel)));
		Register("lollipop", LOLLIPOP, List.of(Words.Lollipop));
		Register("milk_chocolate", MILK_CHOCOLATE, List.of(EN_US.Chocolate(Words.Milk)));
		Register("dark_chocolate", DARK_CHOCOLATE, List.of(EN_US.Chocolate(Words.Dark)));
		Register("white_chocolate", WHITE_CHOCOLATE, List.of(EN_US.Chocolate(Words.White)));
		Register("marshmallow", MARSHMALLOW, List.of(Words.Marshmallow));
		Register("roast_marshmallow", ROAST_MARSHMALLOW, List.of(EN_US.Marshmallow(Words.Roast)));
		Register("marshmallow_on_stick", MARSHMALLOW_ON_STICK, List.of(EN_US.Stick(EN_US.a(EN_US.on(Words.Marshmallow)))));
		Register("roast_marshmallow_on_stick", ROAST_MARSHMALLOW_ON_STICK, List.of(EN_US.Stick(EN_US.a(EN_US.on(EN_US.Marshmallow(Words.Roast))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color.getName() + "_rock_candy", ROCK_CANDIES.get(color), List.of(EN_US.Candy(EN_US.Rock(EN_US.Color(color)))));
		}
		//</editor-fold>
		//<editor-fold desc="Grapes">
		Register("grape_leaves", GRAPE_LEAVES, List.of(EN_US.Leaves(Words.Grape)));
		Register("grape_sapling", GRAPE_SAPLING, List.of(EN_US._Potted(EN_US.Sapling(Words.Grape))));
		Register("grape_vines", GRAPE_VINES, List.of(EN_US.Vines(Words.Grape)));
		...
		Register("grape_vines_plant", GRAPE_VINES_PLANT, List.of(EN_US.Plant(EN_US.Vines(Words.Grape))));
		...
		Register("grapes", GRAPES, List.of(Words.Grapes));
		...
		Register("poisonous_carrot", POISONOUS_CARROT, List.of(EN_US.Carrot(Words.Poisonous)));
		Register("poisonous_beetroot", POISONOUS_BEETROOT, List.of(EN_US.Beetroot(Words.Poisonous)));
		Register("poisonous_glow_berries", POISONOUS_GLOW_BERRIES, List.of(EN_US.Berries(EN_US.Glow(Words.Poisonous))));
		Register("poisonous_sweet_berries", POISONOUS_SWEET_BERRIES, List.of(EN_US.Berries(EN_US.Sweet(Words.Poisonous))));
		Register("poisonous_tomato", POISONOUS_TOMATO, List.of(EN_US.Tomato(Words.Poisonous)));
		Register("wilted_cabbage", WILTED_CABBAGE, List.of(EN_US.Cabbage(Words.Wilted)));
		Register("wilted_onion", WILTED_ONION, List.of(EN_US.Onion(Words.Wilted)));
		Register("wilted_kelp", WILTED_KELP, List.of(EN_US.Kelp(Words.Wilted)));
		Register("moldy_bread", MOLDY_BREAD, List.of(EN_US.Bread(Words.Moldy)));
		Register("moldy_cookie", MOLDY_COOKIE, List.of(EN_US.Cookie(Words.Moldy)));
		Register("rotten_pumpkin_pie", ROTTEN_PUMPKIN_PIE, List.of(EN_US.Pie(EN_US.Pumpkin(Words.Rotten))));
		Register("spoiled_egg", SPOILED_EGG, List.of(EN_US.Egg(Words.Spoiled)));
		Register("rotten_beef", ROTTEN_BEEF, List.of(EN_US.Beef(Words.Rotten)));
		Register("rotten_chevon", ROTTEN_CHEVON, List.of(EN_US.Chevon(Words.Rotten)));
		Register("rotten_chicken", ROTTEN_CHICKEN, List.of(EN_US.Chicken(Words.Rotten)));
		Register("rotten_cod", ROTTEN_COD, List.of(EN_US.Cod(Words.Rotten)));
		Register("rotten_mutton", ROTTEN_MUTTON, List.of(EN_US.Mutton(Words.Rotten)));
		Register("rotten_porkchop", ROTTEN_PORKCHOP, List.of(EN_US.Porkchop(Words.Rotten)));
		Register("rotten_rabbit", ROTTEN_RABBIT, List.of(EN_US.Rabbit(Words.Rotten)));
		Register("rotten_salmon", ROTTEN_SALMON, List.of(EN_US.Salmon(Words.Rotten)));
		//</editor-fold>
		//<editor-fold desc="Juices">
		Register("apple_cider", APPLE_CIDER, List.of(EN_US.Cider(Words.Apple)));
		Register("golden_apple_cider", GOLDEN_APPLE_CIDER, List.of(EN_US.Cider(EN_US.Apple(Words.Golden))));
		Register("juicer", JUICER, List.of(Words.Juicer));
		RegisterJuice("apple_juice", APPLE_JUICE, Items.APPLE, List.of(EN_US.Juice(Words.Apple)));
		JuicerBlock.JUICE_MAP.put(() -> GREEN_APPLE, APPLE_JUICE);
		RegisterJuice("beetroot_juice", BEETROOT_JUICE, Items.BEETROOT, List.of(EN_US.Juice(Words.Beetroot)));
		...
		RegisterJuice("cabbage_juice", CABBAGE_JUICE, ItemsRegistry.CABBAGE.get(), List.of(EN_US.Juice(Words.Cabbage)));
		RegisterJuice("cactus_juice", CACTUS_JUICE, Items.CACTUS, List.of(EN_US.Juice(Words.Cactus)));
		RegisterJuice("carrot_juice", CARROT_JUICE, Items.CARROT, List.of(EN_US.Juice(Words.Carrot)));
		RegisterJuice("cherry_juice", CHERRY_JUICE, CHERRY, List.of(EN_US.Juice(Words.Cherry)));
		RegisterJuice("chorus_juice", CHORUS_JUICE, Items.CHORUS_FRUIT, List.of(EN_US.Juice(Words.Chorus)));
		RegisterJuice("glow_berry_juice", GLOW_BERRY_JUICE, Items.GLOW_BERRIES, List.of(EN_US.Juice(EN_US.Berry(Words.Glow))));
		RegisterJuice("golden_apple_juice", GOLDEN_APPLE_JUICE, Items.GOLDEN_APPLE, List.of(EN_US.Juice(EN_US.Apple(Words.Golden))));
		RegisterJuice("enchanted_golden_apple_juice", ENCHANTED_GOLDEN_APPLE_JUICE, Items.ENCHANTED_GOLDEN_APPLE, List.of(EN_US.Juice(EN_US.Apple(EN_US.Golden(Words.Enchanted)))));
		...
		RegisterJuice("grape_juice", GRAPE_JUICE, GRAPES, List.of(EN_US.Juice(Words.Grape)));
		RegisterJuice("kelp_juice", KELP_JUICE, Items.KELP, List.of(EN_US.Juice(Words.Kelp)));
		RegisterJuice("melon_juice", MELON_JUICE, Items.MELON_SLICE, List.of(EN_US.Juice(Words.Melon)));
		RegisterJuice("onion_juice", ONION_JUICE, ItemsRegistry.ONION.get(), List.of(EN_US.Juice(Words.Onion)));
		RegisterJuice("potato_juice", POTATO_JUICE, Items.POTATO, List.of(EN_US.Juice(Words.Potato)));
		RegisterJuice("pumpkin_juice", PUMPKIN_JUICE, Items.PUMPKIN, List.of(EN_US.Juice(Words.Pumpkin)));
		JuicerBlock.JUICE_MAP.put(ModBase.WHITE_PUMPKIN::asItem, PUMPKIN_JUICE);
		RegisterJuice("strawberry_juice", STRAWBERRY_JUICE, STRAWBERRY, List.of(EN_US.Juice(Words.Strawberry)));
		RegisterJuice("sweet_berry_juice", SWEET_BERRY_JUICE, Items.SWEET_BERRIES, List.of(EN_US.Juice(EN_US.Berry(Words.Sweet))));
		RegisterJuice("tomato_juice", TOMATO_JUICE, ItemsRegistry.TOMATO.get(), List.of(EN_US.Juice(Words.Tomato)));
		//Smoothies
		Register("apple_smoothie", APPLE_SMOOTHIE, List.of(EN_US.Smoothie(Words.Apple)));
		Register("beetroot_smoothie", BEETROOT_SMOOTHIE, List.of(EN_US.Smoothie(Words.Beetroot)));
		Register("black_apple_smoothie", BLACK_APPLE_SMOOTHIE, List.of(EN_US.Smoothie(EN_US.Apple(Words.Black))));
		Register("cabbage_smoothie", CABBAGE_SMOOTHIE, List.of(EN_US.Smoothie(Words.Cabbage)));
		Register("cactus_smoothie", CACTUS_SMOOTHIE, List.of(EN_US.Smoothie(Words.Cactus)));
		Register("carrot_smoothie", CARROT_SMOOTHIE, List.of(EN_US.Smoothie(Words.Carrot)));
		Register("cherry_smoothie", CHERRY_SMOOTHIE, List.of(EN_US.Smoothie(Words.Cherry)));
		Register("chorus_smoothie", CHORUS_SMOOTHIE, List.of(EN_US.Smoothie(Words.Chorus)));
		Register("glow_berry_smoothie", GLOW_BERRY_SMOOTHIE, List.of(EN_US.Smoothie(EN_US.Berry(Words.Glow))));
		Register("golden_apple_smoothie", GOLDEN_APPLE_SMOOTHIE, List.of(EN_US.Smoothie(EN_US.Apple(Words.Golden))));
		Register("enchanted_golden_apple_smoothie", ENCHANTED_GOLDEN_APPLE_SMOOTHIE, List.of(EN_US.Smoothie(EN_US.Apple(EN_US.Golden(Words.Enchanted)))));
		...
		Register("grape_smoothie", GRAPE_SMOOTHIE, List.of(EN_US.Smoothie(Words.Grape)));
		Register("kelp_smoothie", KELP_SMOOTHIE, List.of(EN_US.Smoothie(Words.Kelp)));
		Register("melon_smoothie", MELON_SMOOTHIE, List.of(EN_US.Smoothie(Words.Melon)));
		Register("onion_smoothie", ONION_SMOOTHIE, List.of(EN_US.Smoothie(Words.Onion)));
		Register("potato_smoothie", POTATO_SMOOTHIE, List.of(EN_US.Smoothie(Words.Potato)));
		Register("pumpkin_smoothie", PUMPKIN_SMOOTHIE, List.of(EN_US.Smoothie(Words.Pumpkin)));
		Register("strawberry_smoothie", STRAWBERRY_SMOOTHIE, List.of(EN_US.Smoothie(Words.Strawberry)));
		Register("sweet_berry_smoothie", SWEET_BERRY_SMOOTHIE, List.of(EN_US.Smoothie(EN_US.Berry(Words.Sweet))));
		Register("tomato_smoothie", TOMATO_SMOOTHIE, List.of(EN_US.Smoothie(Words.Tomato)));
		//Juicer (Misc)
		JuicerBlock.JUICE_MAP.put(() -> Items.HONEY_BLOCK, Items.HONEY_BOTTLE);
		//</editor-fold>
		//<editor-fold desc="Cakes">
		Register("carrot_cake", CARROT_CAKE.CAKE, List.of(EN_US.Cake(Words.Carrot)));
		Register("carrot_candle_cake", CARROT_CAKE.CANDLE_CAKE, List.of(EN_US.Candle(EN_US.with(EN_US.Cake(Words.Carrot)))));
		Register("carrot_soul_candle_cake", CARROT_CAKE.SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("carrot_ender_candle_cake", CARROT_CAKE.ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(EN_US.Cake(Words.Carrot))))));
		Register("carrot_netherrack_candle_cake", CARROT_CAKE.NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(EN_US.Cake(Words.Carrot))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color + "_carrot_candle_cake", CARROT_CAKE.CANDLE_CAKES.get(color), List.of(EN_US.Candle(EN_US.Color(color, EN_US.with(EN_US.Cake(Words.Carrot))))));
		}
		Register("chocolate_cake", CHOCOLATE_CAKE.CAKE, List.of(EN_US.Cake(Words.Chocolate)));
		Register("chocolate_candle_cake", CHOCOLATE_CAKE.CANDLE_CAKE, List.of(EN_US.Candle(EN_US.with(EN_US.Cake(Words.Chocolate)))));
		Register("chocolate_soul_candle_cake", CHOCOLATE_CAKE.SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("chocolate_ender_candle_cake", CHOCOLATE_CAKE.ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		Register("chocolate_netherrack_candle_cake", CHOCOLATE_CAKE.NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(EN_US.Cake(Words.Chocolate))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color + "_chocolate_candle_cake", CHOCOLATE_CAKE.CANDLE_CAKES.get(color), List.of(EN_US.Candle(EN_US.Color(color, EN_US.with(EN_US.Cake(Words.Chocolate))))));
		}
		Register("chorus_cake", CHORUS_CAKE.CAKE, List.of(EN_US.Cake(Words.Chorus)));
		Register("chorus_candle_cake", CHORUS_CAKE.CANDLE_CAKE, List.of(EN_US.Candle(EN_US.with(EN_US.Cake(Words.Chorus)))));
		Register("chorus_soul_candle_cake", CHORUS_CAKE.SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(EN_US.Cake(Words.Chorus))))));
		Register("chorus_ender_candle_cake", CHORUS_CAKE.ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(EN_US.Cake(Words.Chorus))))));
		Register("chorus_netherrack_candle_cake", CHORUS_CAKE.NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(EN_US.Cake(Words.Chorus))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color + "_chorus_candle_cake", CHORUS_CAKE.CANDLE_CAKES.get(color), List.of(EN_US.Candle(EN_US.Color(color, EN_US.with(EN_US.Cake(Words.Chorus))))));
		}
		...
		Register("confetti_cake", CONFETTI_CAKE.CAKE, List.of(EN_US.Cake(Words.Confetti)));
		Register("confetti_candle_cake", CONFETTI_CAKE.CANDLE_CAKE, List.of(EN_US.Candle(EN_US.with(EN_US.Cake(Words.Confetti)))));
		Register("confetti_soul_candle_cake", CONFETTI_CAKE.SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("confetti_ender_candle_cake", CONFETTI_CAKE.ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(EN_US.Cake(Words.Confetti))))));
		Register("confetti_netherrack_candle_cake", CONFETTI_CAKE.NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(EN_US.Cake(Words.Confetti))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color + "_confetti_candle_cake", CONFETTI_CAKE.CANDLE_CAKES.get(color), List.of(EN_US.Candle(EN_US.Color(color, EN_US.with(EN_US.Cake(Words.Confetti))))));
		}
		Register("strawberry_cake", STRAWBERRY_CAKE.CAKE, List.of(EN_US.Cake(Words.Strawberry)));
		Register("strawberry_candle_cake", STRAWBERRY_CAKE.CANDLE_CAKE, List.of(EN_US.Candle(EN_US.with(EN_US.Cake(Words.Strawberry)))));
		Register("strawberry_soul_candle_cake", STRAWBERRY_CAKE.SOUL_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Soul(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		Register("strawberry_ender_candle_cake", STRAWBERRY_CAKE.ENDER_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Ender(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		Register("strawberry_netherrack_candle_cake", STRAWBERRY_CAKE.NETHERRACK_CANDLE_CAKE, List.of(EN_US.Candle(EN_US.Netherrack(EN_US.with(EN_US.Cake(Words.Strawberry))))));
		for (DyeColor color : DyeColor.values()) {
			Register(color + "_strawberry_candle_cake", STRAWBERRY_CAKE.CANDLE_CAKES.get(color), List.of(EN_US.Candle(EN_US.Color(color, EN_US.with(EN_US.Cake(Words.Strawberry))))));
		}
		...
		Register("milk_bowl", MILK_BOWL, List.of(EN_US.Bowl(Words.Milk)));
		Register("chocolate_milk_bowl", CHOCOLATE_MILK_BOWL, List.of(EN_US.Bowl(EN_US.Milk(Words.Chocolate))));
		Register("coffee_milk_bowl", COFFEE_MILK_BOWL, List.of(EN_US.Bowl(EN_US.Milk(Words.Coffee))));
		Register("strawberry_milk_bowl", STRAWBERRY_MILK_BOWL, List.of(EN_US.Bowl(EN_US.Milk(Words.Strawberry))));
		Register("vanilla_milk_bowl", VANILLA_MILK_BOWL, List.of(EN_US.Bowl(EN_US.Milk(Words.Vanilla))));
		Register("chocolate_milk_bottle", CHOCOLATE_MILK_BOTTLE, List.of(EN_US.Bottle(EN_US.Milk(Words.Chocolate))));
		Register("coffee_milk_bottle", COFFEE_MILK_BOTTLE, List.of(EN_US.Bottle(EN_US.Milk(Words.Coffee))));
		Register("strawberry_milk_bottle", STRAWBERRY_MILK_BOTTLE, List.of(EN_US.Bottle(EN_US.Milk(Words.Strawberry))));
		Register("vanilla_milk_bottle", VANILLA_MILK_BOTTLE, List.of(EN_US.Bottle(EN_US.Milk(Words.Vanilla))));
		Register("milk_cauldron", MILK_CAULDRON, List.of(EN_US.Cauldron(Words.Milk)));
		Register("cottage_cheese_cauldron", COTTAGE_CHEESE_CAULDRON, List.of(EN_US.Cauldron(EN_US.Cheese(Words.Cottage))));
		Register("cheese_cauldron", CHEESE_CAULDRON, List.of(EN_US.Cauldron(Words.Cheese)));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(Items.MILK_BUCKET, MilkCauldronBlock.FillFromBucket(Items.BUCKET));
		Register("chocolate_milk_bucket", CHOCOLATE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Chocolate))));
		Register("coffee_milk_bucket", COFFEE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Coffee))));
		Register("strawberry_milk_bucket", STRAWBERRY_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Strawberry))));
		Register("vanilla_milk_bucket", VANILLA_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(Words.Vanilla))));
		Register("cheese_block", CHEESE_BLOCK, List.of(EN_US.Block(Words.Cheese)));
		//</editor-fold>
	}
	...
	private static void RegisterDarkIron() {
		Register("dark_iron_nugget", DARK_IRON_NUGGET, List.of(EN_US.Nugget(EN_US.Iron(Words.Dark))));
		Register("dark_iron_ingot", DARK_IRON_INGOT, List.of(EN_US.Ingot(EN_US.Iron(Words.Dark))));
		Register("dark_iron_rod", DARK_IRON_ROD, List.of(EN_US.Rod(EN_US.Iron(Words.Dark))));
		Register("dark_iron_torch", "dark_iron_wall_torch", DARK_IRON_TORCH, List.of(EN_US._Torch(EN_US.Iron(Words.Dark))));
		Register("dark_iron_soul_torch", "dark_iron_soul_wall_torch", DARK_IRON_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(EN_US.Iron(Words.Dark)))));
		Register("dark_iron_ender_torch", "dark_iron_ender_wall_torch", DARK_IRON_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(EN_US.Iron(Words.Dark)))));
		Register("underwater_dark_iron_torch", "underwater_dark_iron_wall_torch", UNDERWATER_DARK_IRON_TORCH, List.of(EN_US._Torch(EN_US.Iron(EN_US.Dark(Words.Underwater)))));
		Register("dark_iron_button", DARK_IRON_BUTTON, List.of(EN_US.Button(EN_US.Iron(Words.Dark))));
		Register("heavy_chain", HEAVY_CHAIN, List.of(EN_US.Chain(Words.Heavy)));
		Register("dark_iron_bars", DARK_IRON_BARS, List.of(EN_US.Bars(EN_US.Iron(Words.Dark))));
		Register("dark_iron_block", DARK_IRON_BLOCK, List.of(EN_US.Block(EN_US.Iron(Words.Dark))));
		Register("dark_iron_stairs", DARK_IRON_STAIRS, List.of(EN_US.Stairs(EN_US.Iron(Words.Dark))));
		Register("dark_iron_slab", DARK_IRON_SLAB, List.of(EN_US.Slab(EN_US.Iron(Words.Dark))));
		Register("dark_iron_wall", DARK_IRON_WALL, List.of(EN_US.Wall(EN_US.Iron(Words.Dark))));
		Register("dark_iron_door", DARK_IRON_DOOR, List.of(EN_US.Door(EN_US.Iron(Words.Dark))));
		Register("dark_iron_trapdoor", DARK_IRON_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Iron(Words.Dark))));
		Register("dark_iron_bricks", DARK_IRON_BRICKS, List.of(EN_US.Bricks(EN_US.Iron(Words.Dark))));
		Register("dark_iron_brick_stairs", DARK_IRON_BRICK_STAIRS, List.of(EN_US.Stairs(EN_US.Brick(EN_US.Iron(Words.Dark)))));
		Register("dark_iron_brick_slab", DARK_IRON_BRICK_SLAB, List.of(EN_US.Slab(EN_US.Brick(EN_US.Iron(Words.Dark)))));
		Register("dark_iron_brick_wall", DARK_IRON_BRICK_WALL, List.of(EN_US.Wall(EN_US.Brick(EN_US.Iron(Words.Dark)))));
		Register("cut_dark_iron", CUT_DARK_IRON, List.of(EN_US.Iron(EN_US.Dark(Words.Cut))));
		Register("cut_dark_iron_pillar", CUT_DARK_IRON_PILLAR, List.of(EN_US.Pillar(EN_US.Iron(EN_US.Dark(Words.Cut)))));
		Register("cut_dark_iron_stairs", CUT_DARK_IRON_STAIRS, List.of(EN_US.Stairs(EN_US.Iron(EN_US.Dark(Words.Cut)))));
		Register("cut_dark_iron_slab", CUT_DARK_IRON_SLAB, List.of(EN_US.Slab(EN_US.Iron(EN_US.Dark(Words.Cut)))));
		Register("cut_dark_iron_wall", CUT_DARK_IRON_WALL, List.of(EN_US.Wall(EN_US.Iron(EN_US.Dark(Words.Cut)))));
		Register("dark_heavy_weighted_pressure_plate", DARK_HEAVY_WEIGHTED_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(EN_US.Weighted(EN_US.Heavy(Words.Dark))))));
		//Misc
		Register("dark_iron_hammer", DARK_IRON_HAMMER, List.of(EN_US.Hammer(EN_US.Iron(Words.Dark))));
		Register("dark_iron_shears", DARK_IRON_SHEARS, List.of(EN_US.Shears(EN_US.Iron(Words.Dark))));
		//Bucket
		Register("dark_iron_bucket", DARK_IRON_BUCKET, List.of(EN_US.Bucket(EN_US.Iron(Words.Dark))));
		DispenserBlock.registerBehavior(DARK_IRON_BUCKET, new BucketDispenserBehavior(DARK_IRON_BUCKET_PROVIDER));
		Register("dark_iron_water_bucket", DARK_IRON_WATER_BUCKET, List.of(EN_US.Bucket(EN_US.Water(EN_US.Iron(Words.Dark)))));
		...
		CauldronBehavior.WATER_CAULDRON_BEHAVIOR.put(DARK_IRON_BUCKET, (state, world, pos, player, hand, stack) -> CauldronBehavior.emptyCauldron(state, world, pos, player, hand, stack, new ItemStack(DARK_IRON_WATER_BUCKET),
				(statex) -> statex.get(LeveledCauldronBlock.LEVEL) == 3, SoundEvents.ITEM_BUCKET_FILL));
		Register("dark_iron_lava_bucket", DARK_IRON_LAVA_BUCKET, List.of(EN_US.Bucket(EN_US.Lava(EN_US.Iron(Words.Dark)))));
		Register("dark_iron_powder_snow_bucket", DARK_IRON_POWDER_SNOW_BUCKET, List.of(EN_US.Bucket(EN_US.Snow(EN_US.Powder(EN_US.Iron(Words.Dark))))));
		...
		CauldronBehavior.POWDER_SNOW_CAULDRON_BEHAVIOR.put(DARK_IRON_BUCKET, (state, world, pos, player, hand, stack) -> CauldronBehavior.emptyCauldron(state, world, pos, player, hand, stack, new ItemStack(DARK_IRON_POWDER_SNOW_BUCKET),
				(statex) -> statex.get(LeveledCauldronBlock.LEVEL) == 3, SoundEvents.ITEM_BUCKET_FILL_POWDER_SNOW));
		Register("dark_iron_blood_bucket", DARK_IRON_BLOOD_BUCKET, List.of(EN_US.Bucket(EN_US.Blood(EN_US.Iron(Words.Dark)))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(DARK_IRON_BLOOD_BUCKET, BloodCauldronBlock.FillFromBucket(DARK_IRON_BUCKET));
		Register("dark_iron_mud_bucket", DARK_IRON_MUD_BUCKET, List.of(EN_US.Bucket(EN_US.Mud(EN_US.Iron(Words.Dark)))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(DARK_IRON_MUD_BUCKET, MudCauldronBlock.FillFromBucket(DARK_IRON_BUCKET));
		Register("dark_iron_milk_bucket", DARK_IRON_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Iron(Words.Dark)))));
		CauldronBehavior.EMPTY_CAULDRON_BEHAVIOR.put(DARK_IRON_MILK_BUCKET, MilkCauldronBlock.FillFromBucket(DARK_IRON_BUCKET));
		Register("dark_iron_chocolate_milk_bucket", DARK_IRON_CHOCOLATE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Chocolate(EN_US.Iron(Words.Dark))))));
		Register("dark_iron_coffee_milk_bucket", DARK_IRON_COFFEE_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Coffee(EN_US.Iron(Words.Dark))))));
		Register("dark_iron_strawberry_milk_bucket", DARK_IRON_STRAWBERRY_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Strawberry(EN_US.Iron(Words.Dark))))));
		Register("dark_iron_vanilla_milk_bucket", DARK_IRON_VANILLA_MILK_BUCKET, List.of(EN_US.Bucket(EN_US.Milk(EN_US.Vanilla(EN_US.Iron(Words.Dark))))));
	}
	private static void RegisterMushroomWood() {
		...
		Register("blue_mushroom_iron_hanging_sign", "blue_mushroom_iron_wall_hanging_sign", BLUE_MUSHROOM_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("blue_mushroom_gold_hanging_sign", "blue_mushroom_gold_wall_hanging_sign", BLUE_MUSHROOM_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("blue_mushroom_copper_hanging_sign", "blue_mushroom_copper_wall_hanging_sign", BLUE_MUSHROOM_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("blue_mushroom_exposed_copper_hanging_sign", "blue_mushroom_exposed_copper_wall_hanging_sign", BLUE_MUSHROOM_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("blue_mushroom_weathered_copper_hanging_sign", "blue_mushroom_weathered_copper_wall_hanging_sign", BLUE_MUSHROOM_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("blue_mushroom_oxidized_copper_hanging_sign", "blue_mushroom_oxidized_copper_wall_hanging_sign", BLUE_MUSHROOM_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("blue_mushroom_netherite_hanging_sign", "blue_mushroom_netherite_wall_hanging_sign", BLUE_MUSHROOM_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Blue), EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_blue_mushroom_torch", "underwater_blue_mushroom_wall_torch", UNDERWATER_BLUE_MUSHROOM_TORCH, List.of(EN_US._Torch(EN_US.Mushroom(EN_US.Blue(Words.Underwater)))));
		//Campfires
		...
		Register("brown_mushroom_iron_hanging_sign", "brown_mushroom_iron_wall_hanging_sign", BROWN_MUSHROOM_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("brown_mushroom_gold_hanging_sign", "brown_mushroom_gold_wall_hanging_sign", BROWN_MUSHROOM_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("brown_mushroom_copper_hanging_sign", "brown_mushroom_copper_wall_hanging_sign", BROWN_MUSHROOM_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("brown_mushroom_exposed_copper_hanging_sign", "brown_mushroom_exposed_copper_wall_hanging_sign", BROWN_MUSHROOM_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("brown_mushroom_weathered_copper_hanging_sign", "brown_mushroom_weathered_copper_wall_hanging_sign", BROWN_MUSHROOM_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("brown_mushroom_oxidized_copper_hanging_sign", "brown_mushroom_oxidized_copper_wall_hanging_sign", BROWN_MUSHROOM_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("brown_mushroom_netherite_hanging_sign", "brown_mushroom_netherite_wall_hanging_sign", BROWN_MUSHROOM_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Brown), EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_brown_mushroom_torch", "underwater_brown_mushroom_wall_torch", UNDERWATER_BROWN_MUSHROOM_TORCH, List.of(EN_US._Torch(EN_US.Mushroom(EN_US.Brown(Words.Underwater)))));
		//Campfires
		...
		Register("red_mushroom_iron_hanging_sign", "red_mushroom_iron_wall_hanging_sign", RED_MUSHROOM_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("red_mushroom_gold_hanging_sign", "red_mushroom_gold_wall_hanging_sign", RED_MUSHROOM_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("red_mushroom_copper_hanging_sign", "red_mushroom_copper_wall_hanging_sign", RED_MUSHROOM_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("red_mushroom_exposed_copper_hanging_sign", "red_mushroom_exposed_copper_wall_hanging_sign", RED_MUSHROOM_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("red_mushroom_weathered_copper_hanging_sign", "red_mushroom_weathered_copper_wall_hanging_sign", RED_MUSHROOM_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("red_mushroom_oxidized_copper_hanging_sign", "red_mushroom_oxidized_copper_wall_hanging_sign", RED_MUSHROOM_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("red_mushroom_netherite_hanging_sign", "red_mushroom_netherite_wall_hanging_sign", RED_MUSHROOM_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Mushroom(Words.Red), EN_US.Chain(EN_US.Netherite(Words.with)))));
		...
		Register("underwater_red_mushroom_torch", "underwater_red_mushroom_wall_torch", UNDERWATER_RED_MUSHROOM_TORCH, List.of(EN_US._Torch(EN_US.Mushroom(EN_US.Red(Words.Underwater)))));
		//Campfires
		...
		Register("mushroom_stem_planks", MUSHROOM_STEM_PLANKS, List.of(EN_US.Planks(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_stairs", MUSHROOM_STEM_STAIRS, List.of(EN_US.Stairs(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_slab", MUSHROOM_STEM_SLAB, List.of(EN_US.Slab(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_fence", MUSHROOM_STEM_FENCE, List.of(EN_US.Fence(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_fence_gate", MUSHROOM_STEM_FENCE_GATE, List.of(EN_US.Gate(EN_US.Fence(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_door", MUSHROOM_STEM_DOOR, List.of(EN_US.Door(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_trapdoor", MUSHROOM_STEM_TRAPDOOR, List.of(EN_US.Trapdoor(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_pressure_plate", MUSHROOM_STEM_PRESSURE_PLATE, List.of(EN_US.Plate(EN_US.Pressure(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_button", MUSHROOM_STEM_BUTTON, List.of(EN_US.Button(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem", MUSHROOM_STEM_SIGN, List.of(EN_US._Sign(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_iron_hanging_sign", "mushroom_stem_iron_wall_hanging_sign", MUSHROOM_STEM_IRON_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Iron(Words.with)))));
		Register("mushroom_stem_gold_hanging_sign", "mushroom_stem_gold_wall_hanging_sign", MUSHROOM_STEM_GOLD_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Gold(Words.with)))));
		Register("mushroom_stem_copper_hanging_sign", "mushroom_stem_copper_wall_hanging_sign", MUSHROOM_STEM_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Copper(Words.with)))));
		Register("mushroom_stem_exposed_copper_hanging_sign", "mushroom_stem_exposed_copper_wall_hanging_sign", MUSHROOM_STEM_EXPOSED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Copper(EN_US.Exposed(Words.with))))));
		Register("mushroom_stem_weathered_copper_hanging_sign", "mushroom_stem_weathered_copper_wall_hanging_sign", MUSHROOM_STEM_WEATHERED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Copper(EN_US.Weathered(Words.with))))));
		Register("mushroom_stem_oxidized_copper_hanging_sign", "mushroom_stem_oxidized_copper_wall_hanging_sign", MUSHROOM_STEM_OXIDIZED_COPPER_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Copper(EN_US.Oxidized(Words.with))))));
		Register("mushroom_stem_netherite_hanging_sign", "mushroom_stem_netherite_wall_hanging_sign", MUSHROOM_STEM_NETHERITE_HANGING_SIGN, List.of(EN_US._HangingSign(EN_US.Stem(Words.Mushroom), EN_US.Chain(EN_US.Netherite(Words.with)))));
		Register("mushroom_stem", MUSHROOM_STEM_BOAT, List.of(EN_US._Boat(EN_US.Stem(Words.Mushroom))));
		//Extended
		Register("mushroom_stem_beehive", MUSHROOM_STEM_BEEHIVE, List.of(EN_US.Beehive(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_bookshelf", MUSHROOM_STEM_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_chiseled_bookshelf", MUSHROOM_STEM_CHISELED_BOOKSHELF, List.of(EN_US.Bookshelf(EN_US.Chiseled(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_crafting_table", MUSHROOM_STEM_CRAFTING_TABLE, List.of(EN_US.Table(EN_US.Crafting(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_ladder", MUSHROOM_STEM_LADDER, List.of(EN_US.Ladder(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_woodcutter", MUSHROOM_STEM_WOODCUTTER, List.of(EN_US.Woodcutter(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_barrel", MUSHROOM_STEM_BARREL, List.of(EN_US.Barrel(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_lectern", MUSHROOM_STEM_LECTERN, List.of(EN_US.Lectern(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_powder_keg", MUSHROOM_STEM_POWDER_KEG, List.of(EN_US.Keg(EN_US.Powder(EN_US.Stem(Words.Mushroom)))));
		//Torches
		Register("mushroom_stem_torch", "mushroom_stem_wall_torch", MUSHROOM_STEM_TORCH, List.of(EN_US._Torch(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_soul_torch", "mushroom_stem_soul_wall_torch", MUSHROOM_STEM_SOUL_TORCH, List.of(EN_US._Torch(EN_US.Soul(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_ender_torch", "mushroom_stem_ender_wall_torch", MUSHROOM_STEM_ENDER_TORCH, List.of(EN_US._Torch(EN_US.Ender(EN_US.Stem(Words.Mushroom)))));
		Register("underwater_mushroom_stem_torch", "underwater_mushroom_stem_wall_torch", UNDERWATER_MUSHROOM_STEM_TORCH, List.of(EN_US._Torch(EN_US.Stem(EN_US.Mushroom(Words.Underwater)))));
		//Campfires
		Register("mushroom_stem_campfire", MUSHROOM_STEM_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Stem(Words.Mushroom))));
		Register("mushroom_stem_soul_campfire", MUSHROOM_STEM_SOUL_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Soul(EN_US.Stem(Words.Mushroom)))));
		Register("mushroom_stem_ender_campfire", MUSHROOM_STEM_ENDER_CAMPFIRE, List.of(EN_US.Campfire(EN_US.Ender(EN_US.Stem(Words.Mushroom)))));
		//</editor-fold>
	}
	private static void RegisterPlushies() {
		//<editor-fold desc="Allays & Vexes">
		Register("allay_plushie", ALLAY_PLUSHIE, List.of(EN_US.Plushie(Words.Allay)));
		Register("vex_plushie", VEX_PLUSHIE, List.of(EN_US.Plushie(Words.Vex)));
		//</editor-fold>
		//<editor-fold desc="Axolotls">
		Register("blue_axolotl_plushie", BLUE_AXOLOTL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Axolotl(Words.Blue))));
		Register("cyan_axolotl_plushie", CYAN_AXOLOTL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Axolotl(Words.Cyan))));
		Register("gold_axolotl_plushie", GOLD_AXOLOTL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Axolotl(Words.Gold))));
		Register("lucy_axolotl_plushie", LUCY_AXOLOTL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Axolotl(Words.Lucy))));
		Register("wild_axolotl_plushie", WILD_AXOLOTL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Axolotl(Words.Wild))));
		//</editor-fold>
		Register("bat_plushie", BAT_PLUSHIE, List.of(EN_US.Plushie(Words.Bat)));
		Register("bee_plushie", BEE_PLUSHIE, List.of(EN_US.Plushie(Words.Bee)));
		//<editor-fold desc="Camel">
		Register("camel_plushie", CAMEL_PLUSHIE, List.of(EN_US.Plushie(Words.Camel)));
		Register("saddled_camel_plushie", SADDLED_CAMEL_PLUSHIE, List.of(EN_US.Plushie(EN_US.Camel(Words.Saddled))));
		//</editor-fold>
		//<editor-fold desc="Cat">
		Register("ocelot_plushie", OCELOT_PLUSHIE, List.of(EN_US.Plushie(Words.Ocelot)));
		...
		Register("calico_cat_plushie", CALICO_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Calico))));
		Register("jellie_cat_plushie", JELLIE_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Jellie))));
		Register("persian_cat_plushie", PERSIAN_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Persian))));
		Register("ragdoll_cat_plushie", RAGDOLL_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Ragdoll))));
		Register("red_cat_plushie", RED_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Red))));
		Register("siamese_cat_plushie", SIAMESE_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Siamese))));
		Register("tabby_cat_plushie", TABBY_CAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cat(Words.Tabby))));
		...
		Register("midnight_chicken_plushie", MIDNIGHT_CHICKEN_PLUSHIE, List.of(EN_US.Plushie(EN_US.Chicken(Words.Midnight))));
		Register("skewbald_chicken_plushie", SKEWBALD_CHICKEN_PLUSHIE, List.of(EN_US.Plushie(EN_US.Chicken(Words.Skewbald))));
		Register("stormy_chicken_plushie", STORMY_CHICKEN_PLUSHIE, List.of(EN_US.Plushie(EN_US.Chicken(Words.Stormy))));
		//</editor-fold>
		//<editor-fold desc="Cows">
		...
		Register("wooly_cow_plushie", WOOLY_COW_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cow(Words.Wooly))));
		...
		Register("mooshroom_plushie", MOOSHROOM_PLUSHIE, List.of(EN_US.Plushie(Words.Mooshroom)));
		...
		Register("crimson_mooshroom_plushie", CRIMSON_MOOSHROOM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Mooshroom(Words.Crimson))));
		Register("gilded_mooshroom_plushie", WARPED_MOOSHROOM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Mooshroom(Words.Warped))));
		Register("warped_mooshroom_plushie", GILDED_MOOSHROOM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Mooshroom(Words.Gilded))));
		Register("moobloom_plushie", MOOBLOOM_PLUSHIE, List.of(EN_US.Plushie(Words.Moobloom)));
		Register("moolip_plushie", MOOLIP_PLUSHIE, List.of(EN_US.Plushie(Words.Moolip)));
		...
		//</editor-fold>
		Register("creeper_plushie", CREEPER_PLUSHIE, List.of(EN_US.Plushie(Words.Creeper)));
		Register("dolphin_plushie", DOLPHIN_PLUSHIE, List.of(EN_US.Plushie(Words.Dolphin)));
		Register("ender_dragon_plushie", ENDER_DRAGON_PLUSHIE, List.of(EN_US.Plushie(EN_US.Dragon(Words.Ender))));
		//<editor-fold desc="Enderman">
		Register("enderman_plushie", ENDERMAN_PLUSHIE, List.of(EN_US.Plushie(Words.Enderman)));
		Register("white_enderman_plushie", WHITE_ENDERMAN_PLUSHIE, List.of(EN_US.Plushie(EN_US.Enderman(Words.White))));
		//</editor-fold>
		//<editor-fold desc="Fox">
		Register("fox_plushie", FOX_PLUSHIE, List.of(EN_US.Plushie(Words.Fox)));
		Register("snow_fox_plushie", SNOW_FOX_PLUSHIE, List.of(EN_US.Plushie(EN_US.Fox(Words.Snow))));
		//</editor-fold>
		//<editor-fold desc="Frog">
		Register("cold_frog_plushie", COLD_FROG_PLUSHIE, List.of(EN_US.Plushie(EN_US.Frog(Words.Cold))));
		Register("temperate_frog_plushie", TEMPERATE_FROG_PLUSHIE, List.of(EN_US.Plushie(EN_US.Frog(Words.Temperate))));
		Register("warm_frog_plushie", WARM_FROG_PLUSHIE, List.of(EN_US.Plushie(EN_US.Frog(Words.Warm))));
		//</editor-fold>
		//<editor-fold desc="Goat">
		Register("goat_plushie", GOAT_PLUSHIE, List.of(EN_US.Plushie(Words.Goat)));
		Register("dark_goat_plushie", DARK_GOAT_PLUSHIE, List.of(EN_US.Plushie(EN_US.Goat(Words.Dark))));
		//</editor-fold>
		//<editor-fold desc="Llama">
		...
		Register("moss_carpeted_brown_llama_plushie", MOSS_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_brown_llama_plushie", GLOW_LICHEN_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_brown_llama_plushie", BEIGE_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_brown_llama_plushie", BURGUNDY_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_brown_llama_plushie", LAVENDER_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_brown_llama_plushie", MINT_CARPETED_BROWN_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Brown(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("creamy_llama_plushie", CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(Words.Creamy))));
		Register("creamy_trader_llama_plushie", CREAMY_TRADER_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Trader(Words.Creamy)))));
		Register("creamy_jolly_llama_plushie", CREAMY_JOLLY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Jolly(Words.Creamy)))));
		...
		Register("moss_carpeted_creamy_llama_plushie", MOSS_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_creamy_llama_plushie", GLOW_LICHEN_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_creamy_llama_plushie", BEIGE_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_creamy_llama_plushie", BURGUNDY_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_creamy_llama_plushie", LAVENDER_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_creamy_llama_plushie", MINT_CARPETED_CREAMY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Creamy(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("gray_llama_plushie", GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(Words.Gray))));
		Register("gray_trader_llama_plushie", GRAY_TRADER_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Trader(Words.Gray)))));
		Register("gray_jolly_llama_plushie", GRAY_JOLLY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Jolly(Words.Gray)))));
		...
		Register("moss_carpeted_gray_llama_plushie", MOSS_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_gray_llama_plushie", GLOW_LICHEN_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_gray_llama_plushie", BEIGE_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_gray_llama_plushie", BURGUNDY_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_gray_llama_plushie", LAVENDER_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_gray_llama_plushie", MINT_CARPETED_GRAY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Gray(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("moss_carpeted_white_llama_plushie", MOSS_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_white_llama_plushie", GLOW_LICHEN_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_white_llama_plushie", BEIGE_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_white_llama_plushie", BURGUNDY_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_white_llama_plushie", LAVENDER_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_white_llama_plushie", MINT_CARPETED_WHITE_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.White(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("mocha_llama_plushie", MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(Words.Mocha))));
		Register("mocha_trader_llama_plushie", MOCHA_TRADER_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Trader(Words.Mocha)))));
		Register("mocha_jolly_llama_plushie", MOCHA_JOLLY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Jolly(Words.Mocha)))));
		...
		Register("moss_carpeted_mocha_llama_plushie", MOSS_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_mocha_llama_plushie", GLOW_LICHEN_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_mocha_llama_plushie", BEIGE_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_mocha_llama_plushie", BURGUNDY_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_mocha_llama_plushie", LAVENDER_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_mocha_llama_plushie", MINT_CARPETED_MOCHA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Mocha(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("cocoa_llama_plushie", COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(Words.Cocoa))));
		Register("cocoa_trader_llama_plushie", COCOA_TRADER_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Trader(Words.Cocoa)))));
		Register("cocoa_jolly_llama_plushie", COCOA_JOLLY_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Jolly(Words.Cocoa)))));
		...
		Register("moss_carpeted_cocoa_llama_plushie", MOSS_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(Words.Moss))))));
		Register("glow_lichen_carpeted_cocoa_llama_plushie", GLOW_LICHEN_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(EN_US.Lichen(Words.Glow)))))));
		Register("beige_carpeted_cocoa_llama_plushie", BEIGE_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(Words.Beige))))));
		Register("burgundy_carpeted_cocoa_llama_plushie", BURGUNDY_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(Words.Burgundy))))));
		Register("lavender_carpeted_cocoa_llama_plushie", LAVENDER_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(Words.Lavender))))));
		Register("mint_carpeted_cocoa_llama_plushie", MINT_CARPETED_COCOA_LLAMA_PLUSHIE, List.of(EN_US.Plushie(EN_US.Llama(EN_US.Cocoa(EN_US.Carpeted(Words.Mint))))));
		for (DyeColor color : DyeColor.values()) {
		...
		Register("flecked_sheep_plushie", FLECKED_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(Words.Flecked))));
		Register("fuzzy_sheep_plushie", FUZZY_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(Words.Fuzzy))));
		Register("inky_sheep_plushie", INKY_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(Words.Inky))));
		Register("long_nose_sheep_plushie", LONG_NOSE_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(EN_US.Nose(Words.Long)))));
		Register("patched_sheep_plushie", PATCHED_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(Words.Patched))));
		Register("rocky_sheep_plushie", ROCKY_SHEEP_PLUSHIE, List.of(EN_US.Plushie(EN_US.Sheep(Words.Rocky))));
		...
		//</editor-fold>
		//<editor-fold desc="Slime">
		Register("magma_cube_plushie", MAGMA_CUBE_PLUSHIE, List.of(EN_US.Plushie(EN_US.Cube(Words.Magma))));
		Register("slime_plushie", SLIME_PLUSHIE, List.of(EN_US.Plushie(Words.Slime)));
		Register("tropical_slime_plushie", TROPICAL_SLIME_PLUSHIE, List.of(EN_US.Plushie(EN_US.Slime(Words.Tropical))));
		Register("pink_slime_plushie", PINK_SLIME_PLUSHIE, List.of(EN_US.Plushie(EN_US.Slime(Words.Pink))));
		//</editor-fold>
		//<editor-fold desc="Snow Golems">
		Register("snow_golem_plushie", SNOW_GOLEM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Golem(Words.Snow))));
		Register("white_snow_golem_plushie", WHITE_SNOW_GOLEM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Golem(EN_US.Snow(Words.White)))));
		Register("rotten_snow_golem_plushie", ROTTEN_SNOW_GOLEM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Golem(EN_US.Snow(Words.Rotten)))));
		Register("melon_golem_plushie", MELON_GOLEM_PLUSHIE, List.of(EN_US.Plushie(EN_US.Golem(Words.Melon))));
		//</editor-fold>
		//<editor-fold desc="Snow Golems (Sheared)">
		...
		//</editor-fold>
		Register("tadpole_plushie", TADPOLE_PLUSHIE, List.of(EN_US.Plushie(Words.Tadpole)));
		//<editor-fold desc="Turtle">
		Register("turtle_plushie", TURTLE_PLUSHIE, List.of(EN_US.Plushie(Words.Turtle)));
		Register("ruby_turtle_plushie", RUBY_TURTLE_PLUSHIE, List.of(EN_US.Plushie(EN_US.Turtle(Words.Ruby))));
		//</editor-fold>
		Register("warden_plushie", WARDEN_PLUSHIE, List.of(EN_US.Plushie(Words.Warden)));
		//<editor-fold desc="Wolf">
		Register("wolf_plushie", WOLF_PLUSHIE, List.of(EN_US.Plushie(Words.Wolf)));
		Register("gray_wolf_plushie", GRAY_WOLF_PLUSHIE, List.of(EN_US.Plushie(EN_US.Wolf(Words.Gray))));
	...
	private static void RegisterInfestedBlocks() {
		Register("infested_mossy_chiseled_stone_bricks", INFESTED_MOSSY_CHISELED_STONE_BRICKS, List.of(EN_US.Bricks(EN_US.Stone(EN_US.Chiseled(EN_US.Mossy(Words.Infested))))));
		Register("infested_cobbled_deepslate", INFESTED_COBBLED_DEEPSLATE, List.of(EN_US.Deepslate(EN_US.Cobbled(Words.Infested))));
		Register("infested_mossy_cobbled_deepslate", INFESTED_MOSSY_COBBLED_DEEPSLATE, List.of(EN_US.Deepslate(EN_US.Cobbled(EN_US.Mossy(Words.Infested)))));
		Register("infested_andesite", INFESTED_ANDESITE, List.of(EN_US.Andesite(Words.Infested)));
		Register("infested_andesite_bricks", INFESTED_ANDESITE_BRICKS, List.of(EN_US.Bricks(EN_US.Andesite(Words.Infested))));
		Register("infested_chiseled_andesite_bricks", INFESTED_CHISELED_ANDESITE_BRICKS, List.of(EN_US.Bricks(EN_US.Andesite(EN_US.Chiseled(Words.Infested)))));
		Register("infested_diorite", INFESTED_DIORITE, List.of(EN_US.Diorite(Words.Infested)));
		Register("infested_diorite_bricks", INFESTED_DIORITE_BRICKS, List.of(EN_US.Bricks(EN_US.Diorite(Words.Infested))));
		Register("infested_chiseled_diorite_bricks", INFESTED_CHISELED_DIORITE_BRICKS, List.of(EN_US.Bricks(EN_US.Diorite(EN_US.Chiseled(Words.Infested)))));
		Register("infested_granite", INFESTED_GRANITE, List.of(EN_US.Granite(Words.Infested)));
		Register("infested_granite_bricks", INFESTED_GRANITE_BRICKS, List.of(EN_US.Bricks(EN_US.Granite(Words.Infested))));
		Register("infested_chiseled_granite_bricks", INFESTED_CHISELED_GRANITE_BRICKS, List.of(EN_US.Bricks(EN_US.Granite(EN_US.Chiseled(Words.Infested)))));
		Register("infested_tuff", INFESTED_TUFF, List.of(EN_US.Tuff(Words.Infested)));
	}
	private static void RegisterMobSkullsAndRagdolls() {
		...
		Register("minecraft:piglin_head", "minecraft:piglin_wall_head", PIGLIN_HEAD, List.of(EN_US._Head(Words.Piglin)));
		DispenserBlock.registerBehavior(PIGLIN_HEAD, new WearableDispenserBehavior());
		Register("zombified_piglin_head", "zombified_piglin_wall_head", ZOMBIFIED_PIGLIN_HEAD, List.of(EN_US._Head(EN_US.Piglin(Words.Zombified))));
		DispenserBlock.registerBehavior(ZOMBIFIED_PIGLIN_HEAD, new WearableDispenserBehavior());
		//</editor-fold>
		Register("ragdoll", RAGDOLL_BLOCK_ENTITY);
		Register("ragdoll", RAGDOLL, List.of(Words.Ragdoll));
	}
