...
public class ForgingSlotsManager {
	...
	public boolean hasSlotIndex(int index) { return this.inputSlots.size() >= index; }
	public ForgingSlot getInputSlot(int index) { return this.inputSlots.get(index); }
	public ForgingSlot getResultSlot() { return this.resultSlot; }
	public List<ForgingSlot> getInputSlots() { return this.inputSlots; }
	public int getInputSlotCount() { return this.inputSlots.size(); }
	...
	public static class Builder {
		private final List<ForgingSlot> inputSlots = new ArrayList<>();
		...
		public ForgingSlotsManager build() { return new ForgingSlotsManager(this.inputSlots, this.resultSlot); }
	}
}
