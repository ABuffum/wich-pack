...
public class WaterloggableWallTorchBlock extends LightableWallTorchBlock implements Waterloggable {
	public WaterloggableWallTorchBlock(Settings settings, ParticleEffect particleEffect) {
