...
public class IdentifiedSounds {
	...
	private static EntitySounds makeEntitySounds(String name, List<String> translations, boolean steps, boolean trip, boolean fall, boolean crash, boolean swim, boolean splash, boolean fastSplash, boolean death) {
		...
		for (int i = 0; i < ModBase.LANGUAGE_CACHES.length; i++) {
			...
			highSpeedSplashTranslations.add(LANGUAGE_CACHES[i].Subtitle_Entity_Splash_High_Speed(translation));
	...
	private static final EntitySounds AXOLOTL_ENTITY = makeEntitySounds("axolotl", List.of(Words.Axolotl), true, false, false, false, false, false, false, false);
	private static final EntitySounds BAT_ENTITY = makeEntitySounds("bat", List.of(Words.Bat), false, false, false, false, false, true, false, false);
	private static final EntitySounds CAT_ENTITY = makeEntitySounds("cat", List.of(Words.Cat), true, false, false, false, false, true, false, false);
	private static final EntitySounds CHICKEN_ENTITY = makeEntitySounds("chicken", List.of(Words.Chicken), false, false, false, false, false, true, false, false);
	private static final EntitySounds COD_ENTITY = makeEntitySounds("cod", List.of(Words.Cod), false, false, false, false, true, true, false, false);
	private static final EntitySounds CREEPER_ENTITY = makeEntitySounds("creeper", List.of(Words.Creeper), true, false, false, false, false, false, false, false);
	private static final EntitySounds FOX_ENTITY = makeEntitySounds("fox", List.of(Words.Fox), true, false, false, false, false, false, false, false);
	private static final EntitySounds GLOW_SQUID_ENTITY = makeEntitySounds("glow_squid", List.of(EN_US.Squid(Words.Glow)), false, false, false, false, false, true, false, false);
	private static final EntitySounds OCELOT_ENTITY = makeEntitySounds("ocelot", List.of(Words.Ocelot), true, false, false, false, false, false, false, false);
	private static final EntitySounds PIRANHA_ENTITY = makeEntitySounds("piranha", List.of(Words.Piranha), false, false, false, false, true, true, false, false);
	private static final EntitySounds PUFFERFISH_ENTITY = makeEntitySounds("pufferfish", List.of(Words.Pufferfish), false, false, false, false, true, true, false, false);
	private static final EntitySounds RABBIT_ENTITY = makeEntitySounds("rabbit", List.of(Words.Rabbit), true, false, false, false, false, false, false, false);
	private static final EntitySounds SALMON_ENTITY = makeEntitySounds("salmon", List.of(Words.Salmon), false, false, false, false, true, true, false, false);
	private static final EntitySounds SQUID_ENTITY = makeEntitySounds("squid", List.of(Words.Squid), false, false, false, false, false, true, false, false);
	private static final EntitySounds TROPICAL_FISH_ENTITY = makeEntitySounds("tropical_fish", List.of(EN_US.Fish(Words.Tropical)), false, false, false, false, true, true, false, false);
	private static final EntitySounds VILLAGER_ENTITY = makeEntitySounds("villager", List.of(Words.Villager), true, false, false, false, false, false, false, false);
	private static final EntitySounds WANDERING_TRADER_ENTITY = makeEntitySounds("wandering_trader", List.of(EN_US.Trader(Words.Wandering)), true, false, false, false, false, false, false, false);
	...
	private static List<String> Translations(BoatEntity.Type type) {
		return switch (type) {
			case OAK -> List.of(Words.Oak);
			case SPRUCE -> List.of(Words.Spruce);
			case BIRCH -> List.of(Words.Birch);
			case JUNGLE -> List.of(Words.Jungle);
			case ACACIA -> List.of(Words.Acacia);
			case DARK_OAK -> List.of(EN_US.Oak(Words.Dark));
		};
	}
	...
	public static void RegisterAll() {
		...
		boatSounds.put(MANGROVE_BOAT.getType().getName(), new BoatSounds("mangrove", List.of(Words.Mangrove)));
		boatSounds.put(BAMBOO_RAFT.getType().getName(), new BoatSounds("bamboo", List.of(Words.Bamboo)));
		boatSounds.put(CHARRED_BOAT.getType().getName(), new BoatSounds("charred", List.of(Words.Charred)));
		//Blocks
		RegisterBlockSounds();
	}
	...
	private static void Register(BlockSounds sounds, CakeContainer... cakes) {
		for (CakeContainer cake : cakes) {
			...
			Register(sounds, cake.BEIGE_CANDLE_CAKE, cake.BURGUNDY_CANDLE_CAKE, cake.LAVENDER_CANDLE_CAKE, cake.MINT_CANDLE_CAKE);
		}
	}
	private static void RegisterBlockSounds() {
		Register("andesite", List.of(Words.Andesite), Blocks.ANDESITE, Blocks.ANDESITE_STAIRS, Blocks.ANDESITE_SLAB, Blocks.ANDESITE_WALL,
		...
		Register("andesite_sandy", List.of(EN_US.Andesite(Words.Sandy)),
				/* Mod */ SANDY_POLISHED_ANDESITE.asBlock(), SANDY_POLISHED_ANDESITE_SLAB.asBlock(),
				SANDY_ANDESITE_BRICKS.asBlock(), SANDY_ANDESITE_BRICK_SLAB.asBlock(),
				SANDY_CUT_POLISHED_ANDESITE.asBlock(), SANDY_CUT_POLISHED_ANDESITE_SLAB.asBlock(),
				RED_SANDY_POLISHED_ANDESITE.asBlock(), RED_SANDY_POLISHED_ANDESITE_SLAB.asBlock(),
				RED_SANDY_ANDESITE_BRICKS.asBlock(), RED_SANDY_ANDESITE_BRICK_SLAB.asBlock(),
				RED_SANDY_CUT_POLISHED_ANDESITE.asBlock(), RED_SANDY_CUT_POLISHED_ANDESITE_SLAB.asBlock());
		Register("bamboo_barrel", List.of(EN_US.Barrel(Words.Bamboo)), /* Mod */ BAMBOO_BARREL.asBlock(), DRIED_BAMBOO_BARREL.asBlock(), BAMBOO_POWDER_KEG.asBlock(), DRIED_BAMBOO_POWDER_KEG.asBlock());
		Register("bamboo_beehive", List.of(EN_US.Beehive(Words.Bamboo)), /* Mod */ BAMBOO_BEEHIVE.asBlock(), DRIED_BAMBOO_BEEHIVE.asBlock());
		Register("bamboo_bookshelf", List.of(EN_US.Bookshelf(Words.Bamboo)), /* Mod */ BAMBOO_BOOKSHELF.asBlock(), DRIED_BAMBOO_BOOKSHELF.asBlock());
		Register("bamboo_crafting_table", List.of(EN_US.Table(EN_US.Crafting(Words.Bamboo))), /* Mod */ BAMBOO_CRAFTING_TABLE.asBlock(), DRIED_BAMBOO_CRAFTING_TABLE.asBlock());
		Register("bamboo_door", List.of(EN_US.Door(Words.Bamboo)), /* Mod */ BAMBOO_DOOR.asBlock(), DRIED_BAMBOO_DOOR.asBlock());
		Register("bamboo_fence", List.of(EN_US.Fence(Words.Bamboo)), /* Mod */ BAMBOO_FENCE.asBlock(), DRIED_BAMBOO_FENCE.asBlock());
		Register("bamboo_fence_gate", List.of(EN_US.Gate(EN_US.Fence(Words.Bamboo))), /* Mod */ BAMBOO_FENCE_GATE.asBlock(), DRIED_BAMBOO_FENCE_GATE.asBlock());
		Register("bamboo_ladder", List.of(EN_US.Ladder(Words.Bamboo)), /* Mod */ BAMBOO_LADDER.asBlock(), DRIED_BAMBOO_LADDER.asBlock());
		Register("bamboo_lectern", List.of(EN_US.Lectern(Words.Bamboo)), /* Mod */ BAMBOO_LECTERN.asBlock(), DRIED_BAMBOO_LECTERN.asBlock());
		Register("bamboo_trapdoor", List.of(EN_US.Trapdoor(Words.Bamboo)), /* Mod */ BAMBOO_TRAPDOOR.asBlock(), DRIED_BAMBOO_TRAPDOOR.asBlock());
		Register("bamboo_woodcutter", List.of(EN_US.Woodcutter(Words.Bamboo)), /* Mod */ BAMBOO_WOODCUTTER.asBlock(), DRIED_BAMBOO_WOODCUTTER.asBlock());
		Register("banner", List.of(Words.Banner), Blocks.BLACK_BANNER, Blocks.BLUE_BANNER, Blocks.BROWN_BANNER, Blocks.CYAN_BANNER,
		...
		Register("barrel", List.of(Words.Barrel), Blocks.BARREL, /* Mod */ ACACIA_BARREL.asBlock(),
		...
		Register("beacon", List.of(Words.Beacon), Blocks.BEACON);
		Register("bed", List.of(Words.Bed), Blocks.BLACK_BED, Blocks.BLUE_BED, Blocks.BROWN_BED, Blocks.CYAN_BED,
...
//				/* Mod */ RAINBOW_BED.asBlock());
		Register("bedrock", List.of(Words.Bedrock), Blocks.BEDROCK);
		Register("bee_nest", List.of(EN_US.Nest(Words.Bee)), Blocks.BEE_NEST);
		Register("beehive", List.of(Words.Beehive), Blocks.BEEHIVE, /* Mod */ ACACIA_BEEHIVE.asBlock(), BIRCH_BEEHIVE.asBlock(),
				DARK_OAK_BEEHIVE.asBlock(), JUNGLE_BEEHIVE.asBlock(), MANGROVE_BEEHIVE.asBlock(), CHARRED_BEEHIVE.asBlock());
		Register("bell", List.of(Words.Bell), Blocks.BELL);
		Register("blackstone", List.of(Words.Blackstone), Blocks.BLACKSTONE, Blocks.BLACKSTONE_STAIRS, Blocks.BLACKSTONE_SLAB, Blocks.BLACKSTONE_WALL,
...
//				/* Mod */ SMOOTH_CHISELED_POLISHED_BLACKSTONE.asBlock());
		...
		Register("brewing_stand", List.of(EN_US.Stand(Words.Brewing)), Blocks.BREWING_STAND);
		Register("bricks", List.of(Words.Bricks), Blocks.BRICKS);
		Register("cactus", List.of(Words.Cactus), Blocks.CACTUS);
		BlockSounds CAKE = new BlockSounds("cake", List.of(Words.Cake));
		...
		Register(CAKE, Blocks.CAKE, Blocks.CANDLE_CAKE,
				...
				/* Mod */ SOUL_CANDLE_CAKE, ENDER_CANDLE_CAKE, NETHERRACK_CANDLE_CAKE,
				BEIGE_CANDLE_CAKE, BURGUNDY_CANDLE_CAKE, LAVENDER_CANDLE_CAKE, MINT_CANDLE_CAKE);
		Register(CAKE, CARROT_CAKE, CHOCOLATE_CAKE, CHORUS_CAKE, COFFEE_CAKE, CONFETTI_CAKE, STRAWBERRY_CAKE, VANILLA_CAKE);
		Register("caramel", List.of(Words.Caramel), /* Mod */ CARAMEL_BLOCK.asBlock());
		Register("carpet", List.of(Words.Carpet), Blocks.BLACK_CARPET, Blocks.BLUE_CARPET, Blocks.BROWN_CARPET, Blocks.CYAN_CARPET,
				...
				BEIGE_CARPET.asBlock(), BURGUNDY_CARPET.asBlock(), LAVENDER_CARPET.asBlock(), MINT_CARPET.asBlock());
		Register("cartography_table", List.of(EN_US.Table(Words.Cartography)), Blocks.CARTOGRAPHY_TABLE);
		...
		Register("cherry_barrel", List.of(EN_US.Barrel(Words.Cherry)), /* Mod */ CHERRY_BARREL.asBlock(), CHERRY_POWDER_KEG.asBlock());
		Register("cherry_beehive", List.of(EN_US.Beehive(Words.Cherry)), /* Mod */ CHERRY_BEEHIVE.asBlock());
		Register("cherry_bookshelf", List.of(EN_US.Bookshelf(Words.Cherry)), /* Mod */ CHERRY_BOOKSHELF.asBlock());
		Register("cherry_crafting_table", List.of(EN_US.Table(EN_US.Crafting(Words.Cherry))), /* Mod */ CHERRY_CRAFTING_TABLE.asBlock());
		Register("cherry_door", List.of(EN_US.Door(Words.Cherry)), /* Mod */ CHERRY_DOOR.asBlock());
		Register("cherry_fence", List.of(EN_US.Fence(Words.Cherry)), /* Mod */ CHERRY_FENCE.asBlock());
		Register("cherry_fence_gate", List.of(EN_US.Gate(EN_US.Fence(Words.Cherry))), /* Mod */ CHERRY_FENCE_GATE.asBlock());
		Register("cherry_ladder", List.of(EN_US.Ladder(Words.Cherry)), /* Mod */ CHERRY_LADDER.asBlock());
		Register("cherry_lectern", List.of(EN_US.Lectern(Words.Cherry)), /* Mod */ CHERRY_LECTERN.asBlock());
		Register("cherry_trapdoor", List.of(EN_US.Trapdoor(Words.Cherry)), /* Mod */ CHERRY_TRAPDOOR.asBlock());
		Register("cherry_wood_sandy", List.of(EN_US.Wood(EN_US.Cherry(Words.Sandy))), /* Mod */ SANDY_CHERRY_PLANKS.asBlock(), SANDY_CHERRY_SLAB.asBlock(), RED_SANDY_CHERRY_PLANKS.asBlock(), RED_SANDY_CHERRY_SLAB.asBlock());
		Register("cherry_woodcutter", List.of(EN_US.Woodcutter(Words.Cherry)), /* Mod */ CHERRY_WOODCUTTER.asBlock());
		Register("chest", List.of(Words.Chest), Blocks.CHEST, Blocks.TRAPPED_CHEST);
		Register("chorus_plant", List.of(EN_US.Plant(Words.Chorus)), Blocks.CHORUS_PLANT, Blocks.CHORUS_FLOWER);
		Register("clay", List.of(Words.Clay), Blocks.CLAY);
		Register("coal", List.of(Words.Coal), Blocks.COAL_BLOCK, /* Mod */ COAL_STAIRS.asBlock(), COAL_SLAB.asBlock(), CHARCOAL_BLOCK.asBlock(), CHARCOAL_STAIRS.asBlock(), CHARCOAL_SLAB.asBlock());
		Register("coarse_dirt", List.of(EN_US.Dirt(Words.Coarse)), Blocks.COARSE_DIRT, /* Mod */ COARSE_DIRT_SLAB.asBlock());
		Register("cobbled_end_shale", List.of(EN_US.Shale(EN_US.End(Words.Cobbled))), /* Mod */ COBBLED_END_SHALE.asBlock(), COBBLED_END_SHALE_STAIRS.asBlock(), COBBLED_END_SHALE_SLAB.asBlock(), COBBLED_END_SHALE_WALL.asBlock());
		Register("cobbled_deepslate", List.of(EN_US.Deepslate(Words.Cobbled)), Blocks.COBBLED_DEEPSLATE, Blocks.COBBLED_DEEPSLATE_STAIRS, Blocks.COBBLED_DEEPSLATE_SLAB, Blocks.COBBLED_DEEPSLATE_WALL);
		Register("cobbled_sculk_stone", List.of(EN_US.Stone(Words.Sculk)), /* Mod */ COBBLED_SCULK_STONE.asBlock(), COBBLED_SCULK_STONE_STAIRS.asBlock(), COBBLED_SCULK_STONE_SLAB.asBlock(), COBBLED_SCULK_STONE_WALL.asBlock());
		Register("cobbled_shale", List.of(EN_US.Shale(Words.Cobbled)), /* Mod */ COBBLED_SHALE.asBlock(), COBBLED_SHALE_STAIRS.asBlock(), COBBLED_SHALE_SLAB.asBlock(), COBBLED_SHALE_WALL.asBlock());
		Register("cobblestone", List.of(Words.Cobblestone), Blocks.COBBLESTONE, Blocks.COBBLESTONE_STAIRS, Blocks.COBBLESTONE_SLAB, Blocks.COBBLESTONE_WALL,
				Blocks.MOSSY_COBBLESTONE, Blocks.MOSSY_COBBLESTONE_STAIRS, Blocks.MOSSY_COBBLESTONE_SLAB, Blocks.MOSSY_COBBLESTONE_WALL);
		Register("cobblestone_sandy", List.of(EN_US.Cobblestone(Words.Sandy)), /* Mod */ SANDY_COBBLESTONE.asBlock(), SANDY_COBBLESTONE_SLAB.asBlock(), RED_SANDY_COBBLESTONE.asBlock(), RED_SANDY_COBBLESTONE_SLAB.asBlock());
		Register("cobweb", List.of(Words.Cobweb), Blocks.COBWEB);
		Register("cocoa", List.of(Words.Cocoa), Blocks.COCOA, /* Mod */ COCOA_BLOCK.asBlock());
		Register("composter", List.of(Words.Composter), Blocks.COMPOSTER);
		BlockSounds concrete = new BlockSounds("concrete", List.of(Words.Concrete));
		...
		Register(concrete, BEIGE_CONCRETE.asBlock(), BEIGE_CONCRETE_STAIRS.asBlock(), BEIGE_CONCRETE_SLAB.asBlock(), BEIGE_CONCRETE_WALL.asBlock(),
				LAVENDER_CONCRETE.asBlock(), LAVENDER_CONCRETE_STAIRS.asBlock(), LAVENDER_CONCRETE_SLAB.asBlock(), LAVENDER_CONCRETE_WALL.asBlock(),
				BURGUNDY_CONCRETE.asBlock(), BURGUNDY_CONCRETE_STAIRS.asBlock(), BURGUNDY_CONCRETE_SLAB.asBlock(), BURGUNDY_CONCRETE_WALL.asBlock(),
				MINT_CONCRETE.asBlock(), MINT_CONCRETE_STAIRS.asBlock(), MINT_CONCRETE_SLAB.asBlock(), MINT_CONCRETE_WALL.asBlock());
		Register("concrete_powder", List.of(EN_US.Powder(EN_US.Concrete())), Blocks.BLACK_CONCRETE_POWDER, Blocks.BLUE_CONCRETE_POWDER, Blocks.BROWN_CONCRETE_POWDER, Blocks.CYAN_CONCRETE_POWDER,
				...
				/* Mod */ BEIGE_CONCRETE_POWDER.asBlock(), BURGUNDY_CONCRETE_POWDER.asBlock(), LAVENDER_CONCRETE_POWDER.asBlock(), MINT_CONCRETE_POWDER.asBlock());
		...
		Register("coral_fan", List.of(EN_US.Fan(EN_US.Coral())), Blocks.BRAIN_CORAL, Blocks.BUBBLE_CORAL, Blocks.FIRE_CORAL, Blocks.HORN_CORAL, Blocks.TUBE_CORAL,
		...
		Register("crafting_table", List.of(EN_US.Table(Words.Crafting)), Blocks.CRAFTING_TABLE, /* Mod */ ACACIA_CRAFTING_TABLE.asBlock(), BIRCH_CRAFTING_TABLE.asBlock(),
		...
		Register(BlockSounds.BreakPlace("crop", SoundEvents.BLOCK_CROP_BREAK, SoundEvents.ITEM_CROP_PLANT, List.of(Words.Crop)),
		...
		Register("stonecutter", List.of(Words.Stonecutter), Blocks.STONECUTTER);
		Register("daylight_detector", List.of(EN_US.Detector(Words.Daylight)), Blocks.DAYLIGHT_DETECTOR);
		Register("dead_coral", List.of(EN_US.Coral(Words.Dead)), Blocks.DEAD_BRAIN_CORAL, Blocks.DEAD_BUBBLE_CORAL, Blocks.DEAD_FIRE_CORAL, Blocks.DEAD_HORN_CORAL, Blocks.DEAD_TUBE_CORAL,
		...
		Register("diorite_sandy", List.of(EN_US.Diorite(Words.Sandy)),
				/* Mod */ SANDY_POLISHED_DIORITE.asBlock(), SANDY_POLISHED_DIORITE_SLAB.asBlock(),
				SANDY_DIORITE_BRICKS.asBlock(), SANDY_DIORITE_BRICK_SLAB.asBlock(),
				SANDY_CUT_POLISHED_DIORITE.asBlock(), SANDY_CUT_POLISHED_DIORITE_SLAB.asBlock(),
		...
		Register("emerald", List.of(Words.Emerald), Blocks.EMERALD_BLOCK,
		...
		Register("enchanting_table", List.of(EN_US.Table(Words.Enchanting)), Blocks.ENCHANTING_TABLE);
		Register("end_portal_frame", List.of(EN_US.Frame(EN_US.Portal(Words.End))), Blocks.END_PORTAL_FRAME, /* Mod */ PURPLE_EYE_END_PORTAL_FRAME);
		Register("end_rock", List.of(EN_US.Rock(Words.End)), /* Mod */ END_ROCK.asBlock(), END_ROCK_SHALE.asBlock());
		Register("end_rod", List.of(EN_US.Rod(Words.End)), Blocks.END_ROD);
		Register("end_shale", List.of(EN_US.Shale(Words.End)), /* Mod */ END_SHALE.asBlock(), END_SHALE_ROCK.asBlock(),
		...
		Register("end_stone", List.of(EN_US.Stone(Words.End)), Blocks.END_STONE, Blocks.END_STONE_BRICKS,
		...
		Register("end_stone_iron_ore", List.of(EN_US.Ore(EN_US.Iron(EN_US.Stone(Words.End)))), /* Mod */ END_IRON_ORE.asBlock());
		Register("end_stone_copper_ore", List.of(EN_US.Ore(EN_US.Copper(EN_US.Stone(Words.End)))), /* Mod */ END_COPPER_ORE.asBlock());
		Register("end_stone_gold_ore", List.of(EN_US.Ore(EN_US.Gold(EN_US.Stone(Words.End)))), /* Mod */ END_GOLD_ORE.asBlock());
		Register("ender_chest", List.of(EN_US.Chest(Words.Ender)), Blocks.ENDER_CHEST);
		Register("farmland", List.of(Words.Farmland), Blocks.FARMLAND);
		Register("fire", List.of(Words.Fire), Blocks.FIRE, Blocks.SOUL_FIRE);
		BlockSounds fleece = new BlockSounds("fleece", List.of(Words.Fleece));
		...
		Register(fleece, /* Mod */ BEIGE_FLEECE.asBlock(), BEIGE_FLEECE_SLAB.asBlock(),
				BURGUNDY_FLEECE.asBlock(), BURGUNDY_FLEECE_SLAB.asBlock(),
				LAVENDER_FLEECE.asBlock(), LAVENDER_FLEECE_SLAB.asBlock(),
				MINT_FLEECE.asBlock(), MINT_FLEECE_SLAB.asBlock());
		BlockSounds fleece_carpet = new BlockSounds("fleece_carpet", List.of(EN_US.Carpet(Words.Fleece)));
		...
		Register(fleece_carpet, /* Mod */ BEIGE_FLEECE_CARPET.asBlock(), BURGUNDY_FLEECE_CARPET.asBlock(), LAVENDER_FLEECE_CARPET.asBlock(), MINT_FLEECE_CARPET.asBlock());
		Register("fletching_table", List.of(EN_US.Table(Words.Fletching)), Blocks.FLETCHING_TABLE);
		Register("flint", List.of(Words.Flint), /* Mod */ FLINT_BLOCK.asBlock(), FLINT_SLAB.asBlock(),
				FLINT_BRICKS.asBlock(), FLINT_BRICK_STAIRS.asBlock(), FLINT_BRICK_SLAB.asBlock(), FLINT_BRICK_WALL.asBlock());
		Register("flower", List.of(Words.Flower), Blocks.ALLIUM, Blocks.AZURE_BLUET, Blocks.CORNFLOWER, Blocks.DANDELION,
		...
		Register("glass_pane", List.of(EN_US.Pane(EN_US.Glass())), Blocks.BLACK_STAINED_GLASS_PANE, Blocks.BLUE_STAINED_GLASS_PANE, Blocks.BROWN_STAINED_GLASS_PANE, Blocks.CYAN_STAINED_GLASS_PANE,
				...
				BEIGE_STAINED_GLASS_PANE.asBlock(), BURGUNDY_STAINED_GLASS_PANE.asBlock(), LAVENDER_STAINED_GLASS_PANE.asBlock(), MINT_STAINED_GLASS_PANE.asBlock());
		BlockSounds glazed_terracotta = new BlockSounds("glazed_terracotta", List.of(EN_US.Terracotta(EN_US.Glazed())));
		...
		Register(glazed_terracotta, BEIGE_GLAZED_TERRACOTTA.asBlock(), BEIGE_GLAZED_TERRACOTTA_SLAB.asBlock(),
...
//		Register("glow_lichen_bed", List.of(EN_US.Bed(EN_US.Lichen(EN_US.Glow()))), /* Mod */ GLOW_LICHEN_BED.asBlock());
		...
		Register("granite_sandy", List.of(EN_US.Granite(Words.Sandy)),
				/* Mod */ SANDY_POLISHED_GRANITE.asBlock(), SANDY_POLISHED_GRANITE_SLAB.asBlock(),
				SANDY_GRANITE_BRICKS.asBlock(), SANDY_GRANITE_BRICK_SLAB.asBlock(),
				SANDY_CUT_POLISHED_GRANITE.asBlock(), SANDY_CUT_POLISHED_GRANITE_SLAB.asBlock(),
				RED_SANDY_POLISHED_GRANITE.asBlock(), RED_SANDY_POLISHED_GRANITE_SLAB.asBlock(),
				RED_SANDY_GRANITE_BRICKS.asBlock(), RED_SANDY_GRANITE_BRICK_SLAB.asBlock(),
				RED_SANDY_CUT_POLISHED_GRANITE.asBlock(), RED_SANDY_CUT_POLISHED_GRANITE_SLAB.asBlock());
		Register("grindstone", List.of(Words.Grindstone), Blocks.GRINDSTONE);
		Register("gunpowder", List.of(Words.Gunpowder), /* Mod */ GUNPOWDER_BLOCK.asBlock());
		Register("gunpowder_fuse", List.of(EN_US.Fuse(Words.Gunpowder)), /* Mod */ GUNPOWDER_FUSE.asBlock());
		Register("hay", List.of(Words.Hay), Blocks.HAY_BLOCK);
		Register("head", List.of(Words.Head), Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD,
				Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, /* Mob */ PIGLIN_HEAD.asBlock(), PIGLIN_HEAD.getWallBlock());
		Register("heavy_copper_chain", List.of(EN_US.Bars(Words.Copper)), /* Mod */
		...
		Register("heavy_gold_chain", List.of(EN_US.Chain(EN_US.Gold(Words.Heavy))), /* Mod */ HEAVY_GOLD_CHAIN.asBlock());
		Register("heavy_iron_chain", List.of(EN_US.Chain(EN_US.Iron(Words.Heavy))), /* Mod */ HEAVY_IRON_CHAIN.asBlock());
		Register("heavy_netherite_chain", List.of(EN_US.Chain(EN_US.Netherite(Words.Heavy))), /* Mod */ HEAVY_NETHERITE_CHAIN.asBlock());
		Register("honeycomb", List.of(Words.Honeycomb), Blocks.HONEYCOMB_BLOCK);
		Register("hopper", List.of(Words.Hopper), Blocks.HOPPER);
		Register("ice", List.of(Words.Ice), Blocks.ICE, Blocks.BLUE_ICE, Blocks.FROSTED_ICE, Blocks.PACKED_ICE);
		Register("infested_andesite", List.of(EN_US.Andesite(Words.Infested)), /* Mod */ INFESTED_ANDESITE.asBlock(), INFESTED_ANDESITE_BRICKS.asBlock(), INFESTED_CHISELED_ANDESITE_BRICKS.asBlock());
		Register("infested_cobblestone", List.of(EN_US.Cobblestone(Words.Infested)), Blocks.INFESTED_COBBLESTONE);
		Register("infested_deepslate", List.of(EN_US.Deepslate(Words.Infested)), Blocks.INFESTED_DEEPSLATE,
				/* Mod */ INFESTED_COBBLED_DEEPSLATE.asBlock(), INFESTED_MOSSY_COBBLED_DEEPSLATE.asBlock());
		Register("infested_diorite", List.of(EN_US.Diorite(Words.Infested)), /* Mod */ INFESTED_DIORITE.asBlock(), INFESTED_DIORITE_BRICKS.asBlock(), INFESTED_CHISELED_DIORITE_BRICKS.asBlock());
		Register("infested_granite", List.of(EN_US.Granite(Words.Infested)), /* Mod */ INFESTED_GRANITE.asBlock(), INFESTED_GRANITE_BRICKS.asBlock(), INFESTED_CHISELED_GRANITE_BRICKS.asBlock());
		Register("infested_stone", List.of(EN_US.Stone(Words.Infested)), Blocks.INFESTED_CHISELED_STONE_BRICKS, Blocks.INFESTED_CRACKED_STONE_BRICKS,
		...
		Register("infested_tuff", List.of(EN_US.Tuff(Words.Infested)), /* Mod */ INFESTED_TUFF.asBlock());
		Register("iron", List.of(Words.Iron), Blocks.IRON_BLOCK, Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE,
		...
		Register("iron_bars", List.of(EN_US.Bars(Words.Iron)), Blocks.IRON_BARS);
		Register("iron_chain", List.of(EN_US.Chain(Words.Iron)), Blocks.CHAIN, /* Mod */ IRON_CHAIN.asBlock());
		Register("iron_lantern", List.of(EN_US.Lantern(Words.Iron)), Blocks.LANTERN, Blocks.SOUL_LANTERN,
				/* Mod */ ENDER_LANTERN.asBlock(), IRON_LANTERN.asBlock(), IRON_SOUL_LANTERN.asBlock(), IRON_ENDER_LANTERN.asBlock());
		Register("iron_door", List.of(EN_US.Door(Words.Iron)), Blocks.IRON_DOOR);
		Register("iron_trapdoor", List.of(EN_US.Trapdoor(Words.Iron)), Blocks.IRON_TRAPDOOR);
		Register("jukebox", List.of(Words.Jukebox), Blocks.JUKEBOX);
		Register("kelp", List.of(Words.Kelp), Blocks.KELP, Blocks.KELP_PLANT);
		Register("lapis", List.of(Words.Lapis), Blocks.LAPIS_BLOCK);
		Register("leaves", List.of(Words.Leaves), Blocks.ACACIA_LEAVES, Blocks.BIRCH_LEAVES,
				...
				WHITE_SPRUCE_LEAVES.asBlock(), SWEET_BERRY_LEAVES.asBlock(), GRAPE_LEAVES.asBlock(),
		...
		Register("lectern", List.of(Words.Lectern), Blocks.LECTERN,
		...
		Register(BlockSounds.Place("lily_pad", SoundEvents.BLOCK_LILY_PAD_PLACE, List.of(EN_US.Pad(Words.Lily))), Blocks.LILY_PAD);
		Register("loom", List.of(Words.Loom), Blocks.LOOM);
		Register("magma", List.of(Words.Magma), Blocks.MAGMA_BLOCK);
		Register("melon", List.of(Words.Melon), Blocks.MELON,
				/* Mod */ CARVED_MELON.asBlock(), MELON_LANTERN.asBlock(), SOUL_MELON_LANTERN.asBlock(), ENDER_MELON_LANTERN.asBlock());
//		Register("moss_bed", List.of(EN_US.Bed(Words.Moss)), /* Mod */ MOSS_BED.asBlock());
		Register("mushroom", List.of(Words.Mushroom), Blocks.MUSHROOM_STEM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM_BLOCK, /* Mod */ BLUE_MUSHROOM_BLOCK.asBlock());
		Register("mushroom_plant", List.of(EN_US.Plant(Words.Mushroom)), Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, /* Mod */ BLUE_MUSHROOM.asBlock(), DEATH_CAP_MUSHROOM.asBlock());
		Register("mycelium", List.of(Words.Mycelium), Blocks.MYCELIUM);
		Register("mycelium_roots", List.of(EN_US.Roots(Words.Mycelium)), /* Mod */ MYCELIUM_ROOTS.asBlock());
		Register(NETHER_BARK_BLOCK, Blocks.CRIMSON_HYPHAE, Blocks.WARPED_HYPHAE);
		Register("nether_brick_fence", List.of(EN_US.Fence(EN_US.Brick(Words.Nether))), Blocks.NETHER_BRICK_FENCE);//,
//				/* Mod */ RED_NETHER_BRICK_FENCE.asBlock(), BLUE_NETHER_BRICK_FENCE.asBlock(), YELLOW_NETHER_BRICK_FENCE.asBlock());
		Register(BlockSounds.BreakPlace("nether_wart", SoundEvents.BLOCK_NETHER_WART_BREAK, SoundEvents.ITEM_NETHER_WART_PLANT,
				List.of(EN_US.Wart(Words.Nether))), Blocks.NETHER_WART);//, /* Mod */ WARPED_WART.asBlock(), GILDED_WART.asBlock());
		...
		Register("nether_wood_beehive", List.of(EN_US.Beehive(EN_US.Wood(Words.Nether))), /* Mod */ CRIMSON_BEEHIVE.asBlock(), WARPED_BEEHIVE.asBlock(), GILDED_BEEHIVE.asBlock());
		Register("nether_wood_bookshelf", List.of(EN_US.Bookshelf(EN_US.Wood(Words.Nether))), /* Mod */ CRIMSON_BOOKSHELF.asBlock(), WARPED_BOOKSHELF.asBlock(), GILDED_BOOKSHELF.asBlock());
		Register("nether_wood_crafting_table", List.of(EN_US.Table(EN_US.Crafting(EN_US.Wood(Words.Nether)))), /* Mod */ CRIMSON_CRAFTING_TABLE.asBlock(), WARPED_CRAFTING_TABLE.asBlock(), GILDED_CRAFTING_TABLE.asBlock());
		Register("nether_wood_door", List.of(EN_US.Door(EN_US.Wood(Words.Nether))), Blocks.CRIMSON_DOOR, Blocks.WARPED_DOOR, GILDED_DOOR.asBlock());
		Register("nether_wood_fence", List.of(EN_US.Fence(EN_US.Wood(Words.Nether))), Blocks.CRIMSON_FENCE, Blocks.WARPED_FENCE, GILDED_FENCE.asBlock());
		Register("nether_wood_fence_gate", List.of(EN_US.Gate(EN_US.Fence(EN_US.Wood(Words.Nether)))), Blocks.CRIMSON_FENCE_GATE, Blocks.WARPED_FENCE_GATE, GILDED_FENCE_GATE.asBlock());
		Register("nether_wood_ladder", List.of(EN_US.Ladder(EN_US.Wood(Words.Nether))), /* Mod */ CRIMSON_LADDER.asBlock(), WARPED_LADDER.asBlock(), GILDED_LADDER.asBlock());
		Register("nether_wood_lectern", List.of(EN_US.Lectern(EN_US.Wood(Words.Nether))), /* Mod */ CRIMSON_LECTERN.asBlock(), WARPED_LECTERN.asBlock(), GILDED_LECTERN.asBlock());
		Register("nether_wood_sandy", List.of(EN_US.Wood(EN_US.Nether(Words.Sandy))),
				/* Mod */ SANDY_CRIMSON_PLANKS.asBlock(), SANDY_CRIMSON_SLAB.asBlock(), SANDY_WARPED_PLANKS.asBlock(), SANDY_WARPED_SLAB.asBlock(), SANDY_GILDED_PLANKS.asBlock(), SANDY_GILDED_SLAB.asBlock(),
				/* Mod */ RED_SANDY_CRIMSON_PLANKS.asBlock(), RED_SANDY_CRIMSON_SLAB.asBlock(), RED_SANDY_WARPED_PLANKS.asBlock(), RED_SANDY_WARPED_SLAB.asBlock(), RED_SANDY_GILDED_PLANKS.asBlock(), RED_SANDY_GILDED_SLAB.asBlock());
		Register("nether_wood_trapdoor", List.of(EN_US.Trapdoor(EN_US.Wood(Words.Nether))), Blocks.CRIMSON_TRAPDOOR, Blocks.WARPED_TRAPDOOR, GILDED_TRAPDOOR.asBlock());
		Register("netherite_bars", List.of(EN_US.Bars(Words.Netherite)), /* Mod */ NETHERITE_BARS.asBlock());
		Register("netherite_chain", List.of(EN_US.Chain(Words.Netherite)), /* Mod */ NETHERITE_CHAIN.asBlock());
		Register("netherite_lantern", List.of(EN_US.Lantern(Words.Netherite)), /* Mod */ NETHERITE_LANTERN.asBlock(), NETHERITE_SOUL_LANTERN.asBlock(), NETHERITE_ENDER_LANTERN.asBlock());
		Register("netherite_door", List.of(EN_US.Door(Words.Netherite)), /* Mod */ NETHERITE_DOOR.asBlock());
		Register("netherite_trapdoor", List.of(EN_US.Trapdoor(Words.Netherite)), /* Mod */ NETHERITE_TRAPDOOR.asBlock());
		Register("netherrack_iron_ore", List.of(EN_US.Ore(EN_US.Iron(Words.Netherrack))), /* Mod */ NETHER_IRON_ORE.asBlock());
		Register("netherrack_copper_ore", List.of(EN_US.Ore(EN_US.Copper(Words.Netherrack))), /* Mod */ NETHER_COPPER_ORE.asBlock());
		Register("netherrack_gold_ore", List.of(EN_US.Ore(EN_US.Gold(Words.Netherrack))), Blocks.NETHER_GOLD_ORE);
		Register("netherrack_quartz_ore", List.of(EN_US.Ore(EN_US.Quartz(Words.Netherrack))), Blocks.NETHER_QUARTZ_ORE);
		Register("note_block", List.of(EN_US.Block(Words.Note)), Blocks.NOTE_BLOCK);
		Register("observer", List.of(Words.Observer), Blocks.OBSERVER);
		Register("obsidian", List.of(Words.Obsidian), Blocks.OBSIDIAN, Blocks.CRYING_OBSIDIAN,
...
//				POLISHED_BLEEDING_OBSIDIAN_BRICKS.asBlock(), POLISHED_BLEEDING_OBSIDIAN_BRICK_STAIRS.asBlock(), POLISHED_BLEEDING_OBSIDIAN_BRICK_SLAB.asBlock(), POLISHED_BLEEDING_OBSIDIAN_BRICK_WALL.asBlock());
		Register("podzol", List.of(Words.Podzol), Blocks.PODZOL);
		Register("polished_shale", List.of(EN_US.Shale(Words.Polished)), /* Mod */ POLISHED_SHALE.asBlock(), POLISHED_SHALE_STAIRS.asBlock(), POLISHED_SHALE_SLAB.asBlock(), POLISHED_SHALE_WALL.asBlock());
		Register("pot", List.of(Words.Pot), Blocks.FLOWER_POT);
		Register("potted_plant", List.of(EN_US.Plant(Words.Potted)), Blocks.POTTED_ACACIA_SAPLING,
				...
				CASSIA_SAPLING.getPottedBlock(), DOGWOOD_SAPLING.getPottedBlock(), GRAPE_SAPLING.getPottedBlock());
		...
		Register("prismarine_sandy", List.of(EN_US.Prismarine(Words.Sandy)),
				/* Mod */ SANDY_PRISMARINE.asBlock(), SANDY_PRISMARINE_SLAB.asBlock(),
				SANDY_SANDY_PRISMARINE.asBlock(), SANDY_SANDY_PRISMARINE_SLAB.asBlock(),
				SANDY_PRISMARINE_BRICKS.asBlock(), SANDY_PRISMARINE_BRICK_SLAB.asBlock(),
				SANDY_CHISELED_PRISMARINE_BRICKS.asBlock(),
				SANDY_DARK_PRISMARINE.asBlock(), SANDY_DARK_PRISMARINE_SLAB.asBlock(),
				SANDY_SANDY_DARK_PRISMARINE.asBlock(), SANDY_SANDY_DARK_PRISMARINE_SLAB.asBlock(),
				RED_SANDY_PRISMARINE.asBlock(), RED_SANDY_PRISMARINE_SLAB.asBlock(),
				RED_SANDY_SANDY_PRISMARINE.asBlock(), RED_SANDY_SANDY_PRISMARINE_SLAB.asBlock(),
				RED_SANDY_PRISMARINE_BRICKS.asBlock(), RED_SANDY_PRISMARINE_BRICK_SLAB.asBlock(),
				RED_SANDY_CHISELED_PRISMARINE_BRICKS.asBlock(),
				RED_SANDY_DARK_PRISMARINE.asBlock(), RED_SANDY_DARK_PRISMARINE_SLAB.asBlock(),
				RED_SANDY_SANDY_DARK_PRISMARINE.asBlock(), RED_SANDY_SANDY_DARK_PRISMARINE_SLAB.asBlock());
		...
		Register("pumpkin", List.of(EN_US.Pumpkin()), Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.JACK_O_LANTERN,
				/* Mod */ SOUL_JACK_O_LANTERN.asBlock(), ENDER_JACK_O_LANTERN.asBlock(), BURNT_PUMPKIN.asBlock(),
				WHITE_PUMPKIN.asBlock(), CARVED_WHITE_PUMPKIN.asBlock(), WHITE_JACK_O_LANTERN.asBlock(), WHITE_SOUL_JACK_O_LANTERN.asBlock(), WHITE_ENDER_JACK_O_LANTERN.asBlock(),
				ROTTEN_PUMPKIN.asBlock(), CARVED_ROTTEN_PUMPKIN.asBlock(), ROTTEN_JACK_O_LANTERN.asBlock(), ROTTEN_SOUL_JACK_O_LANTERN.asBlock(), ROTTEN_ENDER_JACK_O_LANTERN.asBlock());
		...
		Register("purpur_sandy", List.of(EN_US.Purpur()),
				/* Mod */ SANDY_PURPUR_BLOCK.asBlock(), SANDY_PURPUR_SLAB.asBlock(),
				SANDY_CHISELED_PURPUR.asBlock(), SANDY_CHISELED_PURPUR_SLAB.asBlock(),
				SANDY_SANDY_CHISELED_PURPUR.asBlock(), SANDY_SANDY_CHISELED_PURPUR_SLAB.asBlock(),
				SANDY_SMOOTH_PURPUR.asBlock(), SANDY_SMOOTH_PURPUR_SLAB.asBlock(),
				SANDY_PURPUR_BRICKS.asBlock(), SANDY_PURPUR_BRICK_SLAB.asBlock(),
				RED_SANDY_PURPUR_BLOCK.asBlock(), RED_SANDY_PURPUR_SLAB.asBlock(),
				RED_SANDY_CHISELED_PURPUR.asBlock(), RED_SANDY_CHISELED_PURPUR_SLAB.asBlock(),
				RED_SANDY_SANDY_CHISELED_PURPUR.asBlock(), RED_SANDY_SANDY_CHISELED_PURPUR_SLAB.asBlock(),
				RED_SANDY_SMOOTH_PURPUR.asBlock(), RED_SANDY_SMOOTH_PURPUR_SLAB.asBlock(),
				RED_SANDY_PURPUR_BRICKS.asBlock(), RED_SANDY_PURPUR_BRICK_SLAB.asBlock());
		Register("quartz", List.of(Words.Quartz), Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_STAIRS, Blocks.QUARTZ_SLAB, Blocks.QUARTZ_PILLAR,
		...
		Register("rail", List.of(Words.Rail), Blocks.RAIL, Blocks.ACTIVATOR_RAIL, Blocks.DETECTOR_RAIL, Blocks.POWERED_RAIL);
		Register("raw_copper", List.of(EN_US.Copper(Words.Raw)), Blocks.RAW_COPPER_BLOCK, /* Mod */ RAW_COPPER_SLAB.asBlock());
		Register("raw_gold", List.of(EN_US.Gold(Words.Raw)), Blocks.RAW_GOLD_BLOCK, /* Mod */ RAW_GOLD_SLAB.asBlock());
		Register("raw_iron", List.of(EN_US.Iron(Words.Raw)), Blocks.RAW_IRON_BLOCK, /* Mod */ RAW_IRON_SLAB.asBlock());
		Register("redstone", List.of(Words.Redstone), Blocks.REDSTONE_BLOCK);
		//TODO: Pressure Plates???
		Register("redstone_components", List.of(EN_US.Components(Words.Redstone)), Blocks.REPEATER, Blocks.COMPARATOR);
		Register("redstone_lamp", List.of(EN_US.Lamp(Words.Redstone)), Blocks.REDSTONE_LAMP);
		Register("redstone_wire", List.of(EN_US.Wire(Words.Redstone)), Blocks.REDSTONE_WIRE);
		Register("reinforced_deepslate", List.of(EN_US.Deepslate(Words.Reinforced)), REINFORCED_DEEPSLATE.asBlock());
		Register("respawn_anchor", List.of(EN_US.Anchor(Words.Respawn)), Blocks.RESPAWN_ANCHOR);
		...
		Register("sapling", List.of(Words.Sapling), Blocks.ACACIA_SAPLING, Blocks.BIRCH_SAPLING, Blocks.DARK_OAK_SAPLING,
		...
		Register("sapphire", List.of(Words.Sapphire), /* Mod */ SAPPHIRE_BLOCK.asBlock(), SAPPHIRE_STAIRS.asBlock(), SAPPHIRE_SLAB.asBlock(), SAPPHIRE_WALL.asBlock(),
		...
		Register("sculk_stone_bricks", List.of(EN_US.Bricks(EN_US.Stone(Words.Sculk))),
...
//				CHISELED_SCULK_STONE_BRICKS.asBlock(), SMOOTH_CHISELED_SCULK_STONE_BRICKS.asBlock());
		Register("sculk_stone_tiles", List.of(EN_US.Tiles(EN_US.Stone(Words.Sculk))),
		...
		Register("sea_lantern", List.of(EN_US.Lantern(Words.Sea)), Blocks.SEA_LANTERN);
		Register("sea_pickle", List.of(EN_US.Pickle(Words.Sea)), Blocks.SEA_PICKLE);
		Register("seagrass", List.of(Words.Seagrass), Blocks.SEAGRASS, Blocks.TALL_SEAGRASS);
		Register("seeds", List.of(Words.Seeds), /* Mod */ SEED_BLOCK.asBlock());
		Register("shale", List.of(Words.Shale), /* Mod */ SHALE.asBlock(), COBBLED_SHALE.asBlock(), COBBLED_SHALE_STAIRS.asBlock(), COBBLED_SHALE_SLAB.asBlock(), COBBLED_SHALE_WALL.asBlock());
		Register("shale_bricks", List.of(EN_US.Bricks(Words.Shale)), /* Mod */ SHALE_BRICKS.asBlock(), SHALE_BRICK_STAIRS.asBlock(), SHALE_BRICK_SLAB.asBlock(), SHALE_BRICK_WALL.asBlock());
		Register("shale_tiles", List.of(EN_US.Tiles(Words.Shale)), /* Mod */ SHALE_TILES.asBlock(), SHALE_TILE_STAIRS.asBlock(), SHALE_TILE_SLAB.asBlock(), SHALE_TILE_WALL.asBlock());
		Register("shulker_box", List.of(EN_US.Box(Words.Shulker)), Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX,
				...
				Blocks.SHULKER_BOX);
		Register("skull", List.of(Words.Skull), Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL);
		Register("smithing_table", List.of(EN_US.Table(EN_US.Smithing())), Blocks.SMITHING_TABLE);
		Register("smoker", List.of(Words.Smoker), Blocks.SMOKER);
		Register("spawner", List.of(Words.Spawner), Blocks.SPAWNER);
		Register("sponge", List.of(Words.Sponge), Blocks.SPONGE);
		Register("stem", List.of(Words.Stem), Blocks.MELON_STEM, Blocks.PUMPKIN_STEM, /* Mod */ WHITE_PUMPKIN_STEM);
		Register("stem_attached", List.of(EN_US.Stem(EN_US.Attached())), Blocks.ATTACHED_MELON_STEM, Blocks.ATTACHED_PUMPKIN_STEM, /* Mod */ ATTACHED_WHITE_PUMPKIN_STEM);
		...
		Register(terracotta, BEIGE_TERRACOTTA.asBlock(), BEIGE_TERRACOTTA_STAIRS.asBlock(), BEIGE_TERRACOTTA_SLAB.asBlock(), BEIGE_TERRACOTTA_WALL.asBlock(),
				BURGUNDY_TERRACOTTA.asBlock(), BURGUNDY_TERRACOTTA_STAIRS.asBlock(), BURGUNDY_TERRACOTTA_SLAB.asBlock(), BURGUNDY_TERRACOTTA_WALL.asBlock(),
				LAVENDER_TERRACOTTA.asBlock(), LAVENDER_TERRACOTTA_STAIRS.asBlock(), LAVENDER_TERRACOTTA_SLAB.asBlock(), LAVENDER_TERRACOTTA_WALL.asBlock(),
				MINT_TERRACOTTA.asBlock(), MINT_TERRACOTTA_STAIRS.asBlock(), MINT_TERRACOTTA_SLAB.asBlock(), MINT_TERRACOTTA_WALL.asBlock());
		Register("tnt", List.of(Words.TNT), Blocks.TNT);
		Register("tripwire", List.of(Words.Tripwire), Blocks.TRIPWIRE, Blocks.TRIPWIRE_HOOK);
		Register("turtle_egg", List.of(EN_US.Egg(Words.Turtle)), Blocks.TURTLE_EGG);
		Register("wax", List.of(EN_US.Wax()), /* Mod */WAX_BLOCK.asBlock());
		Register("wet_sponge", List.of(EN_US.Sponge(Words.Wet)), Blocks.WET_SPONGE);
		Register("wood_door", List.of(EN_US.Door(Words.Wood)), Blocks.ACACIA_DOOR, Blocks.BIRCH_DOOR,
				Blocks.DARK_OAK_DOOR, Blocks.JUNGLE_DOOR, Blocks.OAK_DOOR, Blocks.SPRUCE_DOOR,
				/* Mod */ MANGROVE_DOOR.asBlock(), CHARRED_DOOR.asBlock());
		Register("wood_fence", List.of(EN_US.Fence(Words.Wood)), Blocks.ACACIA_FENCE, Blocks.BIRCH_FENCE,
		...
		Register("wood_fence_gate", List.of(EN_US.Gate(EN_US.Fence(Words.Wood))), Blocks.ACACIA_FENCE_GATE,
		...
		Register("wood_sandy", List.of(EN_US.Wood(Words.Sandy)),
				/* Mod */ SANDY_ACACIA_PLANKS.asBlock(), SANDY_ACACIA_SLAB.asBlock(), SANDY_BIRCH_PLANKS.asBlock(), SANDY_BIRCH_SLAB.asBlock(), SANDY_DARK_OAK_PLANKS.asBlock(), SANDY_DARK_OAK_SLAB.asBlock(),
				SANDY_JUNGLE_PLANKS.asBlock(), SANDY_JUNGLE_SLAB.asBlock(), SANDY_OAK_PLANKS.asBlock(), SANDY_OAK_SLAB.asBlock(), SANDY_SPRUCE_PLANKS.asBlock(), SANDY_SPRUCE_SLAB.asBlock(),
				SANDY_MANGROVE_PLANKS.asBlock(), SANDY_MANGROVE_SLAB.asBlock(),
				SANDY_CASSIA_PLANKS.asBlock(), SANDY_CASSIA_SLAB.asBlock(), SANDY_CHARRED_PLANKS.asBlock(), SANDY_CHARRED_SLAB.asBlock(), SANDY_DOGWOOD_PLANKS.asBlock(), SANDY_DOGWOOD_SLAB.asBlock(),
				SANDY_HAY_PLANKS.asBlock(), SANDY_HAY_SLAB.asBlock(),
				SANDY_BLUE_MUSHROOM_PLANKS.asBlock(), SANDY_BLUE_MUSHROOM_SLAB.asBlock(), SANDY_BROWN_MUSHROOM_PLANKS.asBlock(), SANDY_BROWN_MUSHROOM_SLAB.asBlock(),
				SANDY_RED_MUSHROOM_PLANKS.asBlock(), SANDY_RED_MUSHROOM_SLAB.asBlock(), SANDY_MUSHROOM_STEM_PLANKS.asBlock(), SANDY_MUSHROOM_STEM_SLAB.asBlock(),
				RED_SANDY_ACACIA_PLANKS.asBlock(), RED_SANDY_ACACIA_SLAB.asBlock(), RED_SANDY_BIRCH_PLANKS.asBlock(), RED_SANDY_BIRCH_SLAB.asBlock(), RED_SANDY_DARK_OAK_PLANKS.asBlock(), RED_SANDY_DARK_OAK_SLAB.asBlock(),
				RED_SANDY_JUNGLE_PLANKS.asBlock(), RED_SANDY_JUNGLE_SLAB.asBlock(), RED_SANDY_OAK_PLANKS.asBlock(), RED_SANDY_OAK_SLAB.asBlock(), RED_SANDY_SPRUCE_PLANKS.asBlock(), RED_SANDY_SPRUCE_SLAB.asBlock(),
				RED_SANDY_MANGROVE_PLANKS.asBlock(), RED_SANDY_MANGROVE_SLAB.asBlock(),
				RED_SANDY_CASSIA_PLANKS.asBlock(), RED_SANDY_CASSIA_SLAB.asBlock(), RED_SANDY_CHARRED_PLANKS.asBlock(), RED_SANDY_CHARRED_SLAB.asBlock(), RED_SANDY_DOGWOOD_PLANKS.asBlock(), RED_SANDY_DOGWOOD_SLAB.asBlock(),
				RED_SANDY_HAY_PLANKS.asBlock(), RED_SANDY_HAY_SLAB.asBlock(),
				RED_SANDY_BLUE_MUSHROOM_PLANKS.asBlock(), RED_SANDY_BLUE_MUSHROOM_SLAB.asBlock(), RED_SANDY_BROWN_MUSHROOM_PLANKS.asBlock(), RED_SANDY_BROWN_MUSHROOM_SLAB.asBlock(),
				RED_SANDY_RED_MUSHROOM_PLANKS.asBlock(), RED_SANDY_RED_MUSHROOM_SLAB.asBlock(), RED_SANDY_MUSHROOM_STEM_PLANKS.asBlock(), RED_SANDY_MUSHROOM_STEM_SLAB.asBlock());
		Register("wood_trapdoor", List.of(EN_US.Trapdoor(Words.Wood)), Blocks.ACACIA_TRAPDOOR, Blocks.BIRCH_TRAPDOOR,
		...
		Register("woodcutter", List.of(Words.Woodcutter), /* Mod */ ACACIA_WOODCUTTER.asBlock(),
	...
	private static final BlockSounds PISTON_BLOCK = new BlockSounds("piston", List.of(Words.Piston));
	private static final SoundEvent STICKY_PISTON_TOP_STEP = BlockSounds.makeStep("sticky_piston_top", List.of(EN_US.Subtitle_Block_Step(EN_US.Sticky(Words.Something))));
