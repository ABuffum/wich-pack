...
public class CompassAnglePredicateProvider implements UnclampedModelPredicateProvider {
	...
	private boolean canPointTo(Entity entity, @Nullable GlobalPos pos) {
		return pos != null && pos.getDimension() == entity.world.getRegistryKey() && pos.getPos().getSquaredDistance(entity.getPos()) > 1.0E-5;
	}
	...
	@Environment(value=EnvType.CLIENT)
	public interface CompassTarget { @Nullable GlobalPos getPos(ClientWorld var1, ItemStack var2, Entity var3); }
}