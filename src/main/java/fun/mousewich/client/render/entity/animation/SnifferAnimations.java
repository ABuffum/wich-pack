...
public class SnifferAnimations {
	public static final Animation SCENTING = Animation.Builder.create(8.0f).looping()/*
			.addBoneAnimation(EntityModelPartNames.NOSE, new Transformation(Transformation.Targets.SCALE,
	...
	public static final Animation WALKING = Animation.Builder.create(2.0f).looping()
			...
			.addBoneAnimation(ModEntityModelPartNames.RIGHT_MID_LEG, new Transformation(Transformation.Targets.ROTATE,
			...
			.addBoneAnimation(ModEntityModelPartNames.RIGHT_MID_LEG, new Transformation(Transformation.Targets.TRANSLATE,
			...
			.addBoneAnimation(ModEntityModelPartNames.LEFT_MID_LEG, new Transformation(Transformation.Targets.ROTATE,
					new Keyframe(0.0f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
					new Keyframe(0.1667f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
					...
					new Keyframe(2.0f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR)))
			.addBoneAnimation(ModEntityModelPartNames.LEFT_MID_LEG, new Transformation(Transformation.Targets.TRANSLATE,
			...
			.addBoneAnimation(EntityModelPartNames.RIGHT_EAR, new Transformation(Transformation.Targets.ROTATE,
					...
					new Keyframe(2.0f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 2.5f), Transformation.Interpolations.CUBIC)))
			.build();
	public static final Animation SEARCHING = Animation.Builder.create(2.0f).looping()
			.addBoneAnimation(EntityModelPartNames.RIGHT_FRONT_LEG, new Transformation(Transformation.Targets.ROTATE,
					new Keyframe(0.0f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
					new Keyframe(0.5833f, AnimationHelper.createRotationalVector(35.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
					new Keyframe(1.0f, AnimationHelper.createRotationalVector(-35.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
	...
	public static final Animation field_42872 = Animation.Builder.create(4.0f)
			.addBoneAnimation(ModEntityModelPartNames.BONE, new Transformation(Transformation.Targets.ROTATE,
			...
			.addBoneAnimation(ModEntityModelPartNames.BONE, new Transformation(Transformation.Targets.TRANSLATE,
			...
			.addBoneAnimation(EntityModelPartNames.LEFT_HIND_LEG, new Transformation(Transformation.Targets.TRANSLATE,
					...
					new Keyframe(1.5f, AnimationHelper.createTranslationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR)))
			.build();
	public static final Animation FEELING_HAPPY = Animation.Builder.create(2.0f).looping()
			.addBoneAnimation(EntityModelPartNames.HEAD, new Transformation(Transformation.Targets.ROTATE,
					new Keyframe(0.0f, AnimationHelper.createRotationalVector(0.0f, 0.0f, 0.0f), Transformation.Interpolations.LINEAR),
