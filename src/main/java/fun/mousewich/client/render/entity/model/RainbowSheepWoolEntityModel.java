...
public class RainbowSheepWoolEntityModel extends QuadrupedEntityModel<RainbowSheepEntity> {
	private float headAngle;
	public RainbowSheepWoolEntityModel(ModelPart root) { super(root, false, 8.0f, 4.0f, 2.0f, 2.0f, 24); }
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(32, 8).cuboid(-4.0f, -10.0f, -7.0f, 8.0f, 16.0f, 6.0f, new Dilation(1.75f)), ModelTransform.of(0.0f, 5.0f, 2.0f, 1.5707964f, 0.0f, 0.0f));
		...
		modelPartBuilder = ModelPartBuilder.create().uv(16, 16).cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.5f));
