...
public class ItemTagGenerator extends FabricTagProvider<Item> {
	...
	protected void generateTags() {
		...
		getOrCreateTagBuilder(ItemTags.SLABS)
				...
				.add(IRON_BRICK_SLAB.asItem(), CUT_IRON_SLAB.asItem())
				.add(GOLD_BRICK_SLAB.asItem(), CUT_GOLD_SLAB.asItem())
		...
		getOrCreateTagBuilder(ItemTags.STAIRS)
				...
				.add(IRON_BRICK_STAIRS.asItem(), CUT_IRON_STAIRS.asItem())
				.add(GOLD_BRICK_STAIRS.asItem(), CUT_GOLD_STAIRS.asItem())
