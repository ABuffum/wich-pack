...
public class OxidizablePickaxeItem extends ModPickaxeItem implements OxidizableItem {
	...
	public OxidizablePickaxeItem(Oxidizable.OxidationLevel level, ModToolMaterials material) { this(level, material, material.getPickaxeDamage(), material.getPickaxeSpeed()); }
