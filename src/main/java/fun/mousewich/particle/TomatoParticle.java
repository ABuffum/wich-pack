...
public class TomatoParticle extends SpriteBillboardParticle {
	protected TomatoParticle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd) {
	...
	public static class Factory implements ParticleFactory<DefaultParticleType> {
		...
		public Factory(SpriteProvider spriteSet) { this.sprites = spriteSet; }
