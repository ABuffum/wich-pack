package fun.mousewich.entity.sniffer;
...
public class SnifferEntity extends AnimalEntity {
	...
	public boolean isPanicking() {
		return this.brain.getOptionalMemory(ModMemoryModules.IS_PANICKING).isPresent();
	}
	...
	private void dropSeeds() {
		...
		ItemStack itemStack = new ItemStack(ModBase.TORCHFLOWER_CROP.asItem());
