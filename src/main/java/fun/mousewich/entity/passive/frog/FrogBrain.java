...
import fun.mousewich.entity.ai.task.BiasedLongJumpTask;
import fun.mousewich.entity.ai.ModMemoryModules;
import fun.mousewich.entity.ai.task.WalkTowardsLandTask;
import fun.mousewich.entity.ai.task.WalkTowardsWaterTask;
