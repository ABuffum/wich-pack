...
import fun.mousewich.gen.data.tag.ModEntityTypeTags;
...
public class FrogEntity extends AnimalEntity {
	...
	public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityNbt) {
		...
		if (registryEntry.isIn(ModBiomeTags.SPAWNS_COLD_VARIANT_FROGS)) this.setVariant(FrogVariant.COLD);
		else if (registryEntry.isIn(ModBiomeTags.SPAWNS_WARM_VARIANT_FROGS)) this.setVariant(FrogVariant.WARM);
