package fun.mousewich.entity.cloud;
...
public class DragonBreathCloudEntity extends AreaEffectCloudEntity {
	...
	public DragonBreathCloudEntity(EntityType<? extends DragonBreathCloudEntity> entityType, World world) {
		super(entityType, world);
		setRadius(1.0F);
		setInvisible(true);
		setParticleType(PARTICLE_EFFECT);
		setDuration(40);
		setRadiusGrowth(0.2F);
		setSilent(true);
	}
	public DragonBreathCloudEntity(World world, double x, double y, double z) {
		super(world, x, y, z);
		setRadius(1.0F);
		setInvisible(true);
		setParticleType(PARTICLE_EFFECT);
