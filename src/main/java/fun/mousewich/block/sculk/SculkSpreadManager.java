...
public class SculkSpreadManager {
	...
	public TagKey<Block> getReplaceableTag() { return this.replaceableTag; }
	...
	private void addCursor(SculkSpreadManager.Cursor cursor) { if (this.cursors.size() < 32) this.cursors.add(cursor); }
	...
	public static class Cursor {
		...
		private boolean canSpread(WorldAccess world, BlockPos pos, boolean worldGen) {
			...
			else return world instanceof ServerWorld serverWorld && serverWorld.shouldTick(pos);
		}
