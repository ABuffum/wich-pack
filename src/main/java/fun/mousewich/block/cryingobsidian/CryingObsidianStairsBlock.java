...
public class CryingObsidianStairsBlock extends StairsBlock {
	...
	public CryingObsidianStairsBlock(BlockConvertible block, DefaultParticleType particle) { this(block.asBlock(), particle); }
	public CryingObsidianStairsBlock(Block block, DefaultParticleType particle) { this(block.getDefaultState(), Settings.copy(block), particle); }
