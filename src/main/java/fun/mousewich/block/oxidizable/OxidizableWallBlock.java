...
public class OxidizableWallBlock extends ModWallBlock implements Oxidizable {
	...
	public OxidizableWallBlock(OxidationLevel level, Block block) { super(block); this.level = level; }
	public OxidizableWallBlock(OxidationLevel level, Settings settings) { super(settings); this.level = level; }
