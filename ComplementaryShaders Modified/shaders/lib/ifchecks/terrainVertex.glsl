...
if (lmCoord.x > 0.99) // Clamp full bright emissives
        ...
        if (mc_Entity.x < 10115.5) {
            ...
            if (mc_Entity.x < 10338.5) {
                if (mc_Entity.x < 10312.5) {
                    ...
                    if (mc_Entity.x < 10328.5 && mc_Entity.x != 10326) {
                        ...
                        else if (mc_Entity.x == 10328 || mc_Entity.x == 10325) // Gold Block+
                ...
                if (mc_Entity.x < 10356.5) {
                    if (mc_Entity.x < 10344.5) {
                        if (mc_Entity.x == 10340 || mc_Entity.x == 10326) // Netherite Block
                ...
                if (mc_Entity.x < 11012.5) {
                    ...
                    if (mc_Entity.x < 11024.5) {
                        ...
                        if (mc_Entity.x == 11028) // Jack o'Lantern
                                ...
                                lightVarying = 3.0,
                            #endif
                            mat = 17000.0, color.rgb = vec3(1.0, 1.0, 1.0),
                ...
                if (mc_Entity.x < 11113.5) {
                    if (mc_Entity.x < 11100.5) {
                        ...
                        if (mc_Entity.x == 11104) // Jigsaw Block, Structure Block
                            ...
                            #endif
                            lmCoord.x = clamp(lmCoord.x, 0.0, 0.87);
						else if (mc_Entity.x == 11113) // Lit Soul/Ender Candles
                            #ifdef COLORED_LIGHT
                                lightVarying = 2.0,
                            #endif
                            lmCoord.x = clamp(lmCoord.x, 0.0, 0.87);
    ...
    if (mc_Entity.x == 99 || mc_Entity.x == 10324 || mc_Entity.x == 10325 || mc_Entity.x == 10326)
        lmCoord.x = clamp(lmCoord.x, 0.0, 0.87);
